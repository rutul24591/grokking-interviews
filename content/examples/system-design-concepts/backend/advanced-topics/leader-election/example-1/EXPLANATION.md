# Leader Election - example-1 Explanation

## Article context
This example supports the article `backend/advanced-topics/leader-election`. The article is about Staff-level deep dive into leader election algorithms: Bully algorithm, Raft, Zab, ZooKeeper-based election, split-brain prevention, and production-scale distributed coordination patterns.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Leader Election Requirements; Failure Detection; Split-Brain Prevention; Architecture and Flow; Raft Leader Election; ZooKeeper-Based Leader Election; Trade-offs and Comparison; Best Practices.
