# Time-Series Optimization - example-1 Explanation

## Article context
This example supports the article `backend/advanced-topics/time-series-optimization`. The article is about Staff-level deep dive into time-series database optimization: data compression, downsampling, retention policies, partitioning strategies, and production-scale patterns for high-throughput time-series workloads.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Append-Only Storage; Time-Based Partitioning; Downsampling and Retention; Architecture and Flow; Data Compression for Time-Series; Query Optimization; Trade-offs and Comparison; Best Practices.
