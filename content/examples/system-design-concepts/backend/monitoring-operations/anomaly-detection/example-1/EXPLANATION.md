# Anomaly Detection - example-1 Explanation

## Article context
This example supports the article `backend/monitoring-operations/anomaly-detection`. The article is about Detect unusual behavior with baselines and seasonality, then operationalize it with guardrails to avoid noise.. The most relevant article sections for this example are: Definition and Context; Core Principles of Production Anomaly Detection; Core Concepts; Architecture and Flow; Trade-offs and Comparison; Best Practices; Common Pitfalls; Real-world Use Cases; Interview Questions; Question 1: When would you use anomaly detection instead of static thresholds?.
