# Auto-Scaling - example-1 Explanation

## Article context
This example supports the article `backend/infrastructure-deployment/auto-scaling`. The article is about Comprehensive guide to auto-scaling covering horizontal and vertical scaling, scaling metrics, scaling policies, cost optimization, and production-scale implementation patterns.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; Scaling Strategies; Trade-offs and Comparison; Horizontal vs. Vertical Scaling; Reactive vs. Predictive Scaling; Best Practices; Common Pitfalls; Real-World Use Cases.
