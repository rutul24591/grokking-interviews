# Networking - example-1 Explanation

## Article context
This example supports the article `backend/infrastructure-deployment/networking`. The article is about Deep dive into cloud networking design covering VPC/VNet architecture, subnetting, routing tables, NAT gateways, security groups vs NACLs, VPC peering, transit gateways, private endpoints, egress control, DNS resolution, MTU/fragmentation, connection pooling, and network observability at production scale.. The most relevant article sections for this example are: Definition and Context; Core Concepts; VPC/VNet Design and CIDR Block Allocation; Subnetting and Tiered Architecture; Routing Tables and Route Propagation; NAT Gateways and Controlled Egress; Security Groups vs. Network ACLs; VPC Peering and Transit Gateways; Architecture and Flow; Egress Control Architecture.
