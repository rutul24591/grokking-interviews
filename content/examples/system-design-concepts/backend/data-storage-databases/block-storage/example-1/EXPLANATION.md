# Block Storage - example-1 Explanation

## Article context
This example supports the article `backend/data-storage-databases/block-storage`. The article is about Comprehensive guide to block storage: block device model, volume types, attachment model, and when to use EBS or similar services for databases and low-latency workloads.. The most relevant article sections for this example are: Block Storage; Core Concepts: Block Devices and Volumes; The Block Device Model; Volume Types; Attachment Model; Architecture and Implementation: Performance and Durability; Performance Characteristics; Durability and Availability; Encryption; Trade-offs and Comparison: Block vs Object vs File.
...
- `Example-Mounting-a-Volume.txt`: Provides supporting example content: mkfs.ext4 /dev/nvme1n1 mount /dev/nvme1n1 /data df -h /data.
