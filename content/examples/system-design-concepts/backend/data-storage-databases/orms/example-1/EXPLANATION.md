# ORMs (Object-Relational Mapping) - example-1 Explanation

## Article context
This example supports the article `backend/data-storage-databases/orms`. The article is about Comprehensive guide to ORMs: Active Record vs Data Mapper patterns, N+1 query problem, eager vs lazy loading, performance optimization, and when to use ORM vs raw SQL.. The most relevant article sections for this example are: ORMs (Object-Relational Mapping); Core Concepts: ORM Patterns and Loading Strategies; ORM Patterns: Active Record vs Data Mapper; Loading Strategies: Lazy vs Eager; Relationship Mapping; Architecture and Implementation: N+1 and Optimization; N+1 Query Problem; Query Optimization; When to Use Raw SQL; Trade-offs and Comparison: ORM vs Raw SQL.
...
- `orm.js`: Implements the main logic, including db, queryCount, resetQueryCount, getQueryCount, findUsers.
