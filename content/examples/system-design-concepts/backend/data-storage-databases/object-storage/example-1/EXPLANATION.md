...
## Article context
This example supports the article `backend/data-storage-databases/object-storage`. The article is about Comprehensive guide to object storage: architecture, storage tiers, lifecycle management, and when to use object stores like S3 for unstructured data at scale.. The most relevant article sections for this example are: Object Storage; Core Concepts: Objects, Buckets, and Keys; The Object Model; Immutability; Storage Tiers and Lifecycle Management; Architecture and Implementation: Scaling and Durability; Distributed Architecture; Consistency Models; Access Patterns and Performance; Trade-offs and Comparison: Object vs Block vs File Storage.
...
- `Example-Upload-and-Versioning.txt`: Provides supporting example content: await storage.putObject({ bucket: "media", key: "avatars/user_1.png", body: fileStream }); // Enable versioning for rollback await storage.e.
