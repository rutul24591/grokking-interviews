# Data Modeling in NoSQL - example-1 Explanation

## Article context
This example supports the article `backend/data-storage-databases/data-modeling-in-nosql`. The article is about Comprehensive guide to NoSQL data modeling: query-first design, denormalization strategies, embedding vs referencing, and selecting the right database for your access patterns.. The most relevant article sections for this example are: Data Modeling in NoSQL; Core Concepts: Query-First Design; The Relational vs NoSQL Mindset; Embedding vs Referencing; Denormalization Strategies; Architecture and Implementation: Patterns by Database Type; Document Database Patterns; Key-Value Store Patterns; Graph Database Patterns; Column-Family Store Patterns.
...
- `model.js`: Defines the domain entities and typed structures used across the example.
