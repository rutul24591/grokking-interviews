# Data Lakes - example-1 Explanation

## Article context
This example supports the article `backend/data-storage-databases/data-lakes`. The article is about Comprehensive guide to data lakes: architecture, medallion architecture (bronze/silver/gold), governance, and when to use data lakes vs data warehouses for analytics and ML.. The most relevant article sections for this example are: Data Lakes; Core Concepts: Schema-on-Read and Medallion Architecture; Schema-on-Read vs Schema-on-Write; Medallion Architecture (Bronze/Silver/Gold); Data Processing; Architecture and Implementation: Governance and Best Practices; Data Governance Framework; Lakehouse Pattern; Trade-offs and Comparison: Data Lake vs Data Warehouse; Data Lake Strengths.
...
- `Example-Data-Lake-Layout.txt`: Provides supporting example content: s3://data-lake/ raw/events/2026/03/09/events.json processed/events/2026/03/09/events.parquet.
