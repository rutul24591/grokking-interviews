...
## Article context
This example supports the article `backend/reliability-fault-tolerance/rollback-strategies`. The article is about Staff-level rollback strategies: blue-green deployments, canary releases, feature flags, database migration rollbacks, automated vs manual rollback, and fix-forward versus rollback decision frameworks.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Blue-Green Deployments; Canary Releases; Feature Flags; Database Migration Rollbacks; Automated versus Manual Rollback; Architecture and Flow; Rollback vs Fix-Forward Decision Framework; Rollback Dependencies and Backward Compatibility.
