# Health Checks - example-1 Explanation

## Article context
This example supports the article `backend/reliability-fault-tolerance/health-checks`. The article is about Staff-level health check patterns: liveness/readiness/startup probes, Kubernetes probe configuration, health check anti-patterns, and integration with load balancers and service discovery.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Liveness Probes; Readiness Probes; Startup Probes; Kubernetes Probe Configuration; Integration with Load Balancers; Architecture and Flow; Health Check Endpoint Design; Dependency-Aware Readiness.
