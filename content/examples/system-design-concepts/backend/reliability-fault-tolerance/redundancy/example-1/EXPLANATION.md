# Redundancy - example-1 Explanation

## Article context
This example supports the article `backend/reliability-fault-tolerance/redundancy`. The article is about Staff-level redundancy patterns: N+1 redundancy, geographic redundancy, component-level vs system-level redundancy, cost vs reliability trade-offs, and common-mode failure prevention.. The most relevant article sections for this example are: Definition and Context; Core Concepts; N+1 Redundancy; Active-Active versus Active-Passive Redundancy; Geographic Redundancy; Component-Level versus System-Level Redundancy; Cost versus Reliability Trade-offs; Architecture and Flow; Failure Domain Mapping; Headroom Planning.
