# Distributed Coordination - example-1 Explanation

## Article context
This example supports the article `backend/scalability-distributed-systems/distributed-coordination`. The article is about Staff-level deep dive into distributed coordination covering ZooKeeper, etcd, Consul, leader election, service discovery, configuration management, distributed barriers, group membership, and coordination primitives for distributed systems.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; Trade-offs and Comparisons; Best Practices; Common Pitfalls; Real-world Use Cases; Common Interview Questions with Detailed Answers; Q1: How does ZooKeeper&apos;s leader election using ephemeral sequential znodes work? What are the advantages of this approach?; Q2: How does service discovery work in a coordination service? What happens when a service instance crashes?.
