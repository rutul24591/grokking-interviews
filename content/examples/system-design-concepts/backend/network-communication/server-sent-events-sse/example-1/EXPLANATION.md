...
## Article context
This example supports the article `backend/network-communication/server-sent-events-sse`. The article is about Server Sent Events SSE. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
