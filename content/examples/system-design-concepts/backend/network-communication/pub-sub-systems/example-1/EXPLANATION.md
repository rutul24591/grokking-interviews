# Pub-Sub Systems - example-1 Explanation

## Article context
This example supports the article `backend/network-communication/pub-sub-systems`. The article is about Comprehensive guide to publish-subscribe systems: topic-based routing, fan-out delivery, durable subscriptions, consumer groups, ordering, backpressure, and production patterns at scale.. The most relevant article sections for this example are: Pub-Sub Systems; Core Concepts: Topics, Subscriptions, and Delivery; Topic-Based Routing; Durable vs Transient Subscriptions; Fan-Out Delivery; Consumer Groups and Parallel Processing; Architecture and Implementation Patterns; Push vs Pull Delivery; Message Retention and Acknowledgment; Filtering and Routing.
