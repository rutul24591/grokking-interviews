# Change Data Capture (CDC) - example-1 Explanation

## Article context
This example supports the article `backend/data-processing-analytics/change-data-capture`. The article is about Replicate and react to database changes with clear correctness guarantees, schema evolution discipline, and operational controls over lag and backfills.. The most relevant article sections for this example are: Definition and Context; CDC Event Structure; Core Concepts; Architecture and Flow; Trade-offs and Comparison; Best Practices; Common Pitfalls; Real-world Use Cases; Interview Questions; Question 1: How does CDC differ from dual-write patterns, and when would you choose one over the other?.
