# IP Addressing - example-1 Explanation

## Article context
This example supports the article `backend/fundamentals-building-blocks/ip-addressing`. The article is about Comprehensive guide to IPv4, IPv6, CIDR, subnetting, NAT, and production IP design patterns for backend systems.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; Cloud Network Hierarchy; Trade-offs and Comparisons; IPv4 vs IPv6: When to Use Each; Best Practices; Common Pitfalls; Production Case Studies; Netflix: Multi-Region VPC Design.
...
- `client.js`: Implements the main logic, including samples, ip.
- `ip-utils.js`: Implements the main logic, including IPV4_PARTS, parseIpv4, parts, parseIpv6, sections.
...
- `subnet-policy.js`: Centralizes business rules, validation, limits, or fallback decisions.
