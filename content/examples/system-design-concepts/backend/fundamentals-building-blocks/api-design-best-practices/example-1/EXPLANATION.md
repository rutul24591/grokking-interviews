# API Design Best Practices - example-1 Explanation
...
- `client.js`: Implements the main logic, including http, request, body, run.
- `errors.js`: Implements the main logic, including errorPayload.
- `filters.js`: Implements the main logic, including filterOrders, result, dir.
- `package.json`: Declares the runnable package metadata and dependencies for the example.
- `pagination.js`: Implements the main logic, including paginate, startIndex, slice, nextCursor, buildMeta.
- `README.md`: Documents how to run, inspect, or reason about the example.
- `server.js`: Implements the main logic, including http, orders, parseQuery, limit, cursor.
