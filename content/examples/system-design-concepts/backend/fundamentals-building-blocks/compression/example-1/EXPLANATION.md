# Compression - example-1 Explanation
...
- `client.js`: Implements the main logic, including payload, raw, gz, br.
- `compress.js`: Implements the main logic, including zlib, gzip, brotli.
