# Edge Rendering - example-2 Explanation
...
- `app/region/[region]/page.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `middleware.ts`: Implements the main logic, including config, normalizeRegion, region, middleware, headerRegion.
