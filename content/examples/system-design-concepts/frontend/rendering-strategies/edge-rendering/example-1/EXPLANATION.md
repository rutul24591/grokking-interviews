# Edge Rendering - example-1 Explanation
...
- `.env.example`: Provides supporting example content: ORIGIN_API=http://localhost:4020.
...
- `lib/hash.ts`: Implements the main logic, including fnv1a32, hash, i, bucketFromUid.
- `middleware.ts`: Implements the main logic, including config, randomUid, bytes, middleware, res.
