# Client-Side Rendering (CSR) - example-3 Explanation
...
- `lib/backoff.ts`: Implements the main logic, including sleep, id, onAbort, backoffDelayMs, pow.
- `lib/fetchWithRetry.ts`: Implements the main logic, including fetchJsonWithRetry, lastError, attempt, res, txt.
