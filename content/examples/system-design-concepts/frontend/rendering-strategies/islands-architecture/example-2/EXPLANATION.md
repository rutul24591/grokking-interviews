# Islands Architecture - example-2 Explanation
...
- `app/_components/CommentsIsland.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `app/_components/CommentsSlot.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
