# Selective Hydration - example-2 Explanation
...
- `app/_components/InteractionIsland.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
