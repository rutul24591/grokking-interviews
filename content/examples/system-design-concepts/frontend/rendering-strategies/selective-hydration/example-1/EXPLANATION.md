# Selective Hydration - example-1 Explanation
...
- `app/_components/QueuedButton.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `app/_components/SelectiveDemo.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
