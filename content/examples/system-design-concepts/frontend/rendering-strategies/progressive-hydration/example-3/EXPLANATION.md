# Progressive Hydration - example-3 Explanation
...
- `app/_components/HeavyWidget.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `app/_components/ScheduledSlot.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
...
- `lib/heavyLoader.ts`: Implements the main logic, including promise, loadHeavyWidget.
