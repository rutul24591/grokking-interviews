# Static Site Generation (SSG) - example-2 Explanation
...
- `content/search-index.json`: Provides structured configuration, sample data, schema, or expected output used by the example.
- `lib/search.ts`: Implements the main logic, including index, tokenize, search, tokens, counts.
...
- `scripts/build-search-index.ts`: Implements the main logic, including tokenize, main, root, outDir, outFile.
