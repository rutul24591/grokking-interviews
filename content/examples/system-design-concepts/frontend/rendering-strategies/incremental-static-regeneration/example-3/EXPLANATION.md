# Incremental Static Regeneration (ISR) - example-3 Explanation
...
- `app/api/public-content/route.ts`: Models an API boundary, request handling path, or backend contract.
...
- `app/personalized/page.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `app/public/page.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
