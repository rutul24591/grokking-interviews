# Server-Side Rendering (SSR) - example-3 Explanation
...
- `components/BuggyClock.tsx`: Implements the main logic, including BuggyClock, now.
- `components/FixedClock.tsx`: Implements the main logic, including FixedClock, id.
