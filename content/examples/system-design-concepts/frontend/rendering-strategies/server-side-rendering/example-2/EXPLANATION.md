# Server-Side Rendering (SSR) - example-2 Explanation
...
- `app/api/recommended/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/trending/route.ts`: Models an API boundary, request handling path, or backend contract.
