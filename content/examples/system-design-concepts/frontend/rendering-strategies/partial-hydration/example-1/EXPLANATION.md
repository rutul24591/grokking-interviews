# Partial Hydration - example-1 Explanation
...
- `app/_components/LikeButton.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `app/actions.ts`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
