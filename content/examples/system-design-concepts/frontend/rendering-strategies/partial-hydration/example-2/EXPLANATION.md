# Partial Hydration - example-2 Explanation
...
- `app/_components/EditorSlot.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `app/_components/HeavyEditor.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
