# Collaborative Editing (Operational Transform, CRDT) - example-1 Explanation

## Article context
This example supports the article `frontend/real-time-features/collaborative-editing`. The article is about Comprehensive guide to real-time collaborative editing — covering Operational Transformation algorithms, Conflict-free Replicated Data Types, cursor and selection synchronization, undo/redo in multiplayer contexts, and production architectures used by Google Docs, Figma, and Notion.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Operational Transformation (OT); Conflict-free Replicated Data Types (CRDTs); Cursor and Selection Synchronization; Undo/Redo in Collaborative Contexts; Awareness and Presence in Editors; Architecture and Flow; Trade-offs and Comparisons; Best Practices.
...
- `tsconfig.tsbuildinfo`: Provides supporting example content: {"fileNames":["../../../../../../../node_modules/.pnpm/typescript@5.9.3/node_modules/typescript/lib/lib.es5.d.ts","../../../../../../../node.
