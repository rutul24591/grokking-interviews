# Server-Side Rendering for SEO - example-2 Explanation
...
- `lib/posts.ts`: Implements the main logic, including PostsBySlug, SlugSchema, dbGetPost, dbGetRelated, listPostSlugs.
- `lib/sleep.ts`: Implements the main logic, including sleep.
