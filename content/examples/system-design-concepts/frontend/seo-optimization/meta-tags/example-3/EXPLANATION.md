# Meta Tags - example-3 Explanation
...
- `app/[locale]/products/[id]/page.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
...
- `lib/products.ts`: Implements the main logic, including PRODUCTS, getProduct.
