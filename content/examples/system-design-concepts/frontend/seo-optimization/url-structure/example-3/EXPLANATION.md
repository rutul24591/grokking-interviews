# URL Structure - example-3 Explanation
...
- `app/[locale]/posts/[id]/[slug]/page.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
