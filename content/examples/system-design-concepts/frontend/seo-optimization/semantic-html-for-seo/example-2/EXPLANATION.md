# Semantic HTML for SEO - example-2 Explanation
...
- `components/Section.tsx`: Implements the main logic, including slugToId, Heading, Tag, Section, id.
- `lib/outline.ts`: Implements the main logic, including DocNodeSchema, DocModelSchema, slugToId, assertValidHeadingTree, child.
