# Semantic HTML for SEO - example-3 Explanation
...
- `components/Breadcrumbs.tsx`: Implements the main logic, including Breadcrumbs, isLast.
- `components/FAQ.tsx`: Implements the main logic, including FAQ.
- `components/Specs.tsx`: Exercises behavior and guards important edge cases or invariants.
- `lib/product.ts`: Implements the main logic, including getProduct.
