# Real-Time Data Updates - example-1 Explanation
...
- `app/api/realtime/state/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/realtime/toggle/route.ts`: Models an API boundary, request handling path, or backend contract.
