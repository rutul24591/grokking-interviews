# HTTP/2 and HTTP/3 - example-1 Explanation

## Article context
This example supports the article `frontend/networking-api-communication/http2-and-http3`. The article is about Deep dive into HTTP/2 and HTTP/3 from the frontend perspective covering multiplexing, server push, header compression, QUIC protocol, and how these impact frontend performance optimization strategies.. The most relevant article sections for this example are: Definition & Context; Core Concepts; Architecture & Flow; Trade-offs & Comparisons; Best Practices; Common Pitfalls; Real-World Use Cases; Security Considerations; TLS Requirements; DDoS Amplification.
...
- `app/protocol-workbench.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
