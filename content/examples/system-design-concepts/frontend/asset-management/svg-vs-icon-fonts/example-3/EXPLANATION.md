# SVG vs Icon Fonts - example-3 Explanation
...
- `next.config.ts`: Implements the main logic, including csp, nextConfig.
...
- `public/sprite.svg`: Provides supporting example content: <?xml version="1.0" encoding="UTF-8"?> <svg xmlns="http://www.w3.org/2000/svg" style="display:none"> <symbol id="shield" viewBox="0 0 24 24".
