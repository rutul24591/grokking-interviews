# SVG vs Icon Fonts - example-2 Explanation
...
- `app/api/sanitize/route.ts`: Models an API boundary, request handling path, or backend contract.
...
- `lib/sanitizeSvg.ts`: Implements the main logic, including sanitizeSvg, s.
