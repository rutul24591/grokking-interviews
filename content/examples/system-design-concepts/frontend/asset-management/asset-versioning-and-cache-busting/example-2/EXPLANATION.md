# Asset Versioning and Cache Busting - example-2 Explanation
...
- `lib/bust.ts`: Implements the main logic, including urlWithQuery, url, urlWithFilenameHash, idx, recommendedCacheControl.
