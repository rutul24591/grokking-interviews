# Asset Versioning and Cache Busting - example-3 Explanation
...
- `app/api/assets/[name]/route.ts`: Models an API boundary, request handling path, or backend contract.
...
- `assets/mutable-asset.txt`: Provides supporting example content: This is a mutable asset served at a stable URL. Edit this file, restart dev server, and observe the ETag change..
- `lib/etag.ts`: Implements the main logic, including strongEtag, hash.
