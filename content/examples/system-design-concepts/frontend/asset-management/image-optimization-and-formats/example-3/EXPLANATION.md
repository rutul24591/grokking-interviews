# Image Optimization and Formats - example-3 Explanation
...
- `app/api/image-negotiated/route.ts`: Models an API boundary, request handling path, or backend contract.
