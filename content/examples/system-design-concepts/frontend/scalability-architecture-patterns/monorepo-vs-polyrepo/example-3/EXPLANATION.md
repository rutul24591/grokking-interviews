# Monorepo vs Polyrepo - example-3 Explanation
...
- `apps/api/internal.ts`: Models an API boundary, request handling path, or backend contract.
- `apps/web/bad.ts`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `enforce.js`: Implements the main logic, including ROOT, WEB_DIR, listFiles, out, entry.
