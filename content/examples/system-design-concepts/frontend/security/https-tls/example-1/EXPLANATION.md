# HTTPS/TLS - example-1 Explanation

## Article context
This example supports the article `frontend/security/https-tls`. The article is about Comprehensive guide to HTTPS and TLS protocols, certificate management, handshake process, security best practices, and implementation strategies for staff/principal engineer interviews.. The most relevant article sections for this example are: Definition & Context; Key Insight: HTTPS Is Table Stakes; TLS Protocol Overview; TLS Handshake Process; TLS Record Layer; Key Insight: TLS 1.3 Is Mandatory for Modern Security; TLS Certificates; Certificate Components; Certificate Validation Levels; Certificate Types by Coverage.
...
- `server/server.js`: Implements the main logic, including HTTP_PORT, HTTPS_PORT, certDir, keyPath, certPath.
...
- `web/lib/health.ts`: Implements the main logic, including fetchTlsHealth, res.
