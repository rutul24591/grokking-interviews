# Secure Storage of Sensitive Data - example-1 Explanation
...
- `app/api/read-cookie/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/set-cookie/route.ts`: Models an API boundary, request handling path, or backend contract.
