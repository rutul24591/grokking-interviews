# Tree Shaking - example-1 Explanation

## Article context
This example supports the article `frontend/performance-optimization/tree-shaking`. The article is about Comprehensive guide to tree shaking for eliminating dead code from JavaScript bundles, covering ES modules, bundler configuration, and library selection.. The most relevant article sections for this example are: Definition & Context; Core Concepts; How Tree Shaking Works; Why ES Modules Are Required; Side Effects and Tree Shaking; Pure Functions and Annotations; Architecture & Flow; Bundler Tree Shaking Pipeline; Barrel Files and Re-exports; Trade-offs & Comparison.
...
- `.env.example`: Provides supporting example content: NEXT_PUBLIC_ORIGIN_API=http://localhost:4230 ORIGIN_API=http://localhost:4230.
