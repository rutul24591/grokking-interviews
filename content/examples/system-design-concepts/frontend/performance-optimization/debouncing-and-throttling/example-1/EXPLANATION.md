# Debouncing and Throttling - example-1 Explanation
...
- `.env.example`: Provides supporting example content: NEXT_PUBLIC_ORIGIN_API=http://localhost:4150 ORIGIN_API=http://localhost:4150.
...
- `app/search-workbench.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
