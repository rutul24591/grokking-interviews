# Web Vitals (LCP, FID, CLS, TTFB, INP) - example-1 Explanation

## Article context
This example supports the article `frontend/performance-optimization/web-vitals`. The article is about Comprehensive guide to Core Web Vitals and key performance metrics for measuring and optimizing real user experience.. The most relevant article sections for this example are: Definition & Context; Core Concepts; The Three Core Web Vitals; Additional Important Metrics; Architecture & Flow; How Web Vitals Are Measured; Measuring Web Vitals in Production; Chrome UX Report (CrUX); Trade-offs & Comparison; Lab vs Field Data Comparison.
...
- `.env.example`: Provides supporting example content: NEXT_PUBLIC_ORIGIN_API=http://localhost:4250 ORIGIN_API=http://localhost:4250.
