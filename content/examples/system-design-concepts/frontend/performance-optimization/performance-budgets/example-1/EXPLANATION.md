# Performance Budgets - example-1 Explanation

## Article context
This example supports the article `frontend/performance-optimization/performance-budgets`. The article is about Comprehensive guide to setting, enforcing, and maintaining measurable limits for frontend performance metrics including bundle size, Core Web Vitals, and resource budgets.. The most relevant article sections for this example are: Definition & Context; Core Concepts; Types of Performance Budgets; Budget Thresholds: The 75th Percentile Rule; Lab Data vs. Field Data; Architecture & Flow; Setting Performance Budgets; Enforcing Budgets in CI/CD; Trade-offs & Comparison; Budget Strictness Trade-offs.
...
- `.env.example`: Provides supporting example content: NEXT_PUBLIC_ORIGIN_API=http://localhost:4200 ORIGIN_API=http://localhost:4200.
