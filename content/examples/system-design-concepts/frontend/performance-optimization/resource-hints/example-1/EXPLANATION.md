# Resource Hints (prefetch, preload, preconnect, dns-prefetch) - example-1 Explanation

## Article context
This example supports the article `frontend/performance-optimization/resource-hints`. The article is about Comprehensive guide to resource hints for optimizing how browsers discover, prioritize, and fetch critical resources.. The most relevant article sections for this example are: Definition & Context; Core Concepts; The Four Resource Hints; The "as" Attribute; Architecture & Flow; Resource Discovery Flow; Connection Setup Flow; Framework Integration; Trade-offs & Comparison; Comparison Table.
...
- `.env.example`: Provides supporting example content: NEXT_PUBLIC_ORIGIN_API=http://localhost:4220 ORIGIN_API=http://localhost:4220.
