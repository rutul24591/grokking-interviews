# Skip Links - example-3 Explanation
...
- `app/a/page.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `app/b/page.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
...
- `components/RouteHeadingFocus.tsx`: Models an API boundary, request handling path, or backend contract.
