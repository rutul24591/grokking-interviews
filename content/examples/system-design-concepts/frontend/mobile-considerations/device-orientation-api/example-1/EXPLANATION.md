# Device Orientation API - example-1 Explanation

## Article context
This example supports the article `frontend/mobile-considerations/device-orientation-api`. The article is about Comprehensive guide to Device Orientation API covering orientation events, motion sensors, use cases for gaming and AR, and privacy considerations.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; iOS Permission Handling; Trade-offs and Comparison; Permission Trade-offs; Sensor Quality Variation; Best Practices; Common Pitfalls; Real-World Use Cases.
