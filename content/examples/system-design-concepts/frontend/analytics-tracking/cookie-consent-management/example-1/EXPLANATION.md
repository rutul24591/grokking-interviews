# Cookie Consent Management - example-1 Explanation

## Article context
This example supports the article `frontend/analytics-tracking/cookie-consent-management`. The article is about Staff-level cookie consent management: consent banner design, consent storage, propagation across systems, withdrawal handling, and compliance with GDPR, CCPA, and ePrivacy Directive.. The most relevant article sections for this example are: Definition & Context; Core Concepts; Consent Requirements by Regulation; Cookie Categories; Consent Banner Design; Consent Storage; Consent Propagation; Consent Withdrawal; Architecture & Flow; Consent Management Architecture.
...
- `app/analytics-lab.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
