# Conflict Resolution for Offline Changes - example-1 Explanation
...
- `app/workbench.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
- `lib/merge.ts`: Implements the main logic, including createDraft, valueChanged, mergeDocuments, merged, autoResolved.
