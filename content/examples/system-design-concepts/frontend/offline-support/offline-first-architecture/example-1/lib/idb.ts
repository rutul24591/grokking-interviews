...
export async function getOne<T>(store: IDBObjectStore, key: IDBValidKey): Promise<T | null> {
  return new Promise((resolve, reject) => {
...
export async function add(store: IDBObjectStore, value: unknown): Promise<IDBValidKey> {
  return new Promise((resolve, reject) => {
