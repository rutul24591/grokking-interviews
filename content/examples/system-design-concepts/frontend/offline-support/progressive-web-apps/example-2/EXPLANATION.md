# Progressive Web Apps (PWA) - example-2 Explanation
...
- `audit-manifest.js`: Implements the main logic, including fail, ok, warn, manifestPath, manifest.
- `manifest.webmanifest`: Provides supporting example content: { "name": "Sample PWA", "short_name": "Sample", "start_url": "/", "scope": "/", "display": "standalone", "background_color": "#070a13", "the.
