# Analytics Tools Integration - example-1 Explanation

## Article context
This example supports the article `frontend/third-party-integration/analytics-tools-integration`. The article is about Staff-level analytics integration: event taxonomy, consent gating, batching and sampling, identity stitching, data quality, and operational guardrails for third-party analytics SDKs.. The most relevant article sections for this example are: Definition & Context; Core Concepts; Event Taxonomy; Consent Gating; Batching and Sampling; Identity Stitching; Data Quality; Architecture & Flow; Analytics Layer Architecture; Event Flow.
...
- `app/analytics-workbench.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
