...
## Article context
This example supports the article `frontend/search-filtering/faceted-search`. The article is about Comprehensive guide to Faceted Search covering filter architecture, multi-select handling, facet counting, and production-scale filtering patterns.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; Filter State Management; Trade-offs and Comparison; Client-Side vs Server-Side Filtering; Facet Count Computation; Best Practices; Common Pitfalls; Real-World Use Cases.
