# Infinite Scroll vs Pagination - example-1 Explanation

## Article context
This example supports the article `frontend/edge-cases-and-user-experience/infinite-scroll-vs-pagination`. The article is about Staff-level deep dive into list navigation patterns, cursor vs offset pagination, virtualization strategies, scroll position preservation, SEO implications, and systematic approaches to choosing between infinite scroll and pagination.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; Trade-offs and Comparisons; Best Practices; Common Pitfalls; Real-World Use Cases; Common Interview Questions.
...
- `app/feed-navigation-client.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
