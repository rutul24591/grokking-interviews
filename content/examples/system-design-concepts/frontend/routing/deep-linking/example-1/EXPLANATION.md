# Deep Linking - example-1 Explanation

## Article context
This example supports the article `frontend/routing/deep-linking`. The article is about Deep linking strategies for web and mobile — direct URL access to specific app states, Universal Links, App Links, deferred deep linking, and preserving context across platforms.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Web Deep Linking; Universal Links (iOS) and App Links (Android); Deferred Deep Linking; Architecture and Flow; URL Schema Design for Deep Links; Custom URL Schemes (Legacy); Open Graph and Social Sharing; Trade-offs and Comparisons.
...
- `app/deep-link-workbench.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
