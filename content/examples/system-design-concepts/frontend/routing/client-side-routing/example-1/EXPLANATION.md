# Client-Side Routing - example-1 Explanation

## Article context
This example supports the article `frontend/routing/client-side-routing`. The article is about Deep dive into client-side routing architecture, SPA navigation patterns, router implementations, and how modern frameworks handle route transitions without full page reloads.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Route Table and Matching; Navigation Interception; Component Resolution and Rendering; Architecture and Flow; Router Architecture Layers; Scroll Restoration; Transition Management; Trade-offs and Comparisons.
...
- `app/routing-workbench.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
