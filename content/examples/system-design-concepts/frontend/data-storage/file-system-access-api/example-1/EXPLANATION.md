# File System Access API - example-1 Explanation

## Article context
This example supports the article `frontend/data-storage/file-system-access-api`. The article is about Deep dive into the File System Access API covering file handles, directory access, OPFS (Origin Private File System), and native-like file operations in the browser.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Picker APIs and File Handles; Permissions and User Gestures; Origin Private File System (OPFS); FileSystemWritableFileStream; Architecture and Flow; Trade-offs Comparison; Best Practices; Common Pitfalls.
...
- `app/file-editor.tsx`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
