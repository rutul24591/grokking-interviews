# RTL (Right-to-Left) Support - example-1 Explanation

## Article context
This example supports the article `frontend/internationalization-i18n-localization-l10n/rtl-support`. The article is about Comprehensive guide to RTL Support covering layout mirroring, CSS logical properties, bidirectional text, and production-scale RTL implementation patterns.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; CSS Strategy Comparison; Trade-offs and Comparison; Icon Flipping Strategies; Testing Approaches; Best Practices; Common Pitfalls; Real-World Use Cases.
