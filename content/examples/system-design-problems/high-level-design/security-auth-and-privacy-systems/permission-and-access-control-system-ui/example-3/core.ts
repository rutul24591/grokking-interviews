...
const slug = "permission-and-access-control-system-ui";
const domain = "security privacy";
const failureModes = [
  "security privacy stale source of truth",
  "security privacy duplicate or replayed event",
  "security privacy policy or permission bypass",
  "security privacy downstream provider outage",
  "security privacy user-visible inconsistency"
];
const telemetry = [
  "riskScore",
  "tokenAgeMs",
