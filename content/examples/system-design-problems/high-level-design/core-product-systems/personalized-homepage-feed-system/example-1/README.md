# Design a personalized homepage/feed system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/core-product-systems/personalized-homepage-feed-system/example-1/app.ts`
