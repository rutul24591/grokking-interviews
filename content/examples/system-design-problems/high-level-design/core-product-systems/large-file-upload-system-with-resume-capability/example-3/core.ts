...
const topic = "Large File Upload System With Resume Capability";
const slug = "large-file-upload-system-with-resume-capability";
const domain = "core product";
const failureModes = [
  "core product stale source of truth",
  "core product duplicate or replayed event",
  "core product policy or permission bypass",
  "core product downstream provider outage",
  "core product user-visible inconsistency"
];
const telemetry = [
  "p95LatencyMs",
  "conflictCount",
