# Design a music/audio streaming frontend — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/core-product-systems/music-audio-streaming-frontend/example-1/app.ts`
