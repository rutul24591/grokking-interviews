# Design cross-device user settings sync — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/core-product-systems/cross-device-user-settings-sync/example-1/app.ts`
