# Design offline-first system (poor network) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/performance-scale-edge-cases/offline-first-system/example-1/app.ts`
