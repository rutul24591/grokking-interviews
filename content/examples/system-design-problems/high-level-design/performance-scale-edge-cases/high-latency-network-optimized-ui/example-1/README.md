# Design a high-latency network optimized UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/performance-scale-edge-cases/high-latency-network-optimized-ui/example-1/app.ts`
