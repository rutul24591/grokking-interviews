# Frontend FOR LOW END Devices - example-1 Explanation

## Article context
This example supports the article `high-level-design/performance-scale-edge-cases/frontend-for-low-end-devices`. The article is about Frontend FOR LOW END Devices. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
