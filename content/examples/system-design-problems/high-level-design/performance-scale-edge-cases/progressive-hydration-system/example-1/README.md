# Design a progressive hydration system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/performance-scale-edge-cases/progressive-hydration-system/example-1/app.ts`
