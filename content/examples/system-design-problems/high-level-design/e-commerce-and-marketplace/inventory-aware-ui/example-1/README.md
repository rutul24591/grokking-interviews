# Design an inventory-aware UI (real-time stock updates) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/e-commerce-and-marketplace/inventory-aware-ui/example-1/app.ts`
