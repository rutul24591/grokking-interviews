# Cart Checkout AT Scale With Concurrency - example-1 Explanation

## Article context
This example supports the article `high-level-design/e-commerce-and-marketplace/cart-checkout-at-scale-with-concurrency`. The article is about Cart Checkout AT Scale With Concurrency. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
