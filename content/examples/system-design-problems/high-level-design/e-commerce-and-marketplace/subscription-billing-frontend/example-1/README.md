# Design a subscription billing frontend — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/e-commerce-and-marketplace/subscription-billing-frontend/example-1/app.ts`
