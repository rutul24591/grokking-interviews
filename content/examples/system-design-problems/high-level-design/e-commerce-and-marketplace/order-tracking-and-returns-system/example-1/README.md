# Design an order tracking & returns system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/e-commerce-and-marketplace/order-tracking-and-returns-system/example-1/app.ts`
