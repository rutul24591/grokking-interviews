# Dynamic Pricing System UI - example-1 Explanation

## Article context
This example supports the article `high-level-design/e-commerce-and-marketplace/dynamic-pricing-system-ui`. The article is about Dynamic Pricing System UI. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
