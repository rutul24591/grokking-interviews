# Design a dynamic pricing system UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/e-commerce-and-marketplace/dynamic-pricing-system-ui/example-1/app.ts`
