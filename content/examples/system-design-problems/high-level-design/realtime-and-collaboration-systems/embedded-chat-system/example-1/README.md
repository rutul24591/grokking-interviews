# Design an embedded chat system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/realtime-and-collaboration-systems/embedded-chat-system/example-1/app.ts`
