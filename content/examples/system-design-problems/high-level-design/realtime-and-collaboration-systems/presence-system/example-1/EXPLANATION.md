# Design a Presence System (Online/Offline, Typing Indicators) - example-1 Explanation

## Article context
This example supports the article `high-level-design/realtime-and-collaboration-systems/presence-system`. The article is about Architecture for a real-time presence system: heartbeat-based online/offline detection, typing indicators, last-seen timestamps, privacy controls, and scalability to millions of users.. The most relevant article sections for this example are: Problem Clarification; Requirements; Functional Requirements; Non-Functional Requirements; High-Level Architecture; Detailed Design; Heartbeat Design and Offline Detection; Multi-Device Presence Aggregation; Fan-Out Architecture; Idle Detection and Activity Tracking.
