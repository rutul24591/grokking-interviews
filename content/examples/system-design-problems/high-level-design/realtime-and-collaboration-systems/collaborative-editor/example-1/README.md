# Design a collaborative editor — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/realtime-and-collaboration-systems/collaborative-editor/example-1/app.ts`
