# Design a cursor-sharing system (Figma-like) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/realtime-and-collaboration-systems/cursor-sharing-system/example-1/app.ts`
