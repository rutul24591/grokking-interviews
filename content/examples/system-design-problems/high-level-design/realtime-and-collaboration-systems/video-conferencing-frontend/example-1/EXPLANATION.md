# Design a Video Conferencing Frontend (Zoom/Google Meet Style) - example-1 Explanation

## Article context
This example supports the article `high-level-design/realtime-and-collaboration-systems/video-conferencing-frontend`. The article is about Architecture for a browser-based video conferencing client: WebRTC mesh vs SFU, media negotiation, adaptive quality, layout management, and resilience under poor network conditions.. The most relevant article sections for this example are: Problem Clarification; Requirements; Functional Requirements; Non-Functional Requirements; High-Level Architecture; Detailed Design; WebRTC Connection Setup; Simulcast and Adaptive Quality; Active Speaker Detection; Layout Management.
