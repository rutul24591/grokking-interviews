...
## Article context
This example supports the article `high-level-design/file-storage-cloud-drive-systems/file-sharing-and-permission-system`. The article is about File Sharing AND Permission System. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
