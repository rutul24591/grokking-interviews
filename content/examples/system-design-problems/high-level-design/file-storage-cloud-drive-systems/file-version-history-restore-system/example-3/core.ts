...
const slug = "file-version-history-restore-system";
const domain = "cloud file storage";
const failureModes = [
  "cloud file storage stale source of truth",
  "cloud file storage duplicate or replayed event",
  "cloud file storage policy or permission bypass",
  "cloud file storage downstream provider outage",
  "cloud file storage user-visible inconsistency"
];
const telemetry = [
  "orphanedObjectCount",
  "scanBacklog",
