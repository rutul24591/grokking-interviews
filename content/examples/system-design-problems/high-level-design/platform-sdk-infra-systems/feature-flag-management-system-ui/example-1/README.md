# Design a feature flag management system UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/platform-sdk-infra-systems/feature-flag-management-system-ui/example-1/app.ts`
