# Design a multi-brand design system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/platform-sdk-infra-systems/multi-brand-design-system/example-1/app.ts`
