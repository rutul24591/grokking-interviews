# Design an embeddable analytics SDK — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/platform-sdk-infra-systems/embeddable-analytics-sdk/example-1/app.ts`
