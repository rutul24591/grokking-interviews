# Design a multi-tenant SaaS admin dashboard — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/platform-sdk-infra-systems/multi-tenant-saas-admin-dashboard/example-1/app.ts`
