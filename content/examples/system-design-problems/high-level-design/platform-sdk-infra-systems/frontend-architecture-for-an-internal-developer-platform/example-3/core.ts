...
const slug = "frontend-architecture-for-an-internal-developer-platform";
const domain = "platform infrastructure";
const failureModes = [
  "platform infrastructure stale source of truth",
  "platform infrastructure duplicate or replayed event",
  "platform infrastructure policy or permission bypass",
  "platform infrastructure downstream provider outage",
  "platform infrastructure user-visible inconsistency"
];
const telemetry = [
  "sdkErrorRate",
  "buildDurationMs",
