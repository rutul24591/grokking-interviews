# Design a on-device AI inference UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/emerging-and-future-systems/on-device-ai-inference-ui/example-1/app.ts`
