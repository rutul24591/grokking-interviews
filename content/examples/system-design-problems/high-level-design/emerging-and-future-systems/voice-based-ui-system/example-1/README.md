# Design a voice-based UI system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/emerging-and-future-systems/voice-based-ui-system/example-1/app.ts`
