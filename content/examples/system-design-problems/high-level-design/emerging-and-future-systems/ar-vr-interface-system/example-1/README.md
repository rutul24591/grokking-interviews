# Design an AR/VR interface system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/emerging-and-future-systems/ar-vr-interface-system/example-1/app.ts`
