# Design a Web3 wallet frontend (like MetaMask) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/emerging-and-future-systems/web3-wallet-frontend/example-1/app.ts`
