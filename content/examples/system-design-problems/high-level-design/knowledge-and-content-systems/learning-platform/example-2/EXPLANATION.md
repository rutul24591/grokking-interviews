# Learning Platform - example-2 Explanation

## Article context
This example supports the article `high-level-design/knowledge-and-content-systems/learning-platform`. The article is about Learning Platform. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
