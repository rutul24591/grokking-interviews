# Design a learning platform (course + progress tracking) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/knowledge-and-content-systems/learning-platform/example-1/app.ts`
