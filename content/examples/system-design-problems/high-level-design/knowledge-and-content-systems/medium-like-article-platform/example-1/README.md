# Design a Medium-like article platform — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/knowledge-and-content-systems/medium-like-article-platform/example-1/app.ts`
