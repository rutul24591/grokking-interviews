# RAG Based UI System - Example 1

This example supports the HLD article for `rag-based-ui-system` in `ai-modern-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/ai-modern-systems/rag-based-ui-system/example-1/app.ts`
