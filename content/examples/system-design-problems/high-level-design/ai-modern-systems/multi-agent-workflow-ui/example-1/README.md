# Multi Agent Workflow UI - Example 1

This example supports the HLD article for `multi-agent-workflow-ui` in `ai-modern-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/ai-modern-systems/multi-agent-workflow-ui/example-1/app.ts`
