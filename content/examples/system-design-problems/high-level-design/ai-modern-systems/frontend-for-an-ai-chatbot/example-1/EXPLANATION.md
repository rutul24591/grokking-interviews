# Frontend FOR AN AI Chatbot - example-1 Explanation

## Article context
This example supports the article `high-level-design/ai-modern-systems/frontend-for-an-ai-chatbot`. The article is about Frontend FOR AN AI Chatbot. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
