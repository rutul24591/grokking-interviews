# Frontend FOR AN AI Chatbot - Example 1

This example supports the HLD article for `ai-chatbot-frontend` in `ai-modern-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/ai-modern-systems/frontend-for-an-ai-chatbot/example-1/app.ts`
