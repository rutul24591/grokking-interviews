# Design an AI-Generated Content Moderation UI - example-1 Explanation

## Article context
This example supports the article `high-level-design/ai-modern-systems/ai-generated-content-moderation-ui`. The article is about Architecture for a content moderation system: fast classifier plus LLM scorer pipeline, policy-based routing, human review queue with SLA, appeal system, feedback-driven classifier retraining, and drift detection.. The most relevant article sections for this example are: Clarifying the Requirements; Two-Stage Detection Pipeline; Policy-Based Routing; Human Review Queue; Appeal System; Feedback Loop and Classifier Retraining; Drift Detection and Monitoring; Interview Q&A; Q: How do you handle content moderation in a language the classifier wasn't trained on?; Q: How do you prevent reviewer bias from accumulating in the training data?.
