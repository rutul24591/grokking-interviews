...
const slug = "copilot-style-ai-assistant-inside-product-ui";
const domain = "AI product";
const failureModes = [
  "AI product stale source of truth",
  "AI product duplicate or replayed event",
  "AI product policy or permission bypass",
  "AI product downstream provider outage",
  "AI product user-visible inconsistency"
];
const telemetry = [
  "tokenLatencyMs",
  "retrievalConfidence",
