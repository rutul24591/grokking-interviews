# AI Prompt Management UI - Example 1

This example supports the HLD article for `ai-prompt-management-ui` in `ai-modern-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/ai-modern-systems/ai-prompt-management-ui/example-1/app.ts`
