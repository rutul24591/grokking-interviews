# AI Powered Search Interface - Example 1

This example supports the HLD article for `ai-powered-search-interface` in `ai-modern-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/ai-modern-systems/ai-powered-search-interface/example-1/app.ts`
