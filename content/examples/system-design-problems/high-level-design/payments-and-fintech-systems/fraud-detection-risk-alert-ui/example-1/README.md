# Design a fraud detection / risk alert UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/payments-and-fintech-systems/fraud-detection-risk-alert-ui/example-1/app.ts`
