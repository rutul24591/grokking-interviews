...
const slug = "transaction-history-and-reconciliation-ui";
const domain = "payments";
const failureModes = [
  "payments stale source of truth",
  "payments duplicate or replayed event",
  "payments policy or permission bypass",
  "payments downstream provider outage",
  "payments user-visible inconsistency"
];
const telemetry = [
  "authRate",
  "ledgerDriftCents",
