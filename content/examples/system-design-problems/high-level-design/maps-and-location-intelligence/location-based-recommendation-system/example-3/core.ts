...
const topic = "Location Based Recommendation System";
const slug = "location-based-recommendation-system";
const domain = "geospatial";
const failureModes = [
  "geospatial stale source of truth",
  "geospatial duplicate or replayed event",
  "geospatial policy or permission bypass",
  "geospatial downstream provider outage",
  "geospatial user-visible inconsistency"
];
const telemetry = [
  "tileCacheHitRate",
  "feedAgeMs",
