# Location Based Recommendation System - Example 1 Explanation

## Article alignment

This example supports `high-level-design/maps-location-intelligence/location-based-recommendation-system`. It maps to the regenerated article sections:
