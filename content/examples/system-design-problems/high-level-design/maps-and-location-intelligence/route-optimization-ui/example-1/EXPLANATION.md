# Route Optimization UI - Example 1 Explanation

## Article alignment

This example supports `high-level-design/maps-location-intelligence/route-optimization-ui`. It maps to the regenerated article sections:
...
- Failure modes: stale road closure, GPS spoofing, viewport overfetch, sensitive-location inference, route oscillation, optimizer timeout, unsafe restricted road
