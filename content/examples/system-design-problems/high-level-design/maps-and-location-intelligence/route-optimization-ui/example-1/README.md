# Design a route optimization UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/maps-and-location-intelligence/route-optimization-ui/example-1/app.ts`
