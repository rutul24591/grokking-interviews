...
const slug = "user-preference-learning-system";
const domain = "personalization";
const failureModes = [
  "personalization stale source of truth",
  "personalization duplicate or replayed event",
  "personalization policy or permission bypass",
  "personalization downstream provider outage",
  "personalization user-visible inconsistency"
];
const telemetry = [
  "featureAgeMs",
