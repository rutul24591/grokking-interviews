# Calendar System - example-1 Explanation

## Article context
This example supports the article `high-level-design/scheduling-and-calendar-systems/calendar-system`. The article is about Calendar System. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
