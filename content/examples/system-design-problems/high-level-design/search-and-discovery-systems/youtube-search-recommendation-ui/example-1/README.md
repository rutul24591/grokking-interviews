# Design YouTube search + recommendation UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/search-and-discovery-systems/youtube-search-recommendation-ui/example-1/app.ts`
