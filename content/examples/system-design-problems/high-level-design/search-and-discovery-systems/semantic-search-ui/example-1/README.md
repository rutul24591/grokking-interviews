# Design a semantic search UI (AI-powered) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/search-and-discovery-systems/semantic-search-ui/example-1/app.ts`
