# Design Google-like search frontend — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/search-and-discovery-systems/google-like-search-frontend/example-1/app.ts`
