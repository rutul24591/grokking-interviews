# Design faceted search for large datasets — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/search-and-discovery-systems/faceted-search-for-large-datasets/example-1/app.ts`
