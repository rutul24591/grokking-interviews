# Design a search analytics dashboard — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/search-and-discovery-systems/search-analytics-dashboard/example-1/app.ts`
