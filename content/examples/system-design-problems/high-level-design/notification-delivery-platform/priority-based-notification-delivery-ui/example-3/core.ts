...
const slug = "priority-based-notification-delivery-ui";
const domain = "notification delivery";
const failureModes = [
  "notification delivery stale source of truth",
  "notification delivery duplicate or replayed event",
  "notification delivery policy or permission bypass",
  "notification delivery downstream provider outage",
  "notification delivery user-visible inconsistency"
];
const telemetry = [
  "providerLatencyMs",
