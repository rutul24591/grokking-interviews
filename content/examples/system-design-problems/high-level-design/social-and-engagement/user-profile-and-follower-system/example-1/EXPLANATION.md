# User Profile AND Follower System - example-1 Explanation

## Article context
This example supports the article `high-level-design/social-and-engagement/user-profile-and-follower-system`. The article is about User Profile AND Follower System. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
