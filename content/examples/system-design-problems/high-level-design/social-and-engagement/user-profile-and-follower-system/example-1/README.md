# Design a user profile & follower system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/social-and-engagement/user-profile-and-follower-system/example-1/app.ts`
