# Design a content moderation & reporting UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/social-and-engagement/content-moderation-and-reporting-ui/example-1/app.ts`
