# Design Instagram / Twitter frontend — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/social-and-engagement/instagram-twitter-frontend/example-1/app.ts`
