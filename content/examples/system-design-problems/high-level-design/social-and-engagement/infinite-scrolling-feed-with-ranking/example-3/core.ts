...
const slug = "infinite-scrolling-feed-with-ranking";
const domain = "social engagement";
const failureModes = [
  "social engagement stale source of truth",
  "social engagement duplicate or replayed event",
  "social engagement policy or permission bypass",
  "social engagement downstream provider outage",
  "social engagement user-visible inconsistency"
];
const telemetry = [
  "rankScore",
  "followGraphDistance",
