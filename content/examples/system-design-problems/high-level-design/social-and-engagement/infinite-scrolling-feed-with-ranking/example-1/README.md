# Design infinite scrolling feed with ranking — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/social-and-engagement/infinite-scrolling-feed-with-ranking/example-1/app.ts`
