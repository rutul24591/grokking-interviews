# Design a dynamic config management UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/feature-configuration-admin-systems/dynamic-config-management-ui/example-1/app.ts`
