# Design a bulk data import system (CSV/Excel uploads) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/data-import-export-systems/bulk-data-import-system/example-1/app.ts`
