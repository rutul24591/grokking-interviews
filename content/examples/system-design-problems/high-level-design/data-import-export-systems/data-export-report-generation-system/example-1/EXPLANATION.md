# Design a Data Export / Report Generation System - example-1 Explanation

## Article context
This example supports the article `high-level-design/data-import-export-systems/data-export-report-generation-system`. The article is about Staff-level design of an async data export pipeline: cursor-paginated reads from OLAP/replicas, S3 multipart streaming render (CSV/Excel/PDF/Parquet), presigned download URLs, scheduled report cron, and delivery semantics.. The most relevant article sections for this example are: Problem Clarification; Requirements; Functional; Non-functional; High-Level Design; Detailed Design; Export Job Creation; Read Source: Read Replica vs. OLAP; Cursor-Paginated Query; Streaming Format Renderers.
