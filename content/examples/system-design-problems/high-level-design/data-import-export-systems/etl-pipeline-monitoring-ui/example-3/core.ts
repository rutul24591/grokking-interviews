...
const topic = "ETL Pipeline Monitoring UI";
const slug = "etl-pipeline-monitoring-ui";
const domain = "data movement";
const failureModes = [
  "data movement stale source of truth",
  "data movement duplicate or replayed event",
  "data movement policy or permission bypass",
  "data movement downstream provider outage",
  "data movement user-visible inconsistency"
];
const telemetry = [
  "invalidRowRate",
  "checkpointAgeMs",
