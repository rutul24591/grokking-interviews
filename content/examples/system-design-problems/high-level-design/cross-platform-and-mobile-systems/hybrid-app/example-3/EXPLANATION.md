# Hybrid APP - example-3 Explanation

## Article context
This example supports the article `high-level-design/cross-platform-and-mobile-systems/hybrid-app`. The article is about Hybrid APP. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
