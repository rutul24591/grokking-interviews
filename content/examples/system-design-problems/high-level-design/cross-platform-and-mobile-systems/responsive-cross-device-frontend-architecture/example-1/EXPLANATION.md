...
This example supports `high-level-design/cross-platform-mobile-systems/responsive-cross-device-architecture`. It maps to the regenerated article sections:
