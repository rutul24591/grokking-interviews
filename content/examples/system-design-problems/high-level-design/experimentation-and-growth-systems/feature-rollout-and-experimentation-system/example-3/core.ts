...
const topic = "Feature Rollout AND Experimentation System";
const slug = "feature-rollout-and-experimentation-system";
const domain = "experimentation";
const failureModes = [
  "experimentation stale source of truth",
  "experimentation duplicate or replayed event",
  "experimentation policy or permission bypass",
  "experimentation downstream provider outage",
  "experimentation user-visible inconsistency"
];
const telemetry = [
  "sampleRatioMismatch",
  "exposureLagMs",
