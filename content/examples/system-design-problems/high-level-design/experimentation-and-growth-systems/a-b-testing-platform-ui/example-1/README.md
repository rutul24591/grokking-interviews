# Design an A/B testing platform UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/experimentation-and-growth-systems/a-b-testing-platform-ui/example-1/app.ts`
