# Design an ads analytics dashboard — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/ads-and-monetization-systems/ads-analytics-dashboard/example-1/app.ts`
