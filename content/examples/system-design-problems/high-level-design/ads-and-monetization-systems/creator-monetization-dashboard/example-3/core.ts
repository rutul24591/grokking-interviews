...
const slug = "creator-monetization-dashboard";
const domain = "monetization";
const failureModes = [
  "monetization stale source of truth",
  "monetization duplicate or replayed event",
  "monetization policy or permission bypass",
  "monetization downstream provider outage",
  "monetization user-visible inconsistency"
];
const telemetry = [
  "spendDriftCents",
  "policyBlockRate",
