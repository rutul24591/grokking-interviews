# Design a creator monetization dashboard — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/ads-and-monetization-systems/creator-monetization-dashboard/example-1/app.ts`
