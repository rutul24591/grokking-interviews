# ADS Delivery AND Targeting UI - example-1 Explanation

## Article context
This example supports the article `high-level-design/ads-and-monetization-systems/ads-delivery-and-targeting-ui`. The article is about ADS Delivery AND Targeting UI. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
