...
## Article context
This example supports the article `high-level-design/data-heavy-systems/alerting-and-anomaly-detection-dashboard`. The article is about Alerting AND Anomaly Detection Dashboard. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
