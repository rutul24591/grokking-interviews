# Design a large dataset exploration UI (millions of rows) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/data-heavy-systems/large-dataset-exploration-ui/example-1/app.ts`
