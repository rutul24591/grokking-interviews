...
const slug = "real-time-analytics-with-10k-data-points";
const domain = "data dashboard";
const failureModes = [
  "data dashboard stale source of truth",
  "data dashboard duplicate or replayed event",
  "data dashboard policy or permission bypass",
  "data dashboard downstream provider outage",
  "data dashboard user-visible inconsistency"
];
const telemetry = [
  "queryCost",
  "freshnessLagMs",
