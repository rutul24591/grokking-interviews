# BI Dashboard - Example 1

This example supports the HLD article for `bi-dashboard` in `data-heavy-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/data-heavy-systems/bi-dashboard/example-1/app.ts`
