# Time Series Visualization System - Example 1

This example supports the HLD article for `time-series-visualization` in `data-heavy-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/data-heavy-systems/time-series-visualization-system/example-1/app.ts`
