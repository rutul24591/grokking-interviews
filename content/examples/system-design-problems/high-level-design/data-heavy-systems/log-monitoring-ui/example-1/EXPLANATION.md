# LOG Monitoring UI - Example 1 Explanation

## Article alignment

This example supports `high-level-design/data-heavy-systems/log-monitoring-ui`. It maps to the regenerated article sections:
