# LOG Monitoring UI - Example 1

This example supports the HLD article for `log-monitoring-ui` in `data-heavy-systems`.
...
`node --import tsx content/examples/system-design-problems/high-level-design/data-heavy-systems/log-monitoring-ui/example-1/app.ts`
