# Design a video player system (adaptive streaming, DRM) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/media-and-rich-content-systems/video-player-system/example-1/app.ts`
