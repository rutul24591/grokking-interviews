# Design a live streaming platform UI — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/media-and-rich-content-systems/live-streaming-platform-ui/example-1/app.ts`
