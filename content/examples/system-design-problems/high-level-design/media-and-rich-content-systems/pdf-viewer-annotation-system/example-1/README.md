# Design a PDF viewer + annotation system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/media-and-rich-content-systems/pdf-viewer-annotation-system/example-1/app.ts`
