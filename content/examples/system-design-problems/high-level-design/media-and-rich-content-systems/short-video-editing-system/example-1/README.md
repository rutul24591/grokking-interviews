# Design a short-video editing system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/media-and-rich-content-systems/short-video-editing-system/example-1/app.ts`
