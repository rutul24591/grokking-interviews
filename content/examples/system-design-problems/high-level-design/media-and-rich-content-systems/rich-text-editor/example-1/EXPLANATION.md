# Design a Rich Text Editor (Google Docs / Notion Style) - example-1 Explanation

## Article context
This example supports the article `high-level-design/media-and-rich-content-systems/rich-text-editor`. The article is about Architecture for a collaborative rich text editor: immutable document model with ProseMirror, Operational Transform for concurrent edits, plugin system for slash commands and @mentions, auto-save with IndexedDB draft, and real-time presence with remote cursors.. The most relevant article sections for this example are: Problem Clarification; Requirements; Functional Requirements; Non-Functional Requirements; High-Level Architecture; Detailed Design; Document Model and Transactions; Operational Transform for Collaboration; Presence and Remote Cursors; Auto-save and Draft Management.
