# Design a form builder system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/enterprise-saas-systems/form-builder-system/example-1/app.ts`
