# Form Builder System - Example 1 Explanation

## Article alignment

This example supports `high-level-design/enterprise-saas-systems/form-builder-system`. It maps to the regenerated article sections:
