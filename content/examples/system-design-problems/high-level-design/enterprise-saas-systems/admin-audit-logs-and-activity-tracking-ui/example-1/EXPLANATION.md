...
This example supports `high-level-design/enterprise-saas-systems/admin-audit-logs`. It maps to the regenerated article sections:
...
- Failure modes: cross-tenant data exposure, mis-scoped role, missing audit event, stuck approval, wrong analytics total
