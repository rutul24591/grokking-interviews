# Reporting AND Analytics Dashboard - Example 1 Explanation

## Article alignment

This example supports `high-level-design/enterprise-saas-systems/reporting-analytics-dashboard`. It maps to the regenerated article sections:
...
- Failure modes: cross-tenant data exposure, mis-scoped role, missing audit event, stuck approval, wrong analytics total, stale dashboard aggregate, missing drilldown evidence
