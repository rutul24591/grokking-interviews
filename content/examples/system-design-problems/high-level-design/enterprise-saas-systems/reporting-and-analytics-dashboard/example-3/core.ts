...
const topic = "Reporting AND Analytics Dashboard";
const slug = "reporting-and-analytics-dashboard";
const domain = "enterprise SaaS";
const failureModes = [
  "enterprise SaaS stale source of truth",
  "enterprise SaaS duplicate or replayed event",
  "enterprise SaaS policy or permission bypass",
  "enterprise SaaS downstream provider outage",
  "enterprise SaaS user-visible inconsistency"
];
const telemetry = [
  "permissionMismatch",
  "auditGapCount",
