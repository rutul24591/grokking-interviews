# CRM Dashboard - Example 1 Explanation

## Article alignment

This example supports `high-level-design/enterprise-saas-systems/crm-dashboard`. It maps to the regenerated article sections:
