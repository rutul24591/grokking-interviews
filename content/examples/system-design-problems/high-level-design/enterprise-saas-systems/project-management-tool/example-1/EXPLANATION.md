# Project Management Tool - Example 1 Explanation

## Article alignment

This example supports `high-level-design/enterprise-saas-systems/project-management-tool`. It maps to the regenerated article sections:
