# Design a workflow automation system (Zapier-like) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/enterprise-saas-systems/workflow-automation-system/example-1/app.ts`
