# Workflow Automation System - Example 1 Explanation

## Article alignment

This example supports `high-level-design/enterprise-saas-systems/workflow-automation-system`. It maps to the regenerated article sections:
