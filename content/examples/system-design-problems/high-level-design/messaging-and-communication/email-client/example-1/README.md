# Design email client (Gmail-like) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/messaging-and-communication/email-client/example-1/app.ts`
