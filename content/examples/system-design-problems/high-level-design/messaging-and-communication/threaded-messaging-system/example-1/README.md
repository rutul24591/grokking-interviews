# Design a threaded messaging system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/messaging-and-communication/threaded-messaging-system/example-1/app.ts`
