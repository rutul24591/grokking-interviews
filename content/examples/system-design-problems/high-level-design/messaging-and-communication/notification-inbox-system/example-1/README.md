# Design a notification inbox system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/messaging-and-communication/notification-inbox-system/example-1/app.ts`
