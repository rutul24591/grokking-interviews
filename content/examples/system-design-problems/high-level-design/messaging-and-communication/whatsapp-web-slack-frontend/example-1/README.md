# Design WhatsApp Web / Slack frontend — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/messaging-and-communication/whatsapp-web-slack-frontend/example-1/app.ts`
