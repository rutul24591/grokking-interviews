...
const slug = "multi-channel-communication-hub";
const domain = "messaging";
const failureModes = [
  "messaging stale source of truth",
  "messaging duplicate or replayed event",
  "messaging policy or permission bypass",
  "messaging downstream provider outage",
  "messaging user-visible inconsistency"
];
const telemetry = [
  "deliveryLagMs",
  "fanoutSize",
