# Design a multi-channel communication hub — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/messaging-and-communication/multi-channel-communication-hub/example-1/app.ts`
