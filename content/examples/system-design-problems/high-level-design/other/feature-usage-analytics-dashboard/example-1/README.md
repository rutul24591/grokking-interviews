# Design a feature usage analytics dashboard — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/other/feature-usage-analytics-dashboard/example-1/app.ts`
