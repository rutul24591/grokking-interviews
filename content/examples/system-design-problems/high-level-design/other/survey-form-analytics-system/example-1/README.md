# Design a survey/form analytics system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/other/survey-form-analytics-system/example-1/app.ts`
