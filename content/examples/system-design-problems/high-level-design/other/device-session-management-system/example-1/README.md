# Design a device/session management system — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/other/device-session-management-system/example-1/app.ts`
