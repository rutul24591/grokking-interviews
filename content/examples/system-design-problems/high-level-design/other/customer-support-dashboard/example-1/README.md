# Design a customer support dashboard (Zendesk-like) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/other/customer-support-dashboard/example-1/app.ts`
