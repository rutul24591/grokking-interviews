...
This example supports `high-level-design/error-handling-reliability-systems/incident-debugging-dashboard`. It maps to the regenerated article sections:
...
- Failure modes: retry storm, silent fallback, uncorrelated user error, stale status page, missing recovery signal, stale dashboard aggregate, missing drilldown evidence
