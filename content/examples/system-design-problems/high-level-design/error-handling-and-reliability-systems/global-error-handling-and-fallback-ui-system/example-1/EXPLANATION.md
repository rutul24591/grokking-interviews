...
This example supports `high-level-design/error-handling-reliability-systems/global-error-handling-fallback-ui`. It maps to the regenerated article sections:
