...
const slug = "global-error-handling-and-fallback-ui-system";
const domain = "reliability";
const failureModes = [
  "reliability stale source of truth",
  "reliability duplicate or replayed event",
  "reliability policy or permission bypass",
  "reliability downstream provider outage",
  "reliability user-visible inconsistency"
];
const telemetry = [
  "errorBudgetBurn",
  "retryAttempt",
