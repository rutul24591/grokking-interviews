# Design an API playground (like Postman) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/developer-experience-systems/api-playground/example-1/app.ts`
