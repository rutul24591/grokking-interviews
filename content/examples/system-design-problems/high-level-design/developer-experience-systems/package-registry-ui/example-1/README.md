# Design a package registry UI (like npm) — Example 1

## Run (smoke)
`node --import tsx content/examples/system-design-problems/high-level-design/developer-experience-systems/package-registry-ui/example-1/app.ts`
