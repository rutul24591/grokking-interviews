# CI CD Dashboard - example-2 Explanation

## Article context
This example supports the article `high-level-design/developer-experience-systems/ci-cd-dashboard`. The article is about CI CD Dashboard. The most relevant article sections for this example are: Definition and context; Core concepts; Architecture and flow; Best practices.
