export type aiFeedbackLoopUiSignal = {
...
export type aiFeedbackLoopUiEvent = {
  id: string;
  topic: "ai-feedback-loop-ui";
  actorId: string;
  sequence: number;
  receivedAtMs: number;
  ...
  payloadSize: number;
  signal: aiFeedbackLoopUiSignal;
};

export type aiFeedbackLoopUiDecision = {
  accepted: boolean;
...
export function evaluateAiFeedbackLoopUiEvent(event: aiFeedbackLoopUiEvent): aiFeedbackLoopUiDecision {
  ...
  let action: aiFeedbackLoopUiDecision["action"] = "commit";
...
export function runAiFeedbackLoopUiContractScenario() {
  const base = Date.parse("2026-05-29T09:00:00.000Z");
  const accepted = evaluateAiFeedbackLoopUiEvent({
    id: "ai-feedback-loop-ui-evt-1",
    topic: "ai-feedback-loop-ui",
    actorId: "user-42",
    sequence: 7,
    receivedAtMs: base,
  ...
  const guarded = evaluateAiFeedbackLoopUiEvent({
    id: "ai-feedback-loop-ui-evt-late",
    topic: "ai-feedback-loop-ui",
    actorId: "user-42",
    sequence: 8,
