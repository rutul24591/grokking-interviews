export type intersectionobserverLazySystemSignal = {
...
export type intersectionobserverLazySystemEvent = {
  id: string;
  ...
  payloadSize: number;
  signal: intersectionobserverLazySystemSignal;
};

export type intersectionobserverLazySystemDecision = {
  accepted: boolean;
...
export function evaluateIntersectionobserverLazySystemEvent(event: intersectionobserverLazySystemEvent): intersectionobserverLazySystemDecision {
  ...
  let action: intersectionobserverLazySystemDecision["action"] = "commit";
...
export function runIntersectionobserverLazySystemContractScenario() {
  const base = Date.parse("2026-05-29T09:00:00.000Z");
  const accepted = evaluateIntersectionobserverLazySystemEvent({
    id: "intersectionobserver-lazy-system-evt-1",
    topic: "intersectionobserver-lazy-system",
    actorId: "user-42",
    sequence: 7,
    receivedAtMs: base,
  ...
  const guarded = evaluateIntersectionobserverLazySystemEvent({
    id: "intersectionobserver-lazy-system-evt-late",
    topic: "intersectionobserver-lazy-system",
    actorId: "user-42",
    sequence: 8,
