export type GlobalEventBusEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type GlobalEventBusState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const globalEventBusTransitions: Array<Transition<GlobalEventBusEvent, GlobalEventBusState>> = [
...
export function buildGlobalEventBusTransitionTable(): TransitionTable<GlobalEventBusEvent, GlobalEventBusState> {
  return new TransitionTable<GlobalEventBusEvent, GlobalEventBusState>("idle", globalEventBusTransitions);
}
