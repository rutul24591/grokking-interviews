export type AsyncStateHandlingEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type AsyncStateHandlingState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const asyncStateHandlingTransitions: Array<Transition<AsyncStateHandlingEvent, AsyncStateHandlingState>> = [
...
export function buildAsyncStateHandlingTransitionTable(): TransitionTable<AsyncStateHandlingEvent, AsyncStateHandlingState> {
  return new TransitionTable<AsyncStateHandlingEvent, AsyncStateHandlingState>("idle", asyncStateHandlingTransitions);
}
