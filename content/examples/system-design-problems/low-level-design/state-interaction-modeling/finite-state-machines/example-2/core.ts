export type FiniteStateMachinesEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type FiniteStateMachinesState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const finiteStateMachinesTransitions: Array<Transition<FiniteStateMachinesEvent, FiniteStateMachinesState>> = [
...
export function buildFiniteStateMachinesTransitionTable(): TransitionTable<FiniteStateMachinesEvent, FiniteStateMachinesState> {
  return new TransitionTable<FiniteStateMachinesEvent, FiniteStateMachinesState>("idle", finiteStateMachinesTransitions);
}
