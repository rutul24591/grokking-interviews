export type UndoRedoEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type UndoRedoState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const undoRedoTransitions: Array<Transition<UndoRedoEvent, UndoRedoState>> = [
...
export function buildUndoRedoTransitionTable(): TransitionTable<UndoRedoEvent, UndoRedoState> {
  return new TransitionTable<UndoRedoEvent, UndoRedoState>("idle", undoRedoTransitions);
}
