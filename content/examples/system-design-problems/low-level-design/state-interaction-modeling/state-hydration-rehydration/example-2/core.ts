export type StateHydrationRehydrationEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type StateHydrationRehydrationState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const stateHydrationRehydrationTransitions: Array<Transition<StateHydrationRehydrationEvent, StateHydrationRehydrationState>> = [
...
export function buildStateHydrationRehydrationTransitionTable(): TransitionTable<StateHydrationRehydrationEvent, StateHydrationRehydrationState> {
  return new TransitionTable<StateHydrationRehydrationEvent, StateHydrationRehydrationState>("idle", stateHydrationRehydrationTransitions);
}
