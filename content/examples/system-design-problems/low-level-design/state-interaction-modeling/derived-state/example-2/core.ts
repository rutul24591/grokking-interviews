export type DerivedStateEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type DerivedStateState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const derivedStateTransitions: Array<Transition<DerivedStateEvent, DerivedStateState>> = [
...
export function buildDerivedStateTransitionTable(): TransitionTable<DerivedStateEvent, DerivedStateState> {
  return new TransitionTable<DerivedStateEvent, DerivedStateState>("idle", derivedStateTransitions);
}
