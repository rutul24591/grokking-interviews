export type CrossTabStateSyncEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type CrossTabStateSyncState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const crossTabStateSyncTransitions: Array<Transition<CrossTabStateSyncEvent, CrossTabStateSyncState>> = [
...
export function buildCrossTabStateSyncTransitionTable(): TransitionTable<CrossTabStateSyncEvent, CrossTabStateSyncState> {
  return new TransitionTable<CrossTabStateSyncEvent, CrossTabStateSyncState>("idle", crossTabStateSyncTransitions);
}
