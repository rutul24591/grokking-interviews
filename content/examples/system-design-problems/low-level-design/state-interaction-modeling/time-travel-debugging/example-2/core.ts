export type TimeTravelDebuggingEvent = "start" | "resolve" | "fail" | "cancel" | "reset";
export type TimeTravelDebuggingState = "idle" | "pending" | "success" | "error" | "cancelled";
...
export const timeTravelDebuggingTransitions: Array<Transition<TimeTravelDebuggingEvent, TimeTravelDebuggingState>> = [
...
export function buildTimeTravelDebuggingTransitionTable(): TransitionTable<TimeTravelDebuggingEvent, TimeTravelDebuggingState> {
  return new TransitionTable<TimeTravelDebuggingEvent, TimeTravelDebuggingState>("idle", timeTravelDebuggingTransitions);
}
