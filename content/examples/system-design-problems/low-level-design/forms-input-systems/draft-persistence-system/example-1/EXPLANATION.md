...
- `draft-store.ts`: Models client or service state transitions and update behavior.
- `merge.ts`: Implements the main logic, including mergeByDirtyFields, merged, conflicts, key, localChanged.
- `README.md`: Documents how to run, inspect, or reason about the example.
- `storage-adapter.ts`: Implements the main logic, including getLocalStorage, loadDraft, ls, raw, parsed.
