# Design an AI-assisted Form Fill System - example-2 Explanation
...
- `cancellation-token.ts`: Implements the main logic, including createCancellationToken, canceled.
