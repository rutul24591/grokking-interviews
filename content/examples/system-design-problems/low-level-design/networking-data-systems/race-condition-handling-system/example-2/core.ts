export type RaceConditionHandlingSystemExample2Operation = {
  key: string;
  tenantId: string;
  sequence: number;
  startedAtMs: number;
...
export type RaceConditionHandlingSystemExample2RuntimeState = {
...
export type RaceConditionHandlingSystemExample2Decision = {
  action:
    | "start-transport"
    | "reuse-inflight"
    ...
    | "commit";
  reasons: string[];
  nextState: RaceConditionHandlingSystemExample2RuntimeState;
...
export function evaluateRaceConditionHandlingSystemExample2(
  operation: RaceConditionHandlingSystemExample2Operation,
  state: RaceConditionHandlingSystemExample2RuntimeState,
  nowMs: number,
): RaceConditionHandlingSystemExample2Decision {
  ...
  let action: RaceConditionHandlingSystemExample2Decision["action"] = "start-transport";
...
export function runRaceConditionHandlingSystemExample2Scenario() {
  const nowMs = Date.parse("2026-05-29T10:00:00.000Z");
  const baseState: RaceConditionHandlingSystemExample2RuntimeState = {
    currentSequence: 8,
    status: "loading",
    cacheAgeMs: 120_000,
    subscribers: 2,
  ...
  const operation: RaceConditionHandlingSystemExample2Operation = {
  ...
  return evaluateRaceConditionHandlingSystemExample2(operation, baseState, nowMs);
}
