export type PollingVsWebsocketSystemExample2Operation = {
  key: string;
  tenantId: string;
  sequence: number;
  startedAtMs: number;
...
export type PollingVsWebsocketSystemExample2RuntimeState = {
...
export type PollingVsWebsocketSystemExample2Decision = {
  action:
    | "start-transport"
    | "reuse-inflight"
    ...
    | "commit";
  reasons: string[];
  nextState: PollingVsWebsocketSystemExample2RuntimeState;
...
export function evaluatePollingVsWebsocketSystemExample2(
  operation: PollingVsWebsocketSystemExample2Operation,
  state: PollingVsWebsocketSystemExample2RuntimeState,
  nowMs: number,
): PollingVsWebsocketSystemExample2Decision {
  ...
  let action: PollingVsWebsocketSystemExample2Decision["action"] = "start-transport";
...
export function runPollingVsWebsocketSystemExample2Scenario() {
  const nowMs = Date.parse("2026-05-29T10:00:00.000Z");
  const baseState: PollingVsWebsocketSystemExample2RuntimeState = {
    currentSequence: 8,
    status: "loading",
    cacheAgeMs: 120_000,
    subscribers: 2,
  ...
  const operation: PollingVsWebsocketSystemExample2Operation = {
  ...
  return evaluatePollingVsWebsocketSystemExample2(operation, baseState, nowMs);
}
