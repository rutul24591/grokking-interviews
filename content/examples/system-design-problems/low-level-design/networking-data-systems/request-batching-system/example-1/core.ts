export type RequestBatchingSystemExample1Operation = {
  key: string;
  tenantId: string;
  sequence: number;
  startedAtMs: number;
...
export type RequestBatchingSystemExample1RuntimeState = {
...
export type RequestBatchingSystemExample1Decision = {
  action:
    | "start-transport"
    | "reuse-inflight"
    ...
    | "commit";
  reasons: string[];
  nextState: RequestBatchingSystemExample1RuntimeState;
...
export function evaluateRequestBatchingSystemExample1(
  operation: RequestBatchingSystemExample1Operation,
  state: RequestBatchingSystemExample1RuntimeState,
  nowMs: number,
): RequestBatchingSystemExample1Decision {
  ...
  let action: RequestBatchingSystemExample1Decision["action"] = "start-transport";
...
export function runRequestBatchingSystemExample1Scenario() {
  const nowMs = Date.parse("2026-05-29T10:00:00.000Z");
  const baseState: RequestBatchingSystemExample1RuntimeState = {
    currentSequence: 8,
    status: "idle",
    cacheAgeMs: 60_000,
    subscribers: 1,
  ...
  const operation: RequestBatchingSystemExample1Operation = {
  ...
  return evaluateRequestBatchingSystemExample1(operation, baseState, nowMs);
}
