export type RequestBatchingSystemExample3Operation = {
  key: string;
  tenantId: string;
  sequence: number;
  startedAtMs: number;
...
export type RequestBatchingSystemExample3RuntimeState = {
...
export type RequestBatchingSystemExample3Decision = {
  action:
    | "start-transport"
    | "reuse-inflight"
    ...
    | "commit";
  reasons: string[];
  nextState: RequestBatchingSystemExample3RuntimeState;
...
export function evaluateRequestBatchingSystemExample3(
  operation: RequestBatchingSystemExample3Operation,
  state: RequestBatchingSystemExample3RuntimeState,
  nowMs: number,
): RequestBatchingSystemExample3Decision {
  ...
  let action: RequestBatchingSystemExample3Decision["action"] = "start-transport";
...
export function runRequestBatchingSystemExample3Scenario() {
  const nowMs = Date.parse("2026-05-29T10:00:00.000Z");
  const baseState: RequestBatchingSystemExample3RuntimeState = {
    currentSequence: 8,
    status: "success",
    cacheAgeMs: 2_000,
    subscribers: 3,
  ...
  const operation: RequestBatchingSystemExample3Operation = {
  ...
  return evaluateRequestBatchingSystemExample3(operation, baseState, nowMs);
}
