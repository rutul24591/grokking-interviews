export type FrontendCachingLayerExample2Operation = {
  key: string;
  tenantId: string;
  sequence: number;
  startedAtMs: number;
...
export type FrontendCachingLayerExample2RuntimeState = {
...
export type FrontendCachingLayerExample2Decision = {
  action:
    | "start-transport"
    | "reuse-inflight"
    ...
    | "commit";
  reasons: string[];
  nextState: FrontendCachingLayerExample2RuntimeState;
...
export function evaluateFrontendCachingLayerExample2(
  operation: FrontendCachingLayerExample2Operation,
  state: FrontendCachingLayerExample2RuntimeState,
  nowMs: number,
): FrontendCachingLayerExample2Decision {
  ...
  let action: FrontendCachingLayerExample2Decision["action"] = "start-transport";
...
export function runFrontendCachingLayerExample2Scenario() {
  const nowMs = Date.parse("2026-05-29T10:00:00.000Z");
  const baseState: FrontendCachingLayerExample2RuntimeState = {
    currentSequence: 8,
    status: "loading",
    cacheAgeMs: 120_000,
    subscribers: 2,
  ...
  const operation: FrontendCachingLayerExample2Operation = {
  ...
  return evaluateFrontendCachingLayerExample2(operation, baseState, nowMs);
}
