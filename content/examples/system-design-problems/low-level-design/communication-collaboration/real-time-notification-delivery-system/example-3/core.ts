export type realTimeNotificationDeliverySystemRuntimeState = {
...
export type realTimeNotificationDeliverySystemRecoveryPlan = {
...
export function planRealTimeNotificationDeliverySystemRecovery(
  state: realTimeNotificationDeliverySystemRuntimeState,
  nowMs: number,
): realTimeNotificationDeliverySystemRecoveryPlan {
  const evidence: string[] = [];
  const actions: realTimeNotificationDeliverySystemRecoveryPlan["actions"] = ["emit-telemetry"];
...
export function runRealTimeNotificationDeliverySystemEdgeCaseScenario() {
  const nowMs = Date.parse("2026-05-29T09:15:00.000Z");
  const normal = planRealTimeNotificationDeliverySystemRecovery(
    {
      topic: "real-time-notification-delivery-system",
      mounted: true,
  ...
  const failure = planRealTimeNotificationDeliverySystemRecovery(
    {
      topic: "real-time-notification-delivery-system",
      mounted: true,
      lastSuccessfulVersion: 21,
