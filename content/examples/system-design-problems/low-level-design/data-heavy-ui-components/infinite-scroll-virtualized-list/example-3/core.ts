export type infiniteScrollVirtualizedListRuntimeState = {
...
export type infiniteScrollVirtualizedListRecoveryPlan = {
...
export function planInfiniteScrollVirtualizedListRecovery(
  state: infiniteScrollVirtualizedListRuntimeState,
  nowMs: number,
): infiniteScrollVirtualizedListRecoveryPlan {
  const evidence: string[] = [];
  const actions: infiniteScrollVirtualizedListRecoveryPlan["actions"] = ["emit-telemetry"];
...
export function runInfiniteScrollVirtualizedListEdgeCaseScenario() {
  const nowMs = Date.parse("2026-05-29T09:15:00.000Z");
  const normal = planInfiniteScrollVirtualizedListRecovery(
    {
      topic: "infinite-scroll-virtualized-list",
      mounted: true,
  ...
  const failure = planInfiniteScrollVirtualizedListRecovery(
    {
      topic: "infinite-scroll-virtualized-list",
      mounted: true,
      lastSuccessfulVersion: 21,
