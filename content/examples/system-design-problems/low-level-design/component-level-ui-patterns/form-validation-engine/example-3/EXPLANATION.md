# Design a Form Validation Engine - example-3 Explanation
...
- `i18n-validation-messages.ts`: Implements the main logic, including ValidationMessageRegistry, template, localeValidators, validateWithLocale, errors.
- `rule-engine.ts`: Implements the main logic, including RuleEngine, rule, error, validator, error.
