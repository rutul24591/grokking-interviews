# Design an Accordion / Collapsible Section - example-2 Explanation
...
- `nested-keyboard-navigation.ts`: Implements the main logic, including useAccordionKeyboard, itemRefs, registerItem, onKeyDown, targetIndex.
