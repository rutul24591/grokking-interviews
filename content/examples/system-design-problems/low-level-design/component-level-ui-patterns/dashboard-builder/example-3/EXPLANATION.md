# Design a Dashboard Builder - example-3 Explanation
...
- `performance-optimization.ts`: Implements the main logic, including useThrottledWidgetRender, lastRenderRef, rafRef, now, elapsed.
- `staggered-data-fetching.ts`: Implements the main logic, including DashboardDataFetcher, cacheKey, cached, pending, promise.
- `widget-communication.ts`: Implements the main logic, including DashboardEventBus, handlers, handler, mappedFilter.
