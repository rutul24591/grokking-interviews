...
- `layout-collision-resolution.ts`: Implements the main logic, including resolveCollisions, result, movedIndex, moved, changed.
- `widget-data-deduplication.ts`: Implements the main logic, including WidgetDataDeduplicator, cacheKey, cached, pending, promise.
