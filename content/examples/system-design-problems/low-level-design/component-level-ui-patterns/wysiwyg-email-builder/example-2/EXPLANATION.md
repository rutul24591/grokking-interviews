# Design a WYSIWYG Email Template Builder - example-2 Explanation
...
- `html-export.ts`: Implements the main logic, including generateEmailHTML, bodyContent, src, alt, url.
