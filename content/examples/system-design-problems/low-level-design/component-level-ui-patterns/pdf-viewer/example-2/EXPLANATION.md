# Design a PDF Viewer Component - example-2 Explanation
...
- `pdf-text-search.ts`: Implements the main logic, including extractPageText, searchPdf, matches, searchTerm, escapedQuery.
