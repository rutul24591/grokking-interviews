# Design a Theme / Theming System - example-2 Explanation
...
- `css-variable-transition.ts`: Implements the main logic, including applyThemeTransition, preloadAndApplyTheme, supportsCSSTransitions, el, computed.
