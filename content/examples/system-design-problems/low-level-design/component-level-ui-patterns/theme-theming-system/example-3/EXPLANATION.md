# Design a Theme / Theming System - example-3 Explanation
...
- `automated-accessibility-auditing.ts`: Implements the main logic, including auditThemeContrast, passing, failing, pairs, fgColor.
- `runtime-theme-switching.ts`: Runs the main scenario and connects the supporting modules into an end-to-end flow.
