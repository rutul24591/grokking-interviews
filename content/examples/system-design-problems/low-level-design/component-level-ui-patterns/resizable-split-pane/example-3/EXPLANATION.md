...
- `collaborative-layout.ts`: Implements the main logic, including CollaborativeLayoutManager, snapshot.
- `persistence-strategy.ts`: Implements the main logic, including MultiUserLayoutManager, layout, previous.
