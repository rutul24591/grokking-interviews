export interface BreadcrumbComponentTimer{id:string;
remainingMs:number;
startedAtMs:number;
pausedAtMs?:number;
}export class BreadcrumbComponentTimerRegistry{private timers=new Map<string,BreadcrumbComponentTimer>();
...
}}export function runBreadcrumbComponentTimerScenario(){const r=new BreadcrumbComponentTimerRegistry();
