...
- `collaborative-editing.ts`: Implements the main logic, including CollaborativeCursorManager, offsetToDomPosition, currentOffset, walker, node.
- `performance-optimization.ts`: Implements the main logic, including ImmutableEditorDoc, hash, useVirtualizedEditor, getVisibleBlocks, start.
