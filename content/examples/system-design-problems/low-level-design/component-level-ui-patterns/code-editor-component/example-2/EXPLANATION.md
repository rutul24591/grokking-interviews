...
- `ime-composition-handling.ts`: Implements the main logic, including useIMEComposition, compositionTextRef, pendingChangeRef, onCompositionStart, onCompositionUpdate.
- `paste-sanitization.ts`: Implements the main logic, including sanitizePastedCode, content, normalizeIndentation, lines, indents.
