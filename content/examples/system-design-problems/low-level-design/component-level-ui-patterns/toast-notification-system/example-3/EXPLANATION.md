# Design a Toast / Notification System - example-3 Explanation
...
- `accessibility-deep-dive.ts`: Implements the main logic, including ToastAnnouncementQueue, now, elapsed, message, wordCount.
- `performance-optimization.ts`: Implements the main logic, including animateToastPosition, toastEl, batchToastUpdates, el, createToastWorker.
