export interface ToastNotificationSystemTimer{id:string;
remainingMs:number;
startedAtMs:number;
pausedAtMs?:number;
}export class ToastNotificationSystemTimerRegistry{private timers=new Map<string,ToastNotificationSystemTimer>();
...
}}export function runToastNotificationSystemTimerScenario(){const r=new ToastNotificationSystemTimerRegistry();
