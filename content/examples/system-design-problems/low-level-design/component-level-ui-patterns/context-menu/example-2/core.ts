export interface ContextMenuTimer{id:string;
remainingMs:number;
startedAtMs:number;
pausedAtMs?:number;
}export class ContextMenuTimerRegistry{private timers=new Map<string,ContextMenuTimer>();
...
}}export function runContextMenuTimerScenario(){const r=new ContextMenuTimerRegistry();
