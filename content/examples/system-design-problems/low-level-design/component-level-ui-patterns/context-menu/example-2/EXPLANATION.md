# Design a Context Menu / Right-click Menu - example-2 Explanation
...
- `boundary-flip.ts`: Implements the main logic, including MARGIN, calculateMenuPosition, x, y, flippedX.
- `nested-submenu-manager.ts`: Implements the main logic, including SubMenuManager, closed, parentId.
