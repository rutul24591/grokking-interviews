# Design a Context Menu / Right-click Menu - example-3 Explanation
...
- `nested-submenu-architecture.ts`: Implements the main logic, including useNestedContextMenu, menuRef, openSubMenu, closeTopMenu, closeAll.
- `touch-device-adaptation.ts`: Implements the main logic, including useAdaptiveContextMenu, longPressTimerRef, LONG_PRESS_DELAY, onTriggerStart, touch.
