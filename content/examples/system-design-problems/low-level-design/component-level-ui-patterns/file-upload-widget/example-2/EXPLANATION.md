# Design a File Upload Widget - example-2 Explanation
...
- `chunk-upload-recovery.ts`: Implements the main logic, including STORE_NAME, DB_NAME, DB_VERSION, openDB, request.
- `folder-upload.ts`: Implements the main logic, including buildFileTree, root, pathMap, file, relativePath.
