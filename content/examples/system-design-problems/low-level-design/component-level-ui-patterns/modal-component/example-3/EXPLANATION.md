# Design a Modal / Dialog Component - example-3 Explanation
...
- `accessibility-testing-strategy.ts`: Exercises behavior and guards important edge cases or invariants.
- `focus-trap-edge-cases.ts`: Implements the main logic, including AdvancedFocusTrap, focusable, focusable, check, focusable.
