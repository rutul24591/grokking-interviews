# Design a Map-based UI - example-3 Explanation
...
- `offline-map-support.ts`: Implements the main logic, including OfflineTileCache, request, db, db, tx.
- `spatial-indexing.ts`: Implements the main logic, including MarkerQuadtree, child, results, marker, child.
