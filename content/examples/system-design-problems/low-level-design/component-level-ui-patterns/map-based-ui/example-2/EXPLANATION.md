# Design a Map-based UI - example-2 Explanation
...
- `marker-clustering.ts`: Implements the main logic, including getCellSizeForZoom, clusterMarkers, cellSize, grid, marker.
