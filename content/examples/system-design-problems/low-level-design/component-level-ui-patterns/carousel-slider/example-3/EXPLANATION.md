...
- `accessibility-deep-dive.ts`: Implements the main logic, including useAriaCarousel, onKeyDown, useCarouselAnnouncements, liveRegionRef, label.
- `performance-benchmarking.ts`: Implements the main logic, including benchmarkCarouselTransition, times, frameDrops, i, start.
