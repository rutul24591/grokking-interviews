# Design a Drag & Drop List with Reordering and Accessibility - example-3 Explanation
...
- `accessibility-testing.ts`: Exercises behavior and guards important edge cases or invariants.
- `multi-list-transfer.ts`: Implements the main logic, including MultiListDragManager, operation, index.
