# Design a Drag & Drop List with Reordering and Accessibility - example-2 Explanation
...
- `keyboard-drag.ts`: Implements the main logic, including useKeyboardDrag, focusedIndexRef, onFocusItem, onKeyDown, getItemState.
- `touch-drag-fallback.ts`: Implements the main logic, including useTouchDrag, longPressTimerRef, pointerIdRef, onPointerDown, onPointerMove.
