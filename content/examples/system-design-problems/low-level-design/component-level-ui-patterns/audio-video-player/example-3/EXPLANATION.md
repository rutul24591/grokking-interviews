...
- `accessibility-deep-dive.ts`: Implements the main logic, including CaptionManager, activeCues, text, AudioDescriptionManager.
- `adaptive-bitrate-streaming.ts`: Implements the main logic, including AdaptiveBitrateManager, avgBandwidth, targetBandwidth, bestIndex, i.
