...
- `analytics-integration.ts`: Implements the main logic, including WizardAnalyticsTracker, step, step, step, rates.
- `form-persistence-strategy.ts`: Implements the main logic, including FormDraftManager, fullDraft, raw, draft, ageMs.
