# Design a Pagination Component - example-3 Explanation
...
- `cursor-based-pagination.ts`: Implements the main logic, including encodeCursor, decodeCursor, fetchCursorPage, result, startCursor.
- `deep-link-pagination.ts`: Implements the main logic, including useDeepLinkPagination, params, page, pageSize, validPage.
