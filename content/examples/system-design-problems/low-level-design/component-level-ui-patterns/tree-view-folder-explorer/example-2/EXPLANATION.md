# Design a Tree View / Folder Explorer - example-2 Explanation
...
- `circular-reference-detection.ts`: Implements the main logic, including buildAdjacencyList, adj, wouldCreateCycle, queue, visited.
