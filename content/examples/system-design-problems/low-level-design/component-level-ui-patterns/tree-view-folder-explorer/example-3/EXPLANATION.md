# Design a Tree View / Folder Explorer - example-3 Explanation
...
- `lazy-loading-performance.ts`: Implements the main logic, including LazyTreeLoader, promise.
- `virtualized-tree.ts`: Implements the main logic, including flattenTree, result, node, handleTreeKeyboardNavigation, newIndex.
