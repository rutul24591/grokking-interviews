export interface ReusableButtonSystemTimer{id:string;
remainingMs:number;
startedAtMs:number;
pausedAtMs?:number;
}export class ReusableButtonSystemTimerRegistry{private timers=new Map<string,ReusableButtonSystemTimer>();
...
}}export function runReusableButtonSystemTimerScenario(){const r=new ReusableButtonSystemTimerRegistry();
