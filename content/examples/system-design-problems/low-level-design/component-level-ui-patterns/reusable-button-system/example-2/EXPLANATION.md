# Design a Reusable Button System - example-2 Explanation
...
- `ripple-performance.ts`: Implements the main logic, including MAX_CONCURRENT_RIPPLES, useRippleAnimation, ripplesRef, containerRef, createRipple.
