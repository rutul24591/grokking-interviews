...
- `collision-detection.ts`: Implements the main logic, including eventsOverlap, detectCollisions, sorted, timeDiff, columns.
- `recurring-expansion.ts`: Implements the main logic, including expandRecurringEvents, occurrences, current, count, nextMonth.
