# Design a Rating / Stars Component with Keyboard Interaction and ARIA - example-2 Explanation
...
- `half-star-detection.ts`: Implements the main logic, including useHalfStarDetection, onMouseMove, rect, relativeX, ratio.
- `hover-preview-race.ts`: Implements the main logic, including useHoverDebounce, timerRef, lastValueRef, onHoverStart, onHoverEnd.
