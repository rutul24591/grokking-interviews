export interface LoadingSkeletonTimer{id:string;
remainingMs:number;
startedAtMs:number;
pausedAtMs?:number;
}export class LoadingSkeletonTimerRegistry{private timers=new Map<string,LoadingSkeletonTimer>();
...
}}export function runLoadingSkeletonTimerScenario(){const r=new LoadingSkeletonTimerRegistry();
