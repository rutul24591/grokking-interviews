# Design a Loading Skeleton Component - example-2 Explanation
...
- `delay-threshold.ts`: Implements the main logic, including useLoadingThreshold, startTimeRef, skeletonTimer, fallbackTimer.
- `flash-prevention.ts`: Implements the main logic, including useFlashPrevention, skeletonShowTimeRef, timer, elapsed, remaining.
