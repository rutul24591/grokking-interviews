# Design a Payment / Checkout UI - example-2 Explanation
...
- `payment-idempotency.ts`: Implements the main logic, including generateIdempotencyKey, checkIdempotency, processPayment, idempotencyKey, existing.
- `three-d-secure-flow.ts`: Implements the main logic, including handleThreeDSecure, processPaymentWith3DS, intentId.
