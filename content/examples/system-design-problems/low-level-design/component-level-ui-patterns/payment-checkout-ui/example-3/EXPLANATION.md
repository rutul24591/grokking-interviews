# Design a Payment / Checkout UI - example-3 Explanation
...
- `fraud-detection.ts`: Implements the main logic, including FraudSignalCollector, timeSpan.
- `pci-compliance-strategy.ts`: Implements the main logic, including tokenizeCard, verifyPayment, response, data, PCIChecklist.
