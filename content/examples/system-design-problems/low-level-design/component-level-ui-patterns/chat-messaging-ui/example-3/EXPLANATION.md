...
- `end-to-end-encryption.ts`: Implements the main logic, including EndToEndEncryption, exported, binaryKey, recipientKey, sharedBits.
- `message-search-and-filtering.ts`: Implements the main logic, including MessageSearchEngine, i, words, word, candidateIndices.
- `realtime-message-ordering.ts`: Implements the main logic, including MessageOrderingManager, insertIndex, sorted, gaps, i.
