...
- `duplicate-message-dedup.ts`: Implements the main logic, including deduplicateMessages, existingIds, newMessages, detectMessageGaps, sequences.
- `optimistic-send-rollback.ts`: Implements the main logic, including handleOptimisticSend, msgIndex, msg, updated, retryCount.
