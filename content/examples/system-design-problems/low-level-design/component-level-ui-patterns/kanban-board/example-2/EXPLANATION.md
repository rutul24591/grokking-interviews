...
- `concurrent-move-resolver.ts`: Implements the main logic, including incrementClock, mergeClocks, result, compareClocks, allReplicas.
- `offline-drag-recovery.ts`: Implements the main logic, including OfflineDragRecovery, queued, serverState, reconciliation, conflict.
