...
- `crdt-collaboration.ts`: Implements the main logic, including mergeConcurrentMoves, VectorClockManager, atLeastOneGreater, allActors, actorId.
- `performance-optimization.ts`: Implements the main logic, including useVirtualizedColumn, visibleStart, visibleCount, start, end.
