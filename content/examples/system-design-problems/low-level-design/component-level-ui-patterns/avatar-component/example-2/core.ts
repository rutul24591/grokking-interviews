export interface AvatarComponentTimer{id:string;
remainingMs:number;
startedAtMs:number;
pausedAtMs?:number;
}export class AvatarComponentTimerRegistry{private timers=new Map<string,AvatarComponentTimer>();
...
}}export function runAvatarComponentTimerScenario(){const r=new AvatarComponentTimerRegistry();
