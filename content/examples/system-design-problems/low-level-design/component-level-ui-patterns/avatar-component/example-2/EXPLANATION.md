# Design an Avatar Component - example-2 Explanation
...
- `avatar-stack-keyboard.ts`: Implements the main logic, including useAvatarStack, visibleAvatars, overflowCount, handleKeyDown.
- `image-error-recovery.ts`: Implements the main logic, including useAvatarFallback, maxRetries, onError, retryImage, getInitials.
