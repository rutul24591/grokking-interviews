# Design an Avatar Component - example-3 Explanation
...
- `avatar-group-stack.ts`: Implements the main logic, including AvatarStack, visible, overflow, sizeMap, avatarSize.
- `performance-optimization.ts`: Implements the main logic, including decodeAvatarImage, response, blob, bitmap, AvatarImagePool.
