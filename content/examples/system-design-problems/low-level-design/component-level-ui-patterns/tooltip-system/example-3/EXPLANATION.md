# Design a Tooltip System - example-3 Explanation
...
- `content-aware-positioning.ts`: Implements the main logic, including calculateSmartPosition, placements, sides, placement, fitsX.
- `visibility-tracking.ts`: Implements the main logic, including useTooltipVisibilityTracking, observerRef, entry, useReducedMotion, mediaQuery.
