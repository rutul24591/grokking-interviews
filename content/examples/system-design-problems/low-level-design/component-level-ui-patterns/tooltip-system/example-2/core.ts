export interface TooltipSystemTimer{id:string;
remainingMs:number;
startedAtMs:number;
pausedAtMs?:number;
}export class TooltipSystemTimerRegistry{private timers=new Map<string,TooltipSystemTimer>();
...
}}export function runTooltipSystemTimerScenario(){const r=new TooltipSystemTimerRegistry();
