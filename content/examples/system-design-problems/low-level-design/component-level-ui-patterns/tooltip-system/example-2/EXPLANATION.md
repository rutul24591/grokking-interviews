# Design a Tooltip System - example-2 Explanation
...
- `placement-flip.ts`: Implements the main logic, including FLIP_MAP, MARGIN, calculateTooltipPosition, placementKey, wasFlipped.
- `rapid-hover-prevention.ts`: Models an API boundary, request handling path, or backend contract.
