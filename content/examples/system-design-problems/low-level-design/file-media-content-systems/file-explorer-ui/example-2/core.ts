export type fileExplorerUiSignal = {
...
export type fileExplorerUiEvent = {
  id: string;
  ...
  payloadSize: number;
  signal: fileExplorerUiSignal;
};

export type fileExplorerUiDecision = {
  accepted: boolean;
...
export function evaluateFileExplorerUiEvent(event: fileExplorerUiEvent): fileExplorerUiDecision {
  ...
  let action: fileExplorerUiDecision["action"] = "commit";
...
export function runFileExplorerUiContractScenario() {
  const base = Date.parse("2026-05-29T09:00:00.000Z");
  const accepted = evaluateFileExplorerUiEvent({
    id: "file-explorer-ui-evt-1",
    topic: "file-explorer-ui",
    actorId: "user-42",
    sequence: 7,
    receivedAtMs: base,
  ...
  const guarded = evaluateFileExplorerUiEvent({
    id: "file-explorer-ui-evt-late",
    topic: "file-explorer-ui",
    actorId: "user-42",
    sequence: 8,
