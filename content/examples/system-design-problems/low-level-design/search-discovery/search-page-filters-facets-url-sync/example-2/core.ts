export type searchPageFiltersFacetsUrlSyncSignal = {
...
export type searchPageFiltersFacetsUrlSyncEvent = {
  id: string;
  topic: "search-page-filters-facets-url-sync";
  actorId: string;
  sequence: number;
  receivedAtMs: number;
  ...
  payloadSize: number;
  signal: searchPageFiltersFacetsUrlSyncSignal;
};

export type searchPageFiltersFacetsUrlSyncDecision = {
  accepted: boolean;
...
export function evaluateSearchPageFiltersFacetsUrlSyncEvent(event: searchPageFiltersFacetsUrlSyncEvent): searchPageFiltersFacetsUrlSyncDecision {
  ...
  let action: searchPageFiltersFacetsUrlSyncDecision["action"] = "commit";
...
export function runSearchPageFiltersFacetsUrlSyncContractScenario() {
  const base = Date.parse("2026-05-29T09:00:00.000Z");
  const accepted = evaluateSearchPageFiltersFacetsUrlSyncEvent({
    id: "search-page-filters-facets-url-sync-evt-1",
    topic: "search-page-filters-facets-url-sync",
    actorId: "user-42",
    sequence: 7,
    receivedAtMs: base,
  ...
  const guarded = evaluateSearchPageFiltersFacetsUrlSyncEvent({
    id: "search-page-filters-facets-url-sync-evt-late",
    topic: "search-page-filters-facets-url-sync",
    actorId: "user-42",
    sequence: 8,
