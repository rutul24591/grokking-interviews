export type thirdPartySdkIntegrationRuntimeState = {
...
export type thirdPartySdkIntegrationRecoveryPlan = {
...
export function planThirdPartySdkIntegrationRecovery(
  state: thirdPartySdkIntegrationRuntimeState,
  nowMs: number,
): thirdPartySdkIntegrationRecoveryPlan {
  const evidence: string[] = [];
  const actions: thirdPartySdkIntegrationRecoveryPlan["actions"] = ["emit-telemetry"];
...
export function runThirdPartySdkIntegrationEdgeCaseScenario() {
  const nowMs = Date.parse("2026-05-29T09:15:00.000Z");
  const normal = planThirdPartySdkIntegrationRecovery(
    {
      topic: "third-party-sdk-integration",
      mounted: true,
  ...
  const failure = planThirdPartySdkIntegrationRecovery(
    {
      topic: "third-party-sdk-integration",
      mounted: true,
      lastSuccessfulVersion: 21,
