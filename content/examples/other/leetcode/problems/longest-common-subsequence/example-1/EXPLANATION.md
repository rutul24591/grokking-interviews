# Longest Common Subsequence - example-1 Explanation
...
- `Solution.java`: Provides supporting example content: public class Solution { static int lcsNaive(String text1, String text2) { return dfs(text1, text2, 0, 0); } static int dfs(String a, String .
- `solution.js`: Implements the main logic, including lcsNaive, dfs.
