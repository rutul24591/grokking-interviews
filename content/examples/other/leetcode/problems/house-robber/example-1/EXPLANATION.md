# House Robber - example-1 Explanation
...
- `Solution.java`: Provides supporting example content: import java.util.HashMap; import java.util.Map; public class Solution { static int robTopDown(int[] nums) { Map<Integer, Integer> memo = new.
- `solution.js`: Implements the main logic, including robTopDown, memo, dfs, best.
