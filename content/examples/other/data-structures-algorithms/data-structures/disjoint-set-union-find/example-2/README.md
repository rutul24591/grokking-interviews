# Disjoint Set Union Find — Cluster Merge Follow-Up
...
## Run
`node content/examples/other/data-structures-algorithms/data-structures/disjoint-set-union-find/example-2/demo.js`
