# Heaps & Priority Queues — Tie and Empty-State Checks
...
## Run
`node content/examples/other/data-structures-algorithms/data-structures/heaps-priority-queues/example-3/demo.js`
