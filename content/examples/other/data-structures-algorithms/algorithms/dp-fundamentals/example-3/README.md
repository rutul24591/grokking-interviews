# Dynamic Programming Fundamentals — Edge Cases and Defensive Checks
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/dp-fundamentals/example-3/demo.js`
