# Dynamic Programming Fundamentals — Follow-Up: Bottom-Up vs Memoization
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/dp-fundamentals/example-2/demo.js`
