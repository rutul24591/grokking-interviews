# Longest Common Subsequence — Implementation Workbench
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/longest-common-subsequence/example-1/app.js`
