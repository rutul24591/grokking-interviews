# Longest Common Subsequence — Follow-Up: Bottom-Up vs Memoization
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/longest-common-subsequence/example-2/demo.js`
