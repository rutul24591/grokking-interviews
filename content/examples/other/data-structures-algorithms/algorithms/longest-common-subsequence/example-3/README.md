# Longest Common Subsequence — Edge Cases and Defensive Checks
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/longest-common-subsequence/example-3/demo.js`
