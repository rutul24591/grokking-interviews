# Longest Increasing Subsequence — Implementation Workbench
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/longest-increasing-subsequence/example-1/app.js`
