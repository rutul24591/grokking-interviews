# Interpolation Search — Lower/Upper Bound Follow-Up
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/interpolation-search/example-2/demo.js`
