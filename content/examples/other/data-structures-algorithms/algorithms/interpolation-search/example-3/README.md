# Interpolation Search — Edge Cases and Preconditions
...
## Run
`node content/examples/other/data-structures-algorithms/algorithms/interpolation-search/example-3/demo.js`
