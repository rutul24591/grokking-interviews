# End-to-End Security Posture - example-3 Explanation
...
- `src/signer.ts`: Implements the main logic, including b64urlEncode, b64urlDecode, normalized, pad, timingSafeEqual.
