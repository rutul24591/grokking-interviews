# Vendor Lock-in Strategy - example-3 Explanation
...
- `src/migration.ts`: Implements the main logic, including dualWritePut, readWithRepair, p, f, backfillBatch.
- `src/store.ts`: Models client or service state transitions and update behavior.
