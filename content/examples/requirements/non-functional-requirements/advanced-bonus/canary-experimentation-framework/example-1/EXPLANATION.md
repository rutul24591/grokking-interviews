# Canary Experimentation Framework - example-1 Explanation
...
- `app/api/serve/route.ts`: Models an API boundary, request handling path, or backend contract.
...
- `lib/bucketing.ts`: Implements the main logic, including chooseVariant, pct, u.
...
- `lib/telemetry.ts`: Implements the main logic, including var, createState, getState, recordEvent, state.
