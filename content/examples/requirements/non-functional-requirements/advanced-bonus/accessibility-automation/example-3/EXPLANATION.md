# Accessibility Automation - example-3 Explanation
...
- `src/sarif.ts`: Implements the main logic, including FindingSchema, toSarif.
- `src/suppress.ts`: Implements the main logic, including SuppressionSchema, hashTarget, applySuppressions, suppressionMap, s.
