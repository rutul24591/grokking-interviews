# Chaos Testing - example-1 Explanation
...
- `app/api/experiments/[id]/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/experiments/[id]/start/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/experiments/[id]/stop/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/experiments/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/metrics/steady-state/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/target/route.ts`: Models an API boundary, request handling path, or backend contract.
...
- `lib/chaos.ts`: Implements the main logic, including sleep, inBlastRadius, pct, digest, bucket.
- `lib/metrics.ts`: Implements the main logic, including RollingWindow, items, total, ok, errors.
