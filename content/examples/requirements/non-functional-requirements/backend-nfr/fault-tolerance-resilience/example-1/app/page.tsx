    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <section className="rounded-2xl border border-slate-700 bg-slate-900/50 p-5 space-y-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">
            This panel captures the operational questions that determine whether fault tolerance resilience is truly production-ready, not
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <ReviewNote
            ...
            detail="For fault tolerance resilience, teams need enough evidence to explain the current state during incidents, reviews, and release gates."
          />
          <ReviewNote
            title="Failure posture"
            detail="For fault tolerance resilience, degraded paths should stay deliberate: clear fallbacks, explicit tradeoffs, and no silent state drift."
          />
          <ReviewNote
            title="Audit prompt"
            detail="For fault tolerance resilience, validate that a new engineer can inspect this screen, trace the output, and understand the next safe action."
          />
        </div>
        <div className="rounded-xl border border-slate-800 bg-black/30 p-4 text-sm text-slate-300">
          <div className="font-semibold text-white">Why this matters for Fault Tolerance Resilience</div>
          <p className="mt-2">
      ...
      <section className="rounded-2xl border border-slate-700 bg-slate-900/50 p-5 space-y-5">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">
            Use this rubric to judge whether fault tolerance resilience is ready for production review. The point is not simply to see a
        ...
        <div className="grid gap-3 md:grid-cols-3">
          <ReviewNote
            ...
            detail="For fault tolerance resilience, verify that the UI exposes the one or two signals an operator would trust first when deciding whether the system is healthy."
          />
          <ReviewNote
            title="Safe fallback"
            detail="For fault tolerance resilience, validate that the fallback path is explicit, bounded, and consistent with the business priority rather than an accidental side effect."
          />
          <ReviewNote
            title="Review evidence"
            detail="For fault tolerance resilience, confirm that the output is detailed enough for another engineer to audit the behavior without re-running the scenario from scratch."
          />
        </div>
