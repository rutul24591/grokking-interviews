# Conflict Resolution UX - example-1 Explanation

## Article context
This example supports the article `non-functional-requirements/frontend-nfr/conflict-resolution-ux`. The article is about Comprehensive guide to handling data conflicts in offline-capable apps: conflict detection, resolution strategies, merge UI patterns, and CRDTs.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Architecture and Flow; Trade-offs and Comparison; Best Practices; Common Pitfalls; Real-World Use Cases; Common Interview Questions with Detailed Answers.
...
- `app/api/doc/route.ts`: Models an API boundary, request handling path, or backend contract.
...
- `lib/merge.ts`: Implements the main logic, including threeWayMergeText, merged.
