# Content Recovery - example-1 Explanation

## Article context
This example supports the article `functional-requirements/other-cross-cutting/content-recovery`. The article is about Comprehensive guide to implementing content recovery covering trash management, undelete functionality, backup recovery, disaster recovery, and content restoration for data loss prevention.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Trash Management; Undelete Functionality; Backup Recovery; Disaster Recovery; Recovery Management; Architecture and Flow; Trash Service; Backup Service.
...
- `app/api/content-recovery/action/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/content-recovery/state/route.ts`: Models an API boundary, request handling path, or backend contract.
