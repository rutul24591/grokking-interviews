# User Muting - example-1 Explanation

## Article context
This example supports the article `functional-requirements/other-cross-cutting/user-muting`. The article is about Comprehensive guide to implementing user muting systems covering mute/unmute workflows, mute list management, muted user experience, content filtering, and integration with notification systems for user experience control without confrontation.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Mute/Unmute Workflows; Mute List Management; Muted User Experience; Content Filtering; Integration with Notification Systems; Architecture and Flow; Mute Management Layer; Content Filtering Layer.
...
- `app/api/user-muting/action/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/user-muting/state/route.ts`: Models an API boundary, request handling path, or backend contract.
