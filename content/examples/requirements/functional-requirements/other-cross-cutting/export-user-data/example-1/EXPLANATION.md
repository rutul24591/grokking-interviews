# Export User Data - example-1 Explanation

## Article context
This example supports the article `functional-requirements/other-cross-cutting/export-user-data`. The article is about Comprehensive guide to implementing export user data covering data export requests, export formats, export generation, export delivery, and export management for data portability and user rights.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Export Requests; Export Formats; Export Generation; Export Delivery; Export Security; Architecture and Flow; Export Service; Generation Service.
...
- `app/api/export-user-data/action/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/export-user-data/state/route.ts`: Models an API boundary, request handling path, or backend contract.
