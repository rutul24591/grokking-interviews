# GDPR Data Requests - example-1 Explanation

## Article context
This example supports the article `functional-requirements/other-cross-cutting/gdpr-data-requests`. The article is about Comprehensive guide to implementing GDPR data requests covering right to access, right to erasure, right to rectification, right to portability, request management, and compliance tracking for GDPR regulatory compliance.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Right to Access; Right to Erasure; Right to Rectification; Right to Portability; Request Management; Architecture and Flow; Request Service; Access Service.
...
- `app/api/gdpr-data-requests/action/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/gdpr-data-requests/state/route.ts`: Models an API boundary, request handling path, or backend contract.
