# Notification Muting - example-1 Explanation

## Article context
This example supports the article `functional-requirements/other-cross-cutting/notification-muting`. The article is about Comprehensive guide to implementing notification muting covering mute duration, mute scope, temporary muting, permanent muting, and mute management for notification control and user experience.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Mute Duration; Mute Scope; Mute Enforcement; Mute Management; Mute Patterns; Architecture and Flow; Mute Service; Duration Service.
...
- `app/api/notification-muting/action/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/notification-muting/state/route.ts`: Models an API boundary, request handling path, or backend contract.
