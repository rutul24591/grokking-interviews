...
export default function Page() {
  ...
  async function reload(action = "state", itemId?: string) {
    const url = action === "state" ? "/api/chat-ui/state" : "/api/chat-ui/action";
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      ...
      <p className="mt-2 max-w-3xl text-slate-300">Runs a support-thread workbench with composer, retry posture, and thread-level recovery actions.</p>
