...
export default function Page() {
  ...
  async function reload(action = "state", itemId?: string) {
    const url = action === "state" ? "/api/group-chat-ui/state" : "/api/group-chat-ui/action";
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <h1 className="text-3xl font-bold">Group Chat UI</h1>
      <p className="mt-2 max-w-3xl text-slate-300">Models room membership, posting permissions, moderator actions, and stale-room recovery for group messaging.</p>
