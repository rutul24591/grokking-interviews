# Trending Computation - example-1 Explanation

## Article context
This example supports the article `functional-requirements/discovery-search-feed-browsing/trending-computation`. The article is about Comprehensive guide to trending computation covering velocity calculation, time windows, stream processing, geographic trends, and manipulation prevention for real-time discovery.. The most relevant article sections for this example are: Definition and Context; Core Concepts; Trending Score Formula; Time Windows; Time Decay; Geographic Segmentation; Manipulation Prevention; Architecture and Flow; Stream Processing Pipeline; Sliding Window Implementation.
...
- `app/api/trending/state/route.ts`: Models an API boundary, request handling path, or backend contract.
- `app/api/trending/window/route.ts`: Models an API boundary, request handling path, or backend contract.
