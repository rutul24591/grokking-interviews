...
id: "article-backend-user-service-extensive",
  ...
  "frontend/state-management/local-component-state": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-13",
      tags: ["frontend", "state management", "useState", "useReducer", "React", "component state"],
      relatedTopics: ["global-state-management", "derived-state", "form-state-management"],
    },
    loader: () => import("./articles/frontend/state-management/local-component-state-concise"),
  },
  "frontend/state-management/global-state-management": {
    ...
    loader: () => import("./articles/frontend/state-management/global-state-management-concise"),
  },
  "frontend/state-management/server-state-management": {
    ...
    loader: () => import("./articles/frontend/state-management/server-state-management-concise"),
  },
  "frontend/state-management/url-state": {
    ...
    loader: () => import("./articles/frontend/state-management/url-state-concise"),
  },
  "frontend/state-management/form-state-management": {
    ...
    loader: () => import("./articles/frontend/state-management/form-state-management-concise"),
  },
  "frontend/state-management/state-synchronization": {
    ...
    loader: () => import("./articles/frontend/state-management/state-synchronization-concise"),
  },
  "frontend/state-management/optimistic-updates": {
    ...
    loader: () => import("./articles/frontend/state-management/optimistic-updates-concise"),
  },
  "frontend/state-management/state-persistence": {
    ...
    loader: () => import("./articles/frontend/state-management/state-persistence-concise"),
  },
  "frontend/state-management/derived-state": {
    ...
    loader: () => import("./articles/frontend/state-management/derived-state-concise"),
  },
  "frontend/state-management/state-normalization": {
    ...
    loader: () => import("./articles/frontend/state-management/state-normalization-concise"),
  },
  "frontend/state-management/immutable-state-updates": {
    ...
    loader: () => import("./articles/frontend/state-management/immutable-state-updates-concise"),
  },
  "frontend/data-storage/localstorage": {
    metadata: {
      ...
      tags: ["frontend", "storage", "localStorage", "Web Storage API", "persistence", "client-side"],
      relatedTopics: ["sessionstorage", "indexeddb", "cookies", "storage-quotas-and-eviction"],
    },
    loader: () => import("./articles/frontend/data-storage/localstorage-concise"),
  },
  "frontend/data-storage/sessionstorage": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-14",
      tags: ["frontend", "storage", "sessionStorage", "Web Storage API", "tab-scoped", "client-side"],
      relatedTopics: ["localstorage", "cookies", "storage-quotas-and-eviction"],
    },
    loader: () => import("./articles/frontend/data-storage/sessionstorage-concise"),
  },
  "frontend/data-storage/cookies": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-14",
      tags: ["frontend", "storage", "cookies", "HTTP", "SameSite", "security", "GDPR"],
      relatedTopics: ["localstorage", "sessionstorage", "storage-quotas-and-eviction"],
    },
    loader: () => import("./articles/frontend/data-storage/cookies-concise"),
  },
  "frontend/data-storage/indexeddb": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-14",
      tags: ["frontend", "storage", "IndexedDB", "database", "Dexie.js", "offline"],
      relatedTopics: ["localstorage", "cache-api", "storage-quotas-and-eviction"],
    },
    loader: () => import("./articles/frontend/data-storage/indexeddb-concise"),
  },
  "frontend/data-storage/cache-api": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-14",
      tags: ["frontend", "storage", "Cache API", "Service Worker", "offline", "PWA"],
      relatedTopics: ["indexeddb", "storage-quotas-and-eviction", "file-system-access-api"],
    },
    loader: () => import("./articles/frontend/data-storage/cache-api-concise"),
  },
  "frontend/data-storage/web-sql": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-14",
      tags: ["frontend", "storage", "Web SQL", "deprecated", "SQL", "migration"],
      relatedTopics: ["indexeddb", "localstorage", "cookies"],
    },
    loader: () => import("./articles/frontend/data-storage/web-sql-concise"),
  },
  "frontend/data-storage/file-system-access-api": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-14",
      tags: ["frontend", "storage", "File System Access API", "OPFS", "file handles", "browser"],
      relatedTopics: ["indexeddb", "cache-api", "storage-quotas-and-eviction"],
    },
    loader: () => import("./articles/frontend/data-storage/file-system-access-api-concise"),
  },
  "frontend/data-storage/storage-quotas-and-eviction": {
    metadata: {
      ...
      readingTime: 13,
      lastUpdated: "2026-03-14",
      tags: ["frontend", "storage", "quotas", "eviction", "StorageManager", "persistence"],
      relatedTopics: ["localstorage", "indexeddb", "cache-api", "cookies"],
    },
    loader: () => import("./articles/frontend/data-storage/storage-quotas-and-eviction-concise"),
  },
