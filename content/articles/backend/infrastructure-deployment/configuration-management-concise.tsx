  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <div className="my-6 grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-theme bg-panel-soft p-5">
            <h3 className="text-lg font-semibold">Dependency ordering bugs</h3>
            <p className="mt-2 text-sm text-muted">
              A service restarts before a config file is valid, or a package upgrade breaks a runtime without coordinated compatibility.
            </p>
            <ul className="mt-3 space-y-1 text-sm">
              <li>
                <strong>Mitigation:</strong> validate config syntax before reload, pin versions, and roll forward with compatibility windows.
              </li>
              <li>
                <strong>Signal:</strong> crash loops or rollback events immediately after an automation change.
              </li>
            </ul>
          </div>
          <div className="rounded-lg border border-theme bg-panel-soft p-5">
            <h3 className="text-lg font-semibold">Secret mismatch</h3>
            <p className="mt-2 text-sm text-muted">
              Consumers are updated before producers (or vice versa), causing authentication failures across a critical path.
            </p>
            <ul className="mt-3 space-y-1 text-sm">
              <li>
                <strong>Mitigation:</strong> staged rotation with overlap, explicit cutovers, and monitoring for authentication error spikes.
              </li>
              <li>
                <strong>Signal:</strong> error bursts tied to rotation events, often first visible in downstream dependency metrics.
              </li>
            </ul>
          </div>
        </div>
