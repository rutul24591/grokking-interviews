  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/infrastructure-deployment/virtual-machines-diagram-1.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/infrastructure-deployment/virtual-machines-diagram-2.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/infrastructure-deployment/virtual-machines-diagram-3.svg"
      ...
      <section>
        ...
        <p className="mt-4">
          ...
          reversible. If VM changes require heroics, the system is telling you the lifecycle pipeline is underpowered.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          A backend service running on VMs shows rising p99 latency without an obvious increase in request volume. The
          application metrics show thread pools saturating intermittently, and retries begin to amplify load on
          downstream systems.
        </p>
        <p>
        ...
        <div className="my-6 rounded-lg bg-panel-soft p-6">
          ...
          <ul className="space-y-2">
            ...
            <li>
              If the instance is mis-sized, resize and compare tail latency to baseline; do not treat scaling as a mystery.
            </li>
          </ul>
        </div>
      </section>
