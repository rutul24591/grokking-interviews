  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/application-cache-layers.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/application-cache-key-design.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/application-cache-local-vs-shared.svg"
...
<section>
  ...
  <p>
    Imagine a high-traffic service where in-process cache and L1 are already in place, but a new
    feature increases permissions and creates new access patterns. Suddenly, GC becomes too
    long and stale data appears during peak usage. The team introduces key design or memory limits in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten GC for critical keys,
    preserve deployments for predictable hot sets, and add operational safeguards so the system
