  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/connection-pool-lifecycle.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/connection-pool-saturation.svg"
          alt="Pool saturation"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/connection-pool-timeouts.svg"
...
<section>
  ...
  <p>
    Imagine a high-traffic service where pool size and max connections are already in place, but a new
    feature increases transaction pooling and creates new access patterns. Suddenly, leaks becomes too
    long and stale data appears during peak usage. The team introduces timeouts or backpressure in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten leaks for critical keys,
    preserve saturation for predictable hot sets, and add operational safeguards so the system
