  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/object-pool-lifecycle.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/object-pool-contention.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/object-pool-reuse.svg"
...
<section>
  ...
  <p>
    Imagine a high-traffic service where reuse and reset are already in place, but a new
    feature increases scarce resources and creates new access patterns. Suddenly, leak detection becomes too
    long and stale data appears during peak usage. The team introduces pool size or contention in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten leak detection for critical keys,
    preserve lifecycle for predictable hot sets, and add operational safeguards so the system
