  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/negative-caching.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/bloom-filter.svg"
...
<section>
  ...
  <p>
    Imagine a high-traffic service where negative caching and bloom filters are already in place, but a new
    feature increases validation and creates new access patterns. Suddenly, 404 spikes becomes too
    long and stale data appears during peak usage. The team introduces invalid IDs or rate limiting in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten 404 spikes for critical keys,
    preserve abuse for predictable hot sets, and add operational safeguards so the system
