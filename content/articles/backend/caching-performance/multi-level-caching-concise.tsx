...
<section>
  ...
  <p>
    Imagine a high-traffic service where L1/L2/L3 and invalidation are already in place, but a new
    feature increases warmup and creates new access patterns. Suddenly, duplication becomes too
    long and stale data appears during peak usage. The team introduces inclusive/exclusive or latency budget in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten duplication for critical keys,
    preserve bypass for predictable hot sets, and add operational safeguards so the system
