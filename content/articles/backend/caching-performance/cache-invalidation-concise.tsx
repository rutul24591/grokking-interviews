...
export const metadata: ArticleMetadata = {
  ...
  description:
    "Deep dive into invalidation strategies, correctness guarantees, and operational playbooks.",
  category: "backend",
  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/cache-invalidation-ttl.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/cache-invalidation-event.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/cache-invalidation-versioned-keys.svg"
...
<section>
  ...
  <p>
    Imagine a high-traffic service where TTL and event-driven are already in place, but a new
    feature increases idempotency and creates new access patterns. Suddenly, invalidation bus becomes too
    long and stale data appears during peak usage. The team introduces versioned keys or write path in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten invalidation bus for critical keys,
    preserve stale reads for predictable hot sets, and add operational safeguards so the system
