  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/page-caching-types.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/fragment-cache-flow.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/backend/caching-performance/page-caching-edge.svg"
...
<section>
  ...
  <p>
    Imagine a high-traffic service where full page and fragment are already in place, but a new
    feature increases edge and creates new access patterns. Suddenly, purge becomes too
    long and stale data appears during peak usage. The team introduces personalization or cache key in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten purge for critical keys,
    preserve origin for predictable hot sets, and add operational safeguards so the system
