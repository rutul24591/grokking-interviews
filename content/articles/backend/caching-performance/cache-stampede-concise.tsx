...
<section>
  ...
  <p>
    Imagine a high-traffic service where TTL jitter and coalescing are already in place, but a new
    feature increases queueing and creates new access patterns. Suddenly, hot keys becomes too
    long and stale data appears during peak usage. The team introduces locks or SWR in the
    critical path, reducing staleness but increasing latency. This trade-off forces a
    redesign of cache scopes and TTL budgets.
  </p>
  <p>
    The solution often requires a layered approach: tighten hot keys for critical keys,
