  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <p>How do you set an availability target and translate it into architecture decisions?</p>
        <p>What are the trade-offs between active-active and active-passive designs?</p>
        <p>How do you prevent automation from amplifying an outage?</p>
        <p>How would you keep a service partially available during a dependency outage?</p>
      </section>
    </ArticleLayout>
  );
}
