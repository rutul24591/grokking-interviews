  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Job Scheduler is a dedicated backend component that encapsulates a single business capability and exposes a stable API.</p>
        <p>It decouples domain logic, improves ownership, and allows independent scaling and evolution.</p>
      </section>
      <section>
        <h2>Architecture Overview</h2>
        <ArticleImage src="/diagrams/backend/system-components-services/job-scheduler-diagram-1.svg" alt="Job Scheduler architecture" caption="Job Scheduler system overview." />
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/backend/system-components-services/job-scheduler-diagram-2.svg" alt="Job Scheduler mechanisms" caption="Key mechanisms and control points." />
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/backend/system-components-services/job-scheduler-diagram-3.svg" alt="Job Scheduler failure modes" caption="Failure paths and mitigation strategies." />
        <p>Common failures include unclear ownership, missing contracts, and unbounded growth in job scheduler responsibilities.</p>
      ...
      <section>
        ...
        <p>Mini app demonstrating core job scheduler workflows.</p>
        <p className="mt-4 font-semibold">scheduler.js</p>
      ...
      <section>
        <h2>Summary</h2>
        <p>Job Scheduler is reliable when its boundary is clear, contracts are stable, and operations are well observed.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: What is the main responsibility of a job scheduler?</p>
            <p className="mt-2 text-sm">A: To provide a focused API for job scheduler concerns with clear SLAs.</p>
          </div>
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
