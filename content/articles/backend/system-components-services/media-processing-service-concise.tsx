  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Media Processing Service is a dedicated backend component that encapsulates a single business capability and exposes a stable API.</p>
        <p>It decouples domain logic, improves ownership, and allows independent scaling and evolution.</p>
      </section>
      <section>
        <h2>Architecture Overview</h2>
        <ArticleImage src="/diagrams/backend/system-components-services/media-processing-service-diagram-1.svg" alt="Media Processing Service architecture" caption="Media Processing Service system overview." />
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/backend/system-components-services/media-processing-service-diagram-2.svg" alt="Media Processing Service mechanisms" caption="Key mechanisms and control points." />
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/backend/system-components-services/media-processing-service-diagram-3.svg" alt="Media Processing Service failure modes" caption="Failure paths and mitigation strategies." />
        <p>Common failures include unclear ownership, missing contracts, and unbounded growth in media processing service responsibilities.</p>
      ...
      <section>
        ...
        <p>Mini app demonstrating core media processing service workflows.</p>
        <p className="mt-4 font-semibold">queue.js</p>
        <div className="mt-4 rounded-lg border border-theme bg-panel-soft p-4 text-sm text-muted">Example code moved to the Example tab.</div>
        <p className="mt-4 font-semibold">worker.js</p>
        <div className="mt-4 rounded-lg border border-theme bg-panel-soft p-4 text-sm text-muted">Example code moved to the Example tab.</div>
      ...
      <section>
        <h2>Summary</h2>
        <p>Media Processing Service is reliable when its boundary is clear, contracts are stable, and operations are well observed.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: What is the main responsibility of a media processing service?</p>
            <p className="mt-2 text-sm">A: To provide a focused API for media processing service concerns with clear SLAs.</p>
          </div>
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
