  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Authorization Service is a dedicated backend component that encapsulates a single business capability and exposes a stable API.</p>
        <p>It decouples domain logic, improves ownership, and allows independent scaling and evolution.</p>
      </section>
      <section>
        <h2>Architecture Overview</h2>
        <ArticleImage src="/diagrams/backend/system-components-services/authorization-service-diagram-1.svg" alt="Authorization Service architecture" caption="Authorization Service system overview." />
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/backend/system-components-services/authorization-service-diagram-2.svg" alt="Authorization Service mechanisms" caption="Key mechanisms and control points." />
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/backend/system-components-services/authorization-service-diagram-3.svg" alt="Authorization Service failure modes" caption="Failure paths and mitigation strategies." />
        <p>Common failures include unclear ownership, missing contracts, and unbounded growth in authorization service responsibilities.</p>
      ...
      <section>
        ...
        <p>Mini app demonstrating core authorization service workflows.</p>
        <p className="mt-4 font-semibold">policy.js</p>
      ...
      <section>
        <h2>Summary</h2>
        <p>Authorization Service is reliable when its boundary is clear, contracts are stable, and operations are well observed.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: What is the main responsibility of a authorization service?</p>
            <p className="mt-2 text-sm">A: To provide a focused API for authorization service concerns with clear SLAs.</p>
          </div>
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
