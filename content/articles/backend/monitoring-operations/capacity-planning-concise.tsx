...
export const metadata: ArticleMetadata = {
  ...
  description: "Planning system capacity to meet growth and reliability targets.",
  category: "backend",
  ...
  relatedTopics: ['metrics', 'error-budgets', 'infrastructure-monitoring'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Capacity Planning describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good capacity planning produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for capacity planning connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/capacity-planning-diagram-1.svg" alt="Capacity Planning architecture diagram" caption="Capacity Planning architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for capacity planning should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in capacity planning come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/capacity-planning-diagram-2.svg" alt="Capacity Planning failure modes diagram" caption="Common failure paths for capacity planning." />
      </section>
      ...
      <section>
        ...
        <p>Capacity Planning involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/capacity-planning-diagram-3.svg" alt="Capacity Planning governance diagram" caption="Governance and trade-offs for capacity planning." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use capacity planning to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design capacity planning to be actionable?</li>
