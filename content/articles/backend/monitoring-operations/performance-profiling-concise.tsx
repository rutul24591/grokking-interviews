...
export const metadata: ArticleMetadata = {
  ...
  description: "Techniques for identifying CPU, memory, and latency bottlenecks.",
  category: "backend",
  ...
  relatedTopics: ['apm-application-performance-monitoring', 'metrics', 'capacity-planning'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Performance Profiling describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good performance profiling produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for performance profiling connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/performance-profiling-diagram-1.svg" alt="Performance Profiling architecture diagram" caption="Performance Profiling architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for performance profiling should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in performance profiling come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/performance-profiling-diagram-2.svg" alt="Performance Profiling failure modes diagram" caption="Common failure paths for performance profiling." />
      </section>
      ...
      <section>
        ...
        <p>Performance Profiling involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/performance-profiling-diagram-3.svg" alt="Performance Profiling governance diagram" caption="Governance and trade-offs for performance profiling." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use performance profiling to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design performance profiling to be actionable?</li>
