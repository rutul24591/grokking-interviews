...
export const metadata: ArticleMetadata = {
  ...
  title: "Dashboards",
  description: "Designing dashboards that communicate system health and user impact.",
  category: "backend",
  ...
  relatedTopics: ['metrics', 'alerting', 'sli-slo-sla'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Dashboards describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good dashboards produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for dashboards connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/dashboards-diagram-1.svg" alt="Dashboards architecture diagram" caption="Dashboards architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for dashboards should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in dashboards come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/dashboards-diagram-2.svg" alt="Dashboards failure modes diagram" caption="Common failure paths for dashboards." />
      </section>
      ...
      <section>
        ...
        <p>Dashboards involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/dashboards-diagram-3.svg" alt="Dashboards governance diagram" caption="Governance and trade-offs for dashboards." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use dashboards to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design dashboards to be actionable?</li>
