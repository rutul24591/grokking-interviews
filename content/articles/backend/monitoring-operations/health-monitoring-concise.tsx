...
export const metadata: ArticleMetadata = {
  ...
  description: "Monitoring service health and readiness for safe traffic routing.",
  category: "backend",
  ...
  tags: ['backend', 'monitoring', 'reliability'],
  relatedTopics: ['health-checks', 'alerting', 'fault-detection'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Health Monitoring describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good health monitoring produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for health monitoring connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/health-monitoring-diagram-1.svg" alt="Health Monitoring architecture diagram" caption="Health Monitoring architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for health monitoring should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in health monitoring come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/health-monitoring-diagram-2.svg" alt="Health Monitoring failure modes diagram" caption="Common failure paths for health monitoring." />
      </section>
      ...
      <section>
        ...
        <p>Health Monitoring involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/health-monitoring-diagram-3.svg" alt="Health Monitoring governance diagram" caption="Governance and trade-offs for health monitoring." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use health monitoring to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design health monitoring to be actionable?</li>
