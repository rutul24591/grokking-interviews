...
export const metadata: ArticleMetadata = {
  ...
  description: "Evaluating monitoring stacks and selecting tools for reliability workflows.",
  category: "backend",
  ...
  relatedTopics: ['observability', 'metrics', 'logging'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Monitoring Tools describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good monitoring tools produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for monitoring tools connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/monitoring-tools-diagram-1.svg" alt="Monitoring Tools architecture diagram" caption="Monitoring Tools architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for monitoring tools should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in monitoring tools come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/monitoring-tools-diagram-2.svg" alt="Monitoring Tools failure modes diagram" caption="Common failure paths for monitoring tools." />
      </section>
      ...
      <section>
        ...
        <p>Monitoring Tools involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/monitoring-tools-diagram-3.svg" alt="Monitoring Tools governance diagram" caption="Governance and trade-offs for monitoring tools." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use monitoring tools to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design monitoring tools to be actionable?</li>
