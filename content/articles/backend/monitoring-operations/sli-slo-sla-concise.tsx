...
export const metadata: ArticleMetadata = {
  ...
  description: "Defining service reliability goals and translating them into operational practice.",
  category: "backend",
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Sli Slo Sla describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good sli slo sla produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for sli slo sla connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/sli-slo-sla-diagram-1.svg" alt="SLI, SLO, and SLA architecture diagram" caption="SLI, SLO, and SLA architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for sli slo sla should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in sli slo sla come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/sli-slo-sla-diagram-2.svg" alt="SLI, SLO, and SLA failure modes diagram" caption="Common failure paths for sli, slo, and sla." />
      </section>
      ...
      <section>
        ...
        <p>Sli Slo Sla involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/sli-slo-sla-diagram-3.svg" alt="SLI, SLO, and SLA governance diagram" caption="Governance and trade-offs for sli, slo, and sla." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use sli slo sla to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design sli slo sla to be actionable?</li>
