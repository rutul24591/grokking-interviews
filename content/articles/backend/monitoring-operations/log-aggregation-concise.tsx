...
export const metadata: ArticleMetadata = {
  ...
  description: "Collecting, indexing, and querying logs across distributed systems.",
  category: "backend",
  ...
  relatedTopics: ['logging', 'observability', 'monitoring-tools'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Log Aggregation describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good log aggregation produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for log aggregation connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/log-aggregation-diagram-1.svg" alt="Log Aggregation architecture diagram" caption="Log Aggregation architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for log aggregation should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in log aggregation come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/log-aggregation-diagram-2.svg" alt="Log Aggregation failure modes diagram" caption="Common failure paths for log aggregation." />
      </section>
      ...
      <section>
        ...
        <p>Log Aggregation involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/log-aggregation-diagram-3.svg" alt="Log Aggregation governance diagram" caption="Governance and trade-offs for log aggregation." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use log aggregation to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design log aggregation to be actionable?</li>
