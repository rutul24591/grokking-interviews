...
export const metadata: ArticleMetadata = {
  ...
  description: "Detecting abnormal behavior in system metrics and logs.",
  category: "backend",
  ...
  tags: ['backend', 'monitoring', 'anomaly-detection'],
  relatedTopics: ['alerting', 'metrics', 'fault-detection'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Anomaly Detection describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good anomaly detection produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for anomaly detection connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/anomaly-detection-diagram-1.svg" alt="Anomaly Detection architecture diagram" caption="Anomaly Detection architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for anomaly detection should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in anomaly detection come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/anomaly-detection-diagram-2.svg" alt="Anomaly Detection failure modes diagram" caption="Common failure paths for anomaly detection." />
      </section>
      ...
      <section>
        ...
        <p>Anomaly Detection involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/anomaly-detection-diagram-3.svg" alt="Anomaly Detection governance diagram" caption="Governance and trade-offs for anomaly detection." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use anomaly detection to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design anomaly detection to be actionable?</li>
