...
export const metadata: ArticleMetadata = {
  ...
  description: "Monitoring database performance, health, and reliability signals.",
  category: "backend",
  ...
  tags: ['backend', 'monitoring', 'databases'],
  relatedTopics: ['metrics', 'logging', 'capacity-planning'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Database Monitoring describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good database monitoring produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for database monitoring connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/database-monitoring-diagram-1.svg" alt="Database Monitoring architecture diagram" caption="Database Monitoring architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for database monitoring should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in database monitoring come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/database-monitoring-diagram-2.svg" alt="Database Monitoring failure modes diagram" caption="Common failure paths for database monitoring." />
      </section>
      ...
      <section>
        ...
        <p>Database Monitoring involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/database-monitoring-diagram-3.svg" alt="Database Monitoring governance diagram" caption="Governance and trade-offs for database monitoring." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use database monitoring to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design database monitoring to be actionable?</li>
