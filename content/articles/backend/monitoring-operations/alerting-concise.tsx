...
export const metadata: ArticleMetadata = {
  ...
  title: "Alerting",
  description: "Designing reliable alerts that reflect user impact and reduce noise.",
  category: "backend",
  ...
  relatedTopics: ['sli-slo-sla', 'error-budgets', 'fault-detection'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Alerting describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good alerting produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for alerting connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/alerting-diagram-1.svg" alt="Alerting architecture diagram" caption="Alerting architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for alerting should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in alerting come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/alerting-diagram-2.svg" alt="Alerting failure modes diagram" caption="Common failure paths for alerting." />
      </section>
      ...
      <section>
        ...
        <p>Alerting involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/alerting-diagram-3.svg" alt="Alerting governance diagram" caption="Governance and trade-offs for alerting." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use alerting to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design alerting to be actionable?</li>
