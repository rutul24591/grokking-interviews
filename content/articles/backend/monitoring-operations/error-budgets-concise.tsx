...
export const metadata: ArticleMetadata = {
  ...
  title: "Error Budgets",
  description: "Using error budgets to balance reliability and delivery velocity.",
  category: "backend",
  ...
  relatedTopics: ['sli-slo-sla', 'alerting', 'capacity-planning'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Error Budgets describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good error budgets produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for error budgets connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/error-budgets-diagram-1.svg" alt="Error Budgets architecture diagram" caption="Error Budgets architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for error budgets should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in error budgets come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/error-budgets-diagram-2.svg" alt="Error Budgets failure modes diagram" caption="Common failure paths for error budgets." />
      </section>
      ...
      <section>
        ...
        <p>Error Budgets involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/error-budgets-diagram-3.svg" alt="Error Budgets governance diagram" caption="Governance and trade-offs for error budgets." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use error budgets to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design error budgets to be actionable?</li>
