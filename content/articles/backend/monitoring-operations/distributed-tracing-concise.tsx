...
export const metadata: ArticleMetadata = {
  ...
  description: "Tracing requests across services to explain latency and failure behavior.",
  category: "backend",
  ...
  relatedTopics: ['tracing', 'observability', 'metrics'],
};
  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Distributed Tracing describes a core monitoring and operations practice used to keep production systems understandable and reliable.</p>
      ...
      <section>
        ...
        <p>Good distributed tracing produces fast diagnosis, low operational noise, and clear ownership of signals and actions.</p>
      ...
      <section>
        ...
        <p>The workflow for distributed tracing connects instrumentation to storage to decision-making. Data must be collected reliably and presented in a way that supports incident response.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/distributed-tracing-diagram-1.svg" alt="Distributed Tracing architecture diagram" caption="Distributed Tracing architecture and data flow." />
      </section>

      <section>
        <h2>Signals and Measurement</h2>
        <p>Signals for distributed tracing should be chosen for decision value. If a signal does not change an action, it should not page humans.</p>
      ...
      <section>
        ...
        <p>Most failures in distributed tracing come from missing ownership or policy: drift accumulates until the system becomes noisy or blind.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/distributed-tracing-diagram-2.svg" alt="Distributed Tracing failure modes diagram" caption="Common failure paths for distributed tracing." />
      </section>
      ...
      <section>
        ...
        <p>Distributed Tracing involves trade-offs between sensitivity and noise, and between fidelity and cost.</p>
        ...
        <ArticleImage src="/diagrams/backend/monitoring-operations/distributed-tracing-diagram-3.svg" alt="Distributed Tracing governance diagram" caption="Governance and trade-offs for distributed tracing." />
      </section>

      <section>
        <h2>Scenario Walkthrough</h2>
        <p>A user-visible regression occurs and responders use distributed tracing to isolate scope and cause quickly.</p>
      ...
      <section>
        ...
        <ul className="mt-4 space-y-2">
          <li>How do you design distributed tracing to be actionable?</li>
