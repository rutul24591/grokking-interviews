  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>HyperLogLog addresses advanced systems challenges that emerge at scale or under strict correctness requirements.</p>
      ...
      <section>
        ...
        <p>Common failures include incorrect assumptions, hidden edge cases, and insufficient monitoring for hyperloglog workloads.</p>
      ...
      <section>
        ...
        <p>Mini example illustrating hyperloglog behavior.</p>
        <p className="mt-4 font-semibold">hll.js</p>
      ...
      <section>
        <h2>Summary</h2>
        <p>HyperLogLog delivers results when assumptions are explicit and operational safeguards are in place.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: Why is hyperloglog important?</p>
