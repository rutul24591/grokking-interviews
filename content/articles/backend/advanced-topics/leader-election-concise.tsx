  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Leader Election addresses advanced systems challenges that emerge at scale or under strict correctness requirements.</p>
        <p>It introduces specialized techniques to manage performance, consistency, or operational complexity.</p>
      </section>
      <section>
        <h2>Architecture Overview</h2>
        <ArticleImage src="/diagrams/backend/advanced-topics/leader-election-ring-graph.png" alt="Ring graph for leader election" caption="Ring topology used in leader election. Source: Wikimedia Commons (Ring_graph.png)." />
      ...
      <section>
        ...
        <p>Common failures include incorrect assumptions, hidden edge cases, and insufficient monitoring for leader election workloads.</p>
      ...
      <section>
        ...
        <p>Mini example illustrating leader election behavior.</p>
        <p className="mt-4 font-semibold">election.js</p>
        <div className="mt-4 rounded-lg border border-theme bg-panel-soft p-4 text-sm text-muted">Example code moved to the Example tab.</div>
        <p className="mt-4 font-semibold">lease.js</p>
        <div className="mt-4 rounded-lg border border-theme bg-panel-soft p-4 text-sm text-muted">Example code moved to the Example tab.</div>
      ...
      <section>
        <h2>Summary</h2>
        <p>Leader Election delivers results when assumptions are explicit and operational safeguards are in place.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: Why is leader election important?</p>
