  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Hot Partitions addresses advanced systems challenges that emerge at scale or under strict correctness requirements.</p>
      ...
      <section>
        ...
        <p>Common failures include incorrect assumptions, hidden edge cases, and insufficient monitoring for hot partitions workloads.</p>
      ...
      <section>
        ...
        <p>Mini example illustrating hot partitions behavior.</p>
        <p className="mt-4 font-semibold">detector.js</p>
      ...
      <section>
        <h2>Summary</h2>
        <p>Hot Partitions delivers results when assumptions are explicit and operational safeguards are in place.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: Why is hot partitions important?</p>
