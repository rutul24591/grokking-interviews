  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Operational Transformation addresses advanced systems challenges that emerge at scale or under strict correctness requirements.</p>
        <p>It introduces specialized techniques to manage performance, consistency, or operational complexity.</p>
      </section>
      <section>
        <h2>Architecture Overview</h2>
        <ArticleImage src="/diagrams/backend/advanced-topics/operational-transformation-basic.png" alt="Operational transformation diagram" caption="Basic operational transformation flow. Source: Wikimedia Commons (Basicot.png)." />
      ...
      <section>
        ...
        <p>Common failures include incorrect assumptions, hidden edge cases, and insufficient monitoring for operational transformation workloads.</p>
      ...
      <section>
        ...
        <p>Mini example illustrating operational transformation behavior.</p>
        <p className="mt-4 font-semibold">ot.js</p>
      ...
      <section>
        <h2>Summary</h2>
        <p>Operational Transformation delivers results when assumptions are explicit and operational safeguards are in place.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: Why is operational transformation important?</p>
