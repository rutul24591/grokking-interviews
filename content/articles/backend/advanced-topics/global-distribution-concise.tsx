  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>Global Distribution addresses advanced systems challenges that emerge at scale or under strict correctness requirements.</p>
      ...
      <section>
        ...
        <p>Common failures include incorrect assumptions, hidden edge cases, and insufficient monitoring for global distribution workloads.</p>
      ...
      <section>
        ...
        <p>Mini example illustrating global distribution behavior.</p>
        <p className="mt-4 font-semibold">routing.js</p>
        <div className="mt-4 rounded-lg border border-theme bg-panel-soft p-4 text-sm text-muted">Example code moved to the Example tab.</div>
        <p className="mt-4 font-semibold">failover.js</p>
        <div className="mt-4 rounded-lg border border-theme bg-panel-soft p-4 text-sm text-muted">Example code moved to the Example tab.</div>
      ...
      <section>
        <h2>Summary</h2>
        <p>Global Distribution delivers results when assumptions are explicit and operational safeguards are in place.</p>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: Why is global distribution important?</p>
