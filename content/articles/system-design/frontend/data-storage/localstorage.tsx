    ...
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="crucial" className="mt-4">
          Heuristic: localStorage is best for small, non-sensitive, low-frequency writes. If you routinely serialize
          large objects, need indexing/queries, or care about main-thread responsiveness, move to IndexedDB or the Cache
          API depending on the data shape.
        </HighlightBlock>
      </section>
