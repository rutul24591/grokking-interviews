    ...
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <HighlightBlock as="p" tier="crucial">
          <strong>Streaming SSR (Server-Side Rendering)</strong> is a rendering
          technique that sends HTML to the client progressively in chunks as
          they're rendered on the server, rather than waiting for the entire
          page to complete before sending anything. This allows the browser to
        ...
        <p>
          ...
          takes 10 seconds, the user sees nothing for 10 seconds—a blank screen
        ...
        <p>
          ...
          <code>renderToReadableStream</code> (Web Streams API). These APIs work
          with React Suspense boundaries to enable granular streaming.{" "}
          <strong>Next.js 13+</strong>
          (with App Router), <strong>Remix</strong>, and{" "}
          <strong>Hydrogen</strong> (Shopify) have embraced streaming as the
      ...
      <section>
        <h2>Core Concepts</h2>
        <p>
          Understanding Streaming SSR requires grasping several fundamental
          concepts:
        </p>
        <ul>
          <li>
          ...
          <HighlightBlock as="li" tier="important">
            ...
            immediately, then replaces it with real content once ready. Suspense
          ...
          <li>
            ...
            instant structure. The "content" (articles, comments, dynamic data)
            streams afterward. The shell gives users immediate visual feedback
            even if content is slow.
          </li>
          <li>
            <strong>Automatic Code-Splitting:</strong> With Suspense lazy
            imports, code-split chunks are automatically prioritized. If a
            suspended component enters the viewport, its JavaScript bundle is
            fetched with higher priority. This works seamlessly with streaming
            SSR.
          </li>
          <li>
            <strong>Back-Pressure Handling:</strong> Streaming SSR respects
            network back-pressure. If the client is on a slow connection and can
            {"'"}t consume HTML fast enough, the server pauses rendering until
            the network buffer clears. This prevents memory exhaustion on the
            server.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <div className="my-6 rounded-lg bg-panel-soft p-6">
          ...
          <ol className="space-y-3">
            ...
            <li>
              <strong>2. Server Starts Rendering:</strong> React begins server
              rendering the component tree
            </li>
            <li>
              <strong>3. Flush Shell Immediately:</strong> Send HTML shell
              (header, nav, layout) as soon as ready (~50-100ms)
            </li>
            <li>
              <strong>4. Browser Starts Parsing:</strong> User sees page
              structure instantly (TTFB {"&lt;"}100ms, FCP {"&lt;"}200ms)
            </li>
            <li>
              <strong>5. Suspense Boundaries Detected:</strong> React encounters
              Suspense around slow components
            </li>
            <li>
              <strong>6. Stream Fallback UI:</strong> Send loading placeholders
              (skeleton UI) for suspended components
            </li>
            <li>
              <strong>7. Continue Rendering Other Parts:</strong> Stream fast
              components (static sections, cached data)
            </li>
            <li>
              <strong>8. Resolve Slow Data:</strong> API calls complete,
              database queries finish
            </li>
            <li>
              <strong>9. Stream Real Content:</strong> Replace fallbacks with
              actual content via inline script tags
            </li>
            <li>
              <strong>10. Close Stream:</strong> Send final HTML chunk;
              connection closes
            </li>
            <li>
              <strong>11. Selective Hydration:</strong> React hydrates
              interactive components progressively as JS downloads
            </li>
            <li>
              <strong>12. Fully Interactive:</strong> All components hydrated;
        ...
        <HighlightBlock as="p" tier="crucial">
          This progressive approach transforms the user experience. With
          traditional SSR, users wait 2-3 seconds seeing nothing, then
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/frontend/rendering-strategies/streaming-ssr-architecture.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/frontend/rendering-strategies/streaming-ssr-performance.svg"
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            sequentially. Streaming naturally parallelizes.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            boundary takes 10+ seconds, crawlers might not see that content.
            Test carefully.
          </li>
          <li>
            <strong>Increased Server Load:</strong> Connections stay open longer
            (seconds vs. milliseconds). More concurrent connections means higher
            memory usage. Requires robust server infrastructure.
          </li>
          <li>
            <strong>Debugging Difficulty:</strong> Inspecting streamed HTML is
            harder. Chrome DevTools shows partial HTML as it arrives.
            Traditional SSR sends one complete document that{"'"}s easy to
            inspect.
          </li>
          <li>
            <strong>HTTP/1.1 Limitations:</strong> Works best over HTTP/2+ for
            multiplexing. HTTP/1.1 head-of-line blocking can delay chunks.
            Modern deployment typically requires HTTP/2.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          To build performant applications with Streaming SSR, follow these
          practices:
        </p>
        ...
        <p>
          ...
          skeleton screens are better. Show the shape of content (gray boxes,
          placeholder text) so users understand what{"'"}s coming. Match the
        ...
        <p>
          ...
          networks (3G, rural broadband) where progressive display keeps users
          engaged. Test with Chrome DevTools network throttling. Ensure timeouts
        ...
        <p>
          ...
          edge computing (Vercel Edge, Cloudflare Workers, Deno Deploy) to
          reduce server-to-client latency. Edge functions can stream HTML from
          locations close to users.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            lazy-loaded). User scrolls while content loads. Feels instant
            compared to traditional SSR waiting for entire feed.
          </li>
          <li>
            <strong>Search Results:</strong> Search UI (input, filters) renders
            in shell. Results stream as search API responds. Facets and
            refinements (which require aggregation queries) defer with Suspense.
            Users see structure instantly.
          </li>
        </ul>

        <p>
          Streaming SSR is <strong>not ideal</strong> for simple static pages
          (blogs, marketing sites) where everything is fast and
          cacheable—traditional SSG or SSR is simpler. Also challenging for
          pages requiring aggressive CDN caching, as streaming responses are
          hard to cache.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            - Overview of rendering strategies including streaming
          </li>
        </ul>
      </section>
    </ArticleLayout>
