...
import { ArticleImage } from "@/components/articles/ArticleImage";
    ...
    export default function LegacyBrowserSupportConciseArticle() {
      return (
        <ArticleLayout metadata={metadata}>
    <section>
        <h2>Definition & Context</h2>
        <p>Comprehensive guide to legacy browser strategy, compatibility tradeoffs, and support policies.</p>
        <p>At staff/principal level, connect standards decisions to system reliability, user trust, and operational risk.</p>
      </section>

      <section>
        <h2>Strategic Implications</h2>
        <p>Legacy Browser Support shapes how users experience reliability across devices, networks, and browser versions. A clear standards strategy reduces churn, support burden, and incident risk.</p>
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/system-design-concepts/frontend/web-standards-and-compatibility/legacy-browser-support-diagram-1.svg" alt="Architecture & Data Flow diagram" caption="Compatibility architecture overview." />
      ...
      <section>
        ...
        <p>Define explicit support policy and tiers. This matters at scale because small compatibility gaps compound into large support costs and create inconsistent user expectations.</p><p>Use differential bundling (module/nomodule). This matters at scale because small compatibility gaps compound into large support costs and create inconsistent user expectations.</p><p>Prioritize critical flows for legacy support. This matters at scale because small compatibility gaps compound into large support costs and create inconsistent user expectations.</p><p>Monitor legacy usage to justify investment. This matters at scale because small compatibility gaps compound into large support costs and create inconsistent user expectations.</p>
      </section>
      ...
      <section>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-left text-sm">
            ...
            <tbody>
              <tr className="border-b border-theme/40"><td className="py-2">High legacy user share</td><td className="py-2">Modern-only audiences</td><td className="py-2">Higher maintenance</td></tr><tr className="border-b border-theme/40"><td className="py-2">Regulated industries</td><td className="py-2">Consumer apps</td><td className="py-2">Compliance constraints</td></tr><tr className="border-b border-theme/40"><td className="py-2">Global reach</td><td className="py-2">Local enterprise</td><td className="py-2">More build variants</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse text-left text-sm">
            ...
            <tbody>
              <tr className="border-b border-theme/40"><td className="py-2">Reach</td><td className="py-2">Legacy support</td><td className="py-2">Performance cost</td></tr><tr className="border-b border-theme/40"><td className="py-2">Speed</td><td className="py-2">Modern-only</td><td className="py-2">Reduced accessibility</td></tr><tr className="border-b border-theme/40"><td className="py-2">Complexity</td><td className="py-2">Multiple bundles</td><td className="py-2">Build and QA overhead</td></tr><tr className="border-b border-theme/40"><td className="py-2">Reliability</td><td className="py-2">Strict support policy</td><td className="py-2">Feature limitations</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>Legacy support when users &gt;2-5% of traffic.</li><li>Limit advanced features in legacy builds.</li><li>Provide explicit messaging for unsupported browsers.</li>
        </ul>
      </section>

      <section>
        <h2>Failure Modes & Mitigations</h2>
        <ArticleImage src="/diagrams/system-design-concepts/frontend/web-standards-and-compatibility/legacy-browser-support-diagram-2.svg" alt="Failure Modes & Mitigations diagram" caption="Failure modes and fallback paths." />
        <ul className="space-y-2">
          <li>Shipping modern JS that crashes on legacy browsers.</li><li>Over-polyfilling and bloating bundles.</li><li>No communication about unsupported browsers.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>Avoid shipping modern js that crashes on legacy browsers. because it reduces resilience.</li><li>Avoid over-polyfilling and bloating bundles. because it reduces resilience.</li><li>Avoid no communication about unsupported browsers. because it reduces resilience.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>Legacy browsers mis-handle ES modules.</li><li>Polyfills break native implementations.</li><li>Old TLS stacks prevent resource loading.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>Backend may need TLS and cipher compatibility for legacy clients.</li><li>CDN can route legacy bundles based on user agent.</li>
        </ul>
      </section>
      ...
      <section>
        <h2>Metrics & SLOs</h2>
        <ul className="space-y-2">
          <li>Legacy user share and retention.</li><li>Legacy bundle size and load time.</li><li>Compatibility error rate.</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>Use differential bundling with module/nomodule.</li><li>Keep legacy builds minimal and stable.</li>
        </ul>
      </section>

      <section>
        <h2>Testing & Rollout</h2>
        <ArticleImage src="/diagrams/system-design-concepts/frontend/web-standards-and-compatibility/legacy-browser-support-diagram-3.svg" alt="Testing & Rollout diagram" caption="Testing matrix and rollout strategy." />
        <ul className="space-y-2">
          <li>Run smoke tests on legacy browsers for critical flows.</li><li>Track errors by browser version.</li>
        </ul>
      </section>
      ...
      <section>
        <h2>Case Study</h2>
        <p>A public sector portal kept legacy support for IE 11 by serving a legacy bundle and limiting advanced UI features to modern browsers.</p>
      </section>

      <section>
        <h2>Postmortem Lessons</h2>
        <p>An app dropped legacy support without notice and saw a spike in support calls. Adding a deprecation banner reduced confusion.</p>
      </section>
