    ...
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="crucial">
          Staff-level point: treat connectivity as a spectrum. You need a
          reliable signal for “can reach my backend” (heartbeat/fetch failures),
          plus quality (effectiveType/saveData), and you must prevent “slow
          network” from becoming “broken UX” (timeouts, retries, offline fallbacks).
        </HighlightBlock>
        <HighlightBlock as="p" tier="important">
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="crucial">
          Interview focus: show you can pick the right adaptation levers (images,
          JS, third-party) and validate them with real-user data segmented by
          effective network type and saveData.
        </HighlightBlock>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="crucial">
          Interview focus: distinguish “adapter online” from “backend reachable”
          (lie-fi/captive portals), and describe how you degrade/queue/retry work
