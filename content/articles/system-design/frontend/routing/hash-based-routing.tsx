    ...
    <ArticleLayout metadata={metadata}>
        ...
        <div className="my-6 overflow-x-auto rounded-lg border border-theme">
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-theme">
              <HighlightBlock as="tr" tier="important"><td className="px-4 py-3 font-medium">URL format</td><td className="px-4 py-3">app.com/#/path</td><td className="px-4 py-3">app.com/path</td></HighlightBlock>
              <HighlightBlock as="tr" tier="important"><td className="px-4 py-3 font-medium">Server config</td><td className="px-4 py-3">None required</td><td className="px-4 py-3">Catch-all fallback required</td></HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial">Use hash routing only when server-side URL rewriting isn&apos;t available (static hosting, embedded widgets, Electron apps)</HighlightBlock>
          <HighlightBlock as="li" tier="important">Adopt a consistent convention — <code>#/path</code> is cleaner and more standard than <code>#!/path</code></HighlightBlock>
          <HighlightBlock as="li" tier="important">Implement your own query parameter parsing within the hash since the browser won&apos;t do it</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial"><strong>Broken in-page anchors:</strong> Since the hash is used for routing, <code>{"<a href=\"#section\">"}</code> triggers a route change instead of scrolling. Workaround: use <code>scrollIntoView()</code> programmatically</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Social sharing issues:</strong> Many social platforms strip or ignore hash fragments when scraping metadata, making shared links lose their route context</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Server-side rendering impossible:</strong> The server cannot read the hash, so it can&apos;t pre-render the correct content — every request returns the same shell HTML</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <div className="my-6 rounded-lg bg-panel-soft p-6">
          ...
          <HighlightBlock as="p" tier="important">
            The core trade-off to call out in interviews: hash routing avoids server rewrite
            requirements but makes URLs less clean and can constrain SEO and analytics tooling that
            expects path-based routes.
          </HighlightBlock>
        </div>
        <div className="my-6 rounded-lg bg-panel-soft p-6">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: Why doesn&apos;t changing the hash trigger a page reload?</HighlightBlock>
            <HighlightBlock as="p" tier="important">
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: When would you choose hash routing over History API routing?</HighlightBlock>
