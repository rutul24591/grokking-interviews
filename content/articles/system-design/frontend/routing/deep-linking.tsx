    ...
    <ArticleLayout metadata={metadata}>
        ...
        <div className="my-6 overflow-x-auto rounded-lg border border-theme">
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-theme">
              <HighlightBlock as="tr" tier="important"><td className="px-4 py-3 font-medium">Custom schemes (myapp://)</td><td className="px-4 py-3">None</td><td className="px-4 py-3">None (any app can claim)</td><td className="px-4 py-3">No</td></HighlightBlock>
              <HighlightBlock as="tr" tier="important"><td className="px-4 py-3 font-medium">Universal Links / App Links</td><td className="px-4 py-3">Automatic (opens browser)</td><td className="px-4 py-3">Domain verification</td><td className="px-4 py-3">No (native only)</td></HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial">Design stable URL schemas — changing URL structure breaks bookmarks and shared links</HighlightBlock>
          <HighlightBlock as="li" tier="important">Use Universal Links / App Links instead of custom URL schemes for mobile deep linking</HighlightBlock>
          <HighlightBlock as="li" tier="important">Ensure every deep-linkable page has unique Open Graph metadata for social sharing</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial"><strong>Broken SPA deep links:</strong> Server returns 404 for client-side routes because no catch-all rule is configured</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Missing association file:</strong> Universal Links / App Links fail silently if the association file is misconfigured, expired, or not served with the correct content type</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Generic OG tags:</strong> All shared links show the same title and image because the server returns the same HTML shell for every URL — fix with SSR or pre-rendering</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <div className="my-6 rounded-lg bg-panel-soft p-6">
          ...
          <HighlightBlock as="p" tier="crucial">
            ...
            link opens the Slack app and scrolls to that message.
          </HighlightBlock>
          <HighlightBlock as="p" tier="important">
            On mobile, Universal Links open the Slack native app to the same location. If the app
            isn&apos;t installed, the web version renders the message with a prompt to install.
          </HighlightBlock>
        </div>
        <div className="my-6 rounded-lg bg-panel-soft p-6">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: How do Universal Links differ from custom URL schemes?</HighlightBlock>
            <HighlightBlock as="p" tier="important">
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: How does deferred deep linking work?</HighlightBlock>
