    ...
    <ArticleLayout metadata={metadata}>
        ...
        <div className="my-6 overflow-x-auto rounded-lg border border-theme">
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-theme">
              <HighlightBlock as="tr" tier="important"><td className="px-4 py-3 font-medium">Layout persistence</td><td className="px-4 py-3">Parent layouts persist across child navigations</td><td className="px-4 py-3">Entire page remounts on every route change</td></HighlightBlock>
              <HighlightBlock as="tr" tier="important"><td className="px-4 py-3 font-medium">State preservation</td><td className="px-4 py-3">Sidebar scroll, form inputs, animation state preserved</td><td className="px-4 py-3">All UI state lost on navigation</td></HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial">Mirror the visual hierarchy in your route structure — if UI nests, routes should nest</HighlightBlock>
          <HighlightBlock as="li" tier="important">Use layout routes for shared chrome (headers, sidebars) that should persist across child navigations</HighlightBlock>
          <HighlightBlock as="li" tier="important">Define index routes for every parent route to handle the default/empty child state</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial"><strong>Missing Outlet:</strong> Defining child routes but forgetting to render <code>{"<Outlet />"}</code> in the parent — children simply don&apos;t appear</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Key-based remount:</strong> Using the route path as a React key on the outlet forces child components to unmount/remount on every navigation, defeating the purpose of nesting</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Stale parent data:</strong> Parent loaders may cache data that becomes stale as children modify it. Use revalidation or shared state to keep parent data fresh</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <div className="my-6 rounded-lg bg-panel-soft p-6">
          ...
          <HighlightBlock as="p" tier="important">
            The key architectural benefit is state retention: keeping parent layouts mounted avoids
            re-initializing expensive providers (data caches, websockets, feature flags) and reduces
            UI churn during intra-section navigation.
          </HighlightBlock>
        </div>
        <div className="my-6 rounded-lg bg-panel-soft p-6">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: Why use nested routes instead of rendering layouts manually in each page?</HighlightBlock>
            <HighlightBlock as="p" tier="important">
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: How do parallel routes differ from nested routes?</HighlightBlock>
