    ...
    <ArticleLayout metadata={metadata}>
        ...
        <div className="my-6 overflow-x-auto rounded-lg border border-theme">
          <table className="min-w-full text-sm">
            ...
            <tbody className="divide-y divide-theme">
              <HighlightBlock as="tr" tier="important"><td className="px-4 py-3 font-medium">URL params</td><td className="px-4 py-3">Yes (copy URL)</td><td className="px-4 py-3">Yes</td><td className="px-4 py-3">Yes</td></HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial">Put shareable, bookmarkable state in URL params: search queries, filters, pagination, sort order, active tabs</HighlightBlock>
          <HighlightBlock as="li" tier="important">Omit params that hold default values to keep URLs clean</HighlightBlock>
          <HighlightBlock as="li" tier="important">Use <code>replaceState</code> for high-frequency updates (typing, slider changes) and <code>pushState</code> for discrete navigation actions</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="crucial"><strong>History stack pollution:</strong> Pushing a new history entry on every keystroke in a search box. Users must click back dozens of times to return. Use replaceState for incremental updates</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Encoding issues:</strong> Not encoding special characters in param values. A search for &quot;cats &amp; dogs&quot; breaks the URL if not encoded as <code>cats+%26+dogs</code></HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Stale component state:</strong> Initializing React state from URL params in useState but not updating when the URL changes. Use the URL as the source of truth — read from useSearchParams on every render</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <div className="my-6 rounded-lg bg-panel-soft p-6">
          ...
          <HighlightBlock as="p" tier="important">
            The system-design nuance is normalization: parameter order, defaults, and invalid values
            must map to a single canonical query to avoid cache fragmentation and duplicate indexing
            of near-identical result pages.
          </HighlightBlock>
        </div>
        <div className="my-6 rounded-lg bg-panel-soft p-6">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: When should UI state live in URL params vs component state?</HighlightBlock>
            <HighlightBlock as="p" tier="important">
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important">Q: How do you avoid polluting the browser history when updating URL params frequently?</HighlightBlock>
