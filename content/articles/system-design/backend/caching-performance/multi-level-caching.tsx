  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/caching-performance/multi-level-hierarchy.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/caching-performance/multi-level-read.svg"
          alt="Multi-level read flow"
          caption="Reads traverse layers from fastest to slowest"
        />
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/caching-performance/multi-level-write.svg"
