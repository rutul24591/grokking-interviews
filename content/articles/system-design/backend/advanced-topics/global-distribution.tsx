  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/advanced-topics/global-distribution-diagram-1.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/advanced-topics/global-distribution-diagram-2.svg"
      ...
      <section>
        ...
        <p className="mt-4">
          Also separate the <strong>control plane</strong> from the <strong>data plane</strong>. Global routing, config,
          and key management need higher availability than any single region because they decide where traffic goes and
          what is allowed. Many &quot;multi-region&quot; outages are really control-plane outages: a healthy region cannot
          serve because configuration, credentials, or routing state is unavailable.
        </p>
      </section>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/advanced-topics/global-distribution-diagram-3.svg"
