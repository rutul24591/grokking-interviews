  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/advanced-topics/geo-sharding-diagram-1.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/advanced-topics/geo-sharding-diagram-2.svg"
      ...
      <section>
        <h2>Compliance and Data Classes: Not Everything Moves the Same Way</h2>
        <p>
          Geo-sharding is frequently driven by policy. To keep the design coherent, classify data into a few classes and
          define allowed replication and access paths for each class. This avoids accidental leakage where a derived view
          or a debug endpoint moves sensitive fields out of region.
        </p>
        <ul className="mt-4 space-y-2">
          <li>
            <strong>Residency-bound state:</strong> personal data and regulated records remain in-region and are accessed
            through region-aware services only.
          </li>
          <li>
            <strong>Global metadata:</strong> non-sensitive identifiers and routing hints can replicate globally to
            support discovery and efficient routing.
          </li>
          <li>
            <strong>Derived representations:</strong> caches and indexes can replicate only if they are scrubbed and have
            clear expiry and rebuild workflows.
          </li>
        </ul>
        <p className="mt-4">
          This classification also shapes the directory contract. The directory should answer &quot;where is the source
          of truth for this identity?&quot; and should support migrations with explicit versioning so caches can be
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-concepts/backend/advanced-topics/geo-sharding-diagram-3.svg"
