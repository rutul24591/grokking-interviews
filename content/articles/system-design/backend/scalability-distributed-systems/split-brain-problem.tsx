...
export default function SplitBrainProblemConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/split-brain-problem-diagram-1.png"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/split-brain-problem-diagram-3.png"
