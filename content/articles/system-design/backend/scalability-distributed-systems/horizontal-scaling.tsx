...
export default function HorizontalScalingConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/horizontal-vs-vertical-scaling.svg"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/scaling-out.svg"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/stateful-scaling-out.svg"
