...
export default function DataReplicationConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/storage-sr-servertoserver.png"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/storage-sr-clustertocluster.png"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/scalability-distributed-systems/storage-sr-stretchcluster.png"
