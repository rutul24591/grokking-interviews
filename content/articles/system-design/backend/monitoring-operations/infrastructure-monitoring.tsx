  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="important">Use this checklist to keep infrastructure monitoring actionable and correlated with impact.</HighlightBlock>
        <ul className="mt-4 space-y-2">
          <HighlightBlock as="li" tier="important">Monitor utilization and saturation for CPU, memory, disk, and network, segmented by zone and node pool.</HighlightBlock>
          <HighlightBlock as="li" tier="important">Track orchestrator signals: pending pods, evictions, throttling, and failed placements.</HighlightBlock>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="important">Show you can reason from user symptoms to platform bottlenecks and safe mitigations.</HighlightBlock>
