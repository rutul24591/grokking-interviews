...
export default function APIVersioningConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/semantic-versioning.svg"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/semver-example.jpg"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/content-negotiation.png"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Define what &quot;breaking&quot; means: wire contract, semantics, and error behavior.</li>
      <li>Compare versioning mechanisms (path, header, negotiation) and the operational cost of each.</li>
      <li>Explain deprecation governance: sunset policy, communication, and enforcement with clear timelines.</li>
      <li>Describe how you prevent silent breakage: contract tests, schema diffing, and compatibility checks in CI.</li>
      <li>Show how you migrate real clients (mobile vs server), including telemetry for adoption and rollback safety.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>Who are the clients and how quickly can they update (mobile apps, SDKs, partners, internal services)?</li>
    <li>Which changes are breaking, and how do you detect them before release (contract tests, golden responses)?</li>
    <li>How is the version selected, routed, and cached, and how do you avoid ambiguous negotiation?</li>
    <li>What is the deprecation policy (window, reminders, headers) and what happens after the sunset date?</li>
    <li>How do you run parallel versions without duplicating business logic (adapters, facade layer)?</li>
    <li>What metrics prove migration is healthy (traffic share, errors per version, client upgrade velocity)?</li>
  </ul>
</section>
