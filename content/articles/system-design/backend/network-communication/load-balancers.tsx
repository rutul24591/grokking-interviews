...
export default function LoadBalancersConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/load-balancing-cluster-nat.svg"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain L4 vs L7 balancing, where TLS terminates, and how that choice affects observability and security.</li>
      <li>Discuss algorithms (round robin, least connections, EWMA) and what traffic patterns break naive choices.</li>
      <li>Cover health checks, outlier detection, and connection draining during deploys and instance failures.</li>
      <li>Address long-lived connections (WebSockets, SSE) and what it means for stickiness and timeouts.</li>
      <li>Show the operational view: per-target latency, error rates, and how you detect imbalance and hotspots.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>What is the failure detection model (health checks, passive probes) and how quickly do you eject bad targets?</li>
    <li>Do you need stickiness, and if so what state is being protected and where does it live?</li>
    <li>How do you handle draining on deploys so in-flight requests complete without spiking errors?</li>
    <li>What timeouts exist at the balancer (connect, idle, request) and how do they align with app timeouts?</li>
    <li>How do you detect and remediate imbalance: noisy neighbors, uneven hashing, or skewed instance capacity?</li>
  </ul>
</section>
