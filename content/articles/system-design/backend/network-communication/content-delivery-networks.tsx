...
export default function ContentDeliveryNetworksConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/cdn-content-distribution-network.svg"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/cdn-ncdn-cdn.svg"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/cdn-content-aware-slb.png"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain the cache model: cache keys, TTLs, Vary, and how personalization changes what is cacheable.</li>
      <li>Discuss invalidation: purge vs versioned URLs and the operational cost of fast purges.</li>
      <li>Cover origin protection: request collapsing, origin shielding, and rate limiting on cache miss storms.</li>
      <li>Call out security: signed URLs or cookies, WAF placement, and avoiding sensitive data in cached responses.</li>
      <li>Show metrics you watch: hit ratio, origin fetch latency, eviction rate, and error rates by POP.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>What is the cache key and how do you prevent fragmentation from query params, headers, and cookies?</li>
    <li>Which responses are allowed to be cached, and what is the staleness budget for each content class?</li>
    <li>How do you invalidate safely (purge APIs, versioned assets) and how quickly must changes propagate?</li>
    <li>How do you protect the origin during a cold cache or traffic spike (shielding, rate limits, collapse)?</li>
    <li>How do you handle authenticated or personalized content without leaking data across users?</li>
  </ul>
</section>
