...
export default function ServiceMeshConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/istio-architecture.svg"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/istio-ztunnel-datapath.png"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/istio-ztunnel-waypoint-datapath.png"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain what a mesh adds: mTLS, policy enforcement, traffic shaping, retries and timeouts, and standardized telemetry.</li>
      <li>Discuss data plane vs control plane and what happens when each one is unhealthy.</li>
      <li>Call out sidecar costs: added latency, resource usage, and new failure modes like proxy config drift.</li>
      <li>Describe safe policy rollout: staged config changes, validation, and how you prevent retries/timeouts from amplifying load.</li>
      <li>Show how you debug with mesh tooling: per-hop traces, proxy metrics, and identifying whether the proxy or the app is the bottleneck.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>Which mesh features justify the added complexity, and which should stay out of the mesh to keep it simple?</li>
    <li>What is the failure mode if the control plane is down, and how do you keep the data plane stable during outages?</li>
    <li>How do you validate policy changes (mTLS, routing, retries) before rollout and ensure rollback is fast?</li>
    <li>What is the performance budget for sidecars, and how do you capacity-plan for proxy CPU and memory?</li>
    <li>How do you prevent accidental global changes (retry policies, timeouts) from causing load amplification?</li>
  </ul>
</section>
