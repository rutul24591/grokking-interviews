...
export default function gRPCConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/http2-hpack.svg"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/http2-vs-http3-protocol-stack.svg"
