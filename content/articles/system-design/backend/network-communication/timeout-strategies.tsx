...
export default function TimeoutStrategiesConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/tcp-timeout.png"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/tcp-ack-timeout.png"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/ident-timeout.svg"
