...
export default function ServerSentEventsSSEConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/server-sent-events.png"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/http-persistent-connection.svg"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/technology-push.png"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain SSE as server-to-client streaming over HTTP and how reconnection works.</li>
      <li>Discuss delivery guarantees: event IDs, resume behavior, and handling duplicates after reconnect.</li>
      <li>Call out intermediary constraints: proxy buffering, idle timeouts, and keepalives.</li>
      <li>Describe scaling: per-connection resource costs, fanout strategy, and isolating noisy clients.</li>
      <li>Compare with WebSockets and long polling, and justify the choice based on directionality and complexity.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>How do clients resume after disconnect (cursor, last event ID) and how long do you retain missed events?</li>
    <li>What keepalive strategy prevents proxies from buffering or closing idle streams?</li>
    <li>How do you enforce authorization on long-lived streams, including token rotation and revocation?</li>
    <li>How do you scale fanout: per-user streams, shared streams, or brokered distribution?</li>
    <li>What metrics prove stream health (disconnect rate, delivery latency, backlog) beyond HTTP status codes?</li>
  </ul>
</section>
