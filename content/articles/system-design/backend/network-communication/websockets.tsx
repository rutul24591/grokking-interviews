...
export default function WebSocketsConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/websocket-connection.png"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/websocket-diagram.png"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/websocket-frame-header.png"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain the connection lifecycle: HTTP upgrade, authentication, and how reconnects preserve user experience.</li>
      <li>Discuss scaling: connection fanout, stickiness vs shared state, and how you route messages to the right server.</li>
      <li>Cover liveness: heartbeats, idle timeouts, and handling half-open connections behind proxies.</li>
      <li>Call out backpressure: buffering limits, slow consumers, and how to avoid memory blowups under bursty traffic.</li>
      <li>Compare with SSE and long polling and justify WebSockets when bidirectional or low-latency interaction is required.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>Where does connection state live, and how do you route messages when you scale out (sticky sessions or a shared broker)?</li>
    <li>How do clients resume after reconnect (cursor, ack) and how do you handle duplicates and ordering?</li>
    <li>What heartbeat and timeout policy keeps connections healthy without excess traffic?</li>
    <li>How do you enforce quotas (connections, message rate, payload size) to prevent one client from exhausting capacity?</li>
    <li>What signals prove health (disconnect rate, send queue depth, fanout lag) and where do you alert?</li>
  </ul>
</section>
