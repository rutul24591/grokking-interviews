...
export default function ReverseProxyConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/reverse-proxy-h2g2bob.svg"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/proxy-website-diagram.svg"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/proxy-schematic.svg"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain what the reverse proxy is responsible for: TLS termination, routing, buffering, caching, and security policy.</li>
      <li>Discuss header trust boundaries (forwarded headers, client IP) and how misconfiguration becomes a security bug.</li>
      <li>Call out proxy failure modes: timeouts, buffer limits, bad routing rules, and how they manifest as application incidents.</li>
      <li>Describe safe rollout mechanics: canary routing, config validation, and fast rollback for broken rules.</li>
      <li>Show operational signals: per-route latency, upstream error rates, and proxy saturation metrics.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>Where is TLS terminated and how are certificates rotated without downtime?</li>
    <li>Which headers are trusted, and how do you prevent spoofed forwarded headers from bypassing security controls?</li>
    <li>What timeouts exist at the proxy (connect, idle, request) and how do they align with app timeouts?</li>
    <li>Is caching or compression enabled, and how do you ensure it does not change semantics for dynamic endpoints?</li>
    <li>How do you validate and roll out config changes (linting, staging, canary) and what is the rollback path?</li>
  </ul>
</section>
