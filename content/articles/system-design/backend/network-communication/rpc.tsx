...
export default function RPCConciseArticle() {
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/rpc-call-steps.png"
      alt="RPC call steps"
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/traditional-client-server.svg"
...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/recommendation-service-sequence.jpg"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain the coupling trade-off: RPC makes synchronous dependencies explicit and pushes you to manage deadlines.</li>
      <li>Describe how interfaces evolve safely: compatibility rules, deprecations, and contract tests.</li>
      <li>Cover timeouts, retries, and cancellation as a single end-to-end policy, not independent knobs.</li>
      <li>Discuss error models and retryability: what fails fast vs what is safe to retry with backoff.</li>
      <li>Show debugging approach: tracing across hops, per-method latency, and isolating fanout bottlenecks.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>What is the end-to-end timeout budget per method, and how is remaining time propagated to downstream calls?</li>
    <li>How will you evolve the interface without forcing lockstep deployments across services?</li>
    <li>How do you prevent synchronous fanout from turning one request into many dependency calls?</li>
    <li>Which errors are retriable, and what is the backoff and retry-budget policy?</li>
    <li>What instrumentation is required to attribute latency to the right hop (client, server, dependency)?</li>
  </ul>
</section>
