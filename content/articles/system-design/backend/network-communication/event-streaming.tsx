...
<section>
  ...
  <section>
    ...
    <ArticleImage
      src="/diagrams/system-design-concepts/backend/network-communication/pubsub-azure-pattern.png"
...
<section>
  ...
  <section>
    ...
    <ul className="space-y-2">
      <li>Explain the ordering model: what is ordered (per partition) and what is not (across partitions).</li>
      <li>Discuss partitioning choices and their operational consequences: hot partitions, skew, and rebalancing.</li>
      <li>Describe consumer behavior: lag, backpressure, retries, and how you recover from backlog growth.</li>
      <li>Cover delivery semantics and idempotency: at-least-once processing, replays, and safe side effects.</li>
      <li>Explain schema evolution and compatibility so producers and consumers can ship independently.</li>
    </ul>
  </section>
...
<section>
  ...
  <ul className="space-y-2">
    <li>What ordering do consumers rely on, and what is the partition key that provides it?</li>
    <li>How do you handle lag: autoscaling consumers, pausing producers, or shedding non-critical events?</li>
    <li>What is the poison-event strategy (retry policy, DLQ, quarantine) and how do you enable replay safely?</li>
    <li>How do you evolve event schemas without breaking older consumers (compat rules, default fields, versioning)?</li>
    <li>What are retention and replay expectations, and who owns data lifecycle for topics?</li>
  </ul>
</section>
