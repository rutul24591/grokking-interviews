...
<section>
  <h2>System Framing</h2>
        <ArticleImage src="/diagrams/frontend/edge-cases-and-user-experience/empty-states-diagram-1.svg" alt="System Framing diagram" caption="System framing for user experience edge cases." />
...
<section>
  <h2>Failure Modes & Mitigations</h2>
        <ArticleImage src="/diagrams/frontend/edge-cases-and-user-experience/empty-states-diagram-2.svg" alt="Failure Modes & Mitigations diagram" caption="Common failure paths and mitigations." />
  <ul className="space-y-2">
...
<section>
  <h2>Testing & Rollout</h2>
        <ArticleImage src="/diagrams/frontend/edge-cases-and-user-experience/empty-states-diagram-3.svg" alt="Testing & Rollout diagram" caption="Testing strategy for edge-case behavior." />
