...
import { ArticleImage } from "@/components/articles/ArticleImage";
    ...
    <section>
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/frontend/web-standards-and-compatibility/css-vendor-prefixes-diagram-1.svg" alt="Architecture & Data Flow diagram" caption="Compatibility architecture overview." />
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/frontend/web-standards-and-compatibility/css-vendor-prefixes-diagram-2.svg" alt="Failure Modes & Mitigations diagram" caption="Failure modes and fallback paths." />
        <ul className="space-y-2">
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/frontend/web-standards-and-compatibility/css-vendor-prefixes-diagram-3.svg" alt="Testing & Rollout diagram" caption="Testing matrix and rollout strategy." />
        <ul className="space-y-2">
