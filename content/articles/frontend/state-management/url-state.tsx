  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/frontend/state-management/url-anatomy.svg"
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/frontend/state-management/url-state-flow.svg"
      ...
      <section>
        ...
        <p>These issues frequently arise in production URL state implementations:</p>
