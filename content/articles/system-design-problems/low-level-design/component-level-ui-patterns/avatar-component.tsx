  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-problems/low-level-design/avatar-component-architecture.svg"
          alt="Avatar component architecture showing state model, fallback chain, render output, and accessibility"
