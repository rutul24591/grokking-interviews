  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <HighlightBlock as="p" tier="crucial">We need to design a PDF viewer component — a UI for displaying PDF documents</HighlightBlock>
<HighlightBlock as="p" tier="important">with page navigation, zoom controls, text search within the document, optional</HighlightBlock>
<HighlightBlock as="p" tier="important">annotation support (highlights, notes), and full keyboard accessibility.</HighlightBlock>
        <p>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <HighlightBlock as="li" tier="important"><strong>Page Navigation:</strong> Previous/Next buttons, page number input, thumbnail sidebar for quick navigation.</HighlightBlock>
        ...
        <ul className="space-y-2">
          <HighlightBlock as="li" tier="important"><strong>Performance:</strong> 100+ page PDF loads smoothly. Pages render on-demand (virtualized).</HighlightBlock>
          <HighlightBlock as="li" tier="crucial"><strong>Accessibility:</strong> Screen reader reads PDF text content, keyboard navigation between pages and controls.</HighlightBlock>
        </ul>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="important">The core idea is a <Highlight tier="important"><strong>PDF.js-based viewer</strong></Highlight> that loads the PDF
          document, renders pages as canvas elements on demand, and provides a toolbar
          for navigation, zoom, and search.</HighlightBlock>
<HighlightBlock as="p" tier="crucial">A <strong>Zustand store</strong> manages
          the current page, zoom level, search results, and annotations. Pages are
          virtualized — only visible pages render, reducing memory usage.</HighlightBlock>
      </section>
      ...
      <section>
        ...
        <div className="my-6 rounded-lg border border-theme bg-panel-soft p-6">
          ...
          <HighlightBlock as="p" tier="crucial">Uses PDF.js to load the document, parse pages, extract text content for search. Handles password prompts and error states.</HighlightBlock>
        </div>
        <div className="my-6 rounded-lg border border-theme bg-panel-soft p-6">
          <h4 className="mb-3 font-semibold">2. Page Renderer</h4>
          <HighlightBlock as="p" tier="important">Renders pages as canvas elements at the current zoom level. Uses IntersectionObserver to render only visible pages.</HighlightBlock>
        </div>
        <div className="my-6 rounded-lg border border-theme bg-panel-soft p-6">
          <h4 className="mb-3 font-semibold">3. Search Engine</h4>
          <HighlightBlock as="p" tier="important">Extracts text content from all pages, builds a text index, finds matches for the search query, highlights matches on rendered pages.</HighlightBlock>
        </div>
        <div className="my-6 rounded-lg border border-theme bg-panel-soft p-6">
          <h4 className="mb-3 font-semibold">4. Annotation Layer</h4>
          <HighlightBlock as="p" tier="important">SVG overlay on top of the canvas for highlights, notes, and shapes. Annotations persist to localStorage or server.</HighlightBlock>
        </div>
      ...
      <section>
        ...
        <ul className="space-y-3">
          <HighlightBlock as="li" tier="important"><strong>Password-protected PDF:</strong> PDF.js throws a password exception. The viewer shows a password prompt. On correct password, re-parses the document.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Large pages:</strong> Pages larger than the viewport are scaled down to fit. Zoom controls allow the user to zoom in for detail.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Corrupted PDF:</strong> PDF.js throws a parse error. The viewer shows an error state with &quot;This PDF could not be loaded&quot; and a retry button.</HighlightBlock>
        </ul>
      </section>
...
<HighlightBlock as="p" tier="important">PDF.js for parsing and rendering, canvas-based page rendering,
          IntersectionObserver for virtualized</HighlightBlock>
<HighlightBlock as="p" tier="important">page rendering, SVG overlay for annotations,
          and full ARIA compliance for screen reader text access.</HighlightBlock>
      </section>
        ...
        <div className="my-4 overflow-x-auto">
          <table className="w-full border-collapse text-sm">
            ...
            <tbody className="divide-y divide-theme">
              <HighlightBlock as="tr" tier="crucial"><td className="p-2">Page render</td><td className="p-2">O(w × h) — canvas fill</td><td className="p-2">O(w × h) — canvas buffer</td></HighlightBlock>
              <HighlightBlock as="tr" tier="important"><td className="p-2">Text search</td><td className="p-2">O(t) — t = total text length</td><td className="p-2">O(t) — text index</td></HighlightBlock>
              <HighlightBlock as="tr" tier="important"><td className="p-2">Annotation render</td><td className="p-2">O(a) — a annotations per page</td><td className="p-2">O(a)</td></HighlightBlock>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="important"><Highlight tier="important">PDF URLs are validated against an allowlist. PDF.js renders in a sandboxed
          iframe to prevent script execution within the PDF.</Highlight></HighlightBlock>
<HighlightBlock as="p" tier="crucial">For accessibility, the PDF
          ...
          scroll, Ctrl+F opens search, Ctrl++/- for zoom.</HighlightBlock>
      </section>

      <section>
        <h2>Testing Strategy</h2>
        <ul className="space-y-2">
          <HighlightBlock as="li" tier="important"><strong>Unit:</strong> PDF loader — test parse, password handling, error states. Search engine — test text extraction, match finding.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Integration:</strong> Load PDF, verify first page renders. Scroll, verify virtualized pages render. Search, verify highlights appear.</HighlightBlock>
          <HighlightBlock as="li" tier="crucial"><strong>Accessibility:</strong> Screen reader reads PDF text content, keyboard navigation between pages, zoom controls accessible.</HighlightBlock>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-3">
          <HighlightBlock as="li" tier="important"><strong>Rendering all pages at once:</strong> A 100-page PDF rendered as 100 canvas elements causes memory issues. Virtualized rendering is mandatory.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>No text layer for accessibility:</strong> Canvas-only rendering is invisible to screen readers. A hidden text layer behind the canvas is essential.</HighlightBlock>
