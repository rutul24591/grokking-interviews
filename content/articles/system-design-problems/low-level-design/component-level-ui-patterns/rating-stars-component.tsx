  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/system-design-problems/low-level-design/rating-stars-component-architecture.svg"
          alt="Rating stars component architecture showing value state, hover preview, star rendering, and form accessibility"
