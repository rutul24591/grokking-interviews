  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <p>Activation milestones are events that the product team has identified as predictive of long-term retention. They are defined in a configuration (not hardcoded) with fields like: milestoneId, eventType, conditions (for example, recipient type is coworker), and a human-readable description. When the user completes the corresponding action anywhere in the product, the event is published to a Kafka topic. A milestone evaluator consumer checks each event against the registered milestone conditions; when a match is found, the milestone is recorded for the user (userId, milestoneId, completedAt, sessionId).</p>
