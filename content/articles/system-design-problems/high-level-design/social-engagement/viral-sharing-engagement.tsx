  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <p>The sharing system has two main pipelines. The Link Generation Pipeline produces shareable URLs with embedded tracking parameters, generates OG metadata for link previews, and serves dynamically generated OG images from a Puppeteer-based screenshot service with Redis-backed caching. The Attribution Pipeline tracks shares as events (share.created Kafka), records link clicks (click.recorded), and joins click events to registration events within the attribution window to assign referral credit. Real-time share counts and viewer counts are maintained as Redis HyperLogLog structures (PFADD/PFCOUNT) with a 30-second polling refresh on the client side.</p>
      </section>
