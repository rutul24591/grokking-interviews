...
const definition = [
  ...
  "The goal is to design a viral sharing and engagement system so users see relevant, fresh, and safe social content without exposing private actors, losing user actions, or amplifying abuse. The design must address graph scale, hot users, projection lag, mobile constraints, ranking changes, and trust-and-safety intervention.",
...
const concepts = [
  ...
  "The second concept is projection architecture. share graph, attribution, and rate limit are optimized for different read patterns. The design should not force every UI to join raw social tables at request time.",
...
const architecture = [
  "The architecture has five cooperating planes: share graph, attribution, rate limit, link scanner, ranking guardrail. The write plane records durable social facts and emits events. Projection workers build feed, profile, notification, counter, search, and analytics views. The read API serves surface-optimized projections. Integrity and moderation systems can remove or demote content quickly. The frontend renders stable cursors, pending actions, and recovery states.",
...
const pitfalls = [
  "spam amplification is a scale failure that appears suddenly. The design should define hot-key handling, fanout backpressure, cache windows, and degraded behavior before traffic arrives.",
  "fraud attribution is usually caused by inconsistent policy enforcement across derived surfaces. Fixing the main UI is not enough if notifications, search, emails, or previews still expose restricted information.",
  "policy bypass undermines user trust because social products feel personal. Users notice missing posts, duplicate cards, incorrect counters, and unexplained ranking shifts quickly.",
  "hot object requires abuse-aware product design. Rate limits and classifiers help, but the system also needs support tooling, appeals, audit trails, and emergency controls.",
...
const useCases = [
  "invite loops requires graph visibility, ranking or grouping policy, projection freshness, and abuse controls to work together rather than as separate features.",
  "share-to-story requires graph visibility, ranking or grouping policy, projection freshness, and abuse controls to work together rather than as separate features.",
  "creator referral campaign requires graph visibility, ranking or grouping policy, projection freshness, and abuse controls to work together rather than as separate features.",
...
const questions = [
  {
    "question": "How would you design a viral sharing and engagement system end to end?",
  ...
  },
  {
    ...
    "answer": "The main failures are spam amplification, fraud attribution, policy bypass, hot object, plus hot users, viral content, counter drift, notification storms, moderation backlog, and cache stampedes. Prevention requires hybrid fanout, ranked windows, idempotent actions, integrity scoring, projection-lag monitoring, and emergency throttles."
  },
  {
  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/social-engagement/viral-sharing-engagement.svg" alt="Design a Viral Sharing and Engagement System architecture" caption="Architecture view: graph writes, projections, ranking, privacy, integrity, and surface-specific reads." />
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/social-engagement/viral-sharing-engagement-flow.svg" alt="Design a Viral Sharing and Engagement System flow" caption="Flow view: user action, fanout or projection, ranking, notification, moderation, and recovery." />
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/social-engagement/viral-sharing-engagement-operations.svg" alt="Design a Viral Sharing and Engagement System operations" caption="Operations view: fanout backlog, projection lag, privacy invalidation, abuse signals, and moderation controls." />
      </section>
