...
const definition = [
  "Design an Amazon/Flipkart-like Frontend is a commerce correctness system wrapped in a shopping experience. A principal-ready design treats a marketplace frontend as a coordinated set of catalog, pricing, inventory, payment, order, fulfillment, fraud, and support workflows rather than a collection of product cards.",
...
const concepts = [
  "The first concept is promise integrity. catalog service, search and ranking, and cart service produce the promise shown to the customer, but final purchase or refund decisions must revalidate authoritative state.",
...
const pitfalls = [
  "catalog staleness is a product trust failure. It should be handled through authoritative validation, explicit state, and support-visible history instead of silent UI correction.",
  "stock race often appears when browse projections are used as transaction truth. The system should treat cached results as hints, not final commitments.",
  "promotion abuse requires user-facing recovery. The UI should explain what changed and offer safe next actions rather than forcing a generic retry.",
  "checkout outage needs operational tooling. Manual database repair is not an acceptable support workflow for money, inventory, entitlement, or returns.",
...
const useCases = [
  "marketplace homepage requires browse speed, transactional correctness, risk controls, and support reconstruction to work together.",
  "product detail page requires browse speed, transactional correctness, risk controls, and support reconstruction to work together.",
  "flash sale experience requires browse speed, transactional correctness, risk controls, and support reconstruction to work together.",
...
const questions = [
  {
    "question": "How would you design a marketplace frontend end to end?",
  ...
  },
  {
    ...
    "answer": "The main failures are catalog staleness, stock race, promotion abuse, checkout outage, plus flash-sale bot traffic, hot SKUs, provider outages, promotion bugs, fraud rings, recommendation drift, and support overload. Prevention requires cache strategy, authoritative revalidation, idempotency, holds, risk controls, staged rollout, and operational kill switches."
  },
  {
  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/ecommerce-marketplace/amazon-flipkart-frontend.svg" alt="Design an Amazon/Flipkart-like Frontend architecture" caption="Architecture view: browse projections, transaction state, risk controls, support history, and operational boundaries." />
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/ecommerce-marketplace/amazon-flipkart-frontend-flow.svg" alt="Design an Amazon/Flipkart-like Frontend flow" caption="Flow view: user intent, validation, hold or quote, payment/order/refund state, and recovery." />
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/ecommerce-marketplace/amazon-flipkart-frontend-operations.svg" alt="Design an Amazon/Flipkart-like Frontend operations" caption="Operations view: stale data, provider failure, fraud, rollback, reconciliation, and support reconstruction." />
      </section>
