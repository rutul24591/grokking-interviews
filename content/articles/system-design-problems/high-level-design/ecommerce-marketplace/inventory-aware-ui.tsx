...
const definition = [
  "Design an Inventory-aware UI is a commerce correctness system wrapped in a shopping experience. A principal-ready design treats an inventory-aware UI as a coordinated set of catalog, pricing, inventory, payment, order, fulfillment, fraud, and support workflows rather than a collection of product cards.",
...
const concepts = [
  "The first concept is promise integrity. availability service, reservation ledger, and warehouse routing produce the promise shown to the customer, but final purchase or refund decisions must revalidate authoritative state.",
...
const pitfalls = [
  "oversell is a product trust failure. It should be handled through authoritative validation, explicit state, and support-visible history instead of silent UI correction.",
  "stale availability often appears when browse projections are used as transaction truth. The system should treat cached results as hints, not final commitments.",
  "split-shipment surprise requires user-facing recovery. The UI should explain what changed and offer safe next actions rather than forcing a generic retry.",
  "reservation leak needs operational tooling. Manual database repair is not an acceptable support workflow for money, inventory, entitlement, or returns.",
...
const useCases = [
  "low-stock product page requires browse speed, transactional correctness, risk controls, and support reconstruction to work together.",
  "store pickup selector requires browse speed, transactional correctness, risk controls, and support reconstruction to work together.",
  "delivery promise widget requires browse speed, transactional correctness, risk controls, and support reconstruction to work together.",
...
const questions = [
  {
    "question": "How would you design an inventory-aware UI end to end?",
  ...
  },
  {
    ...
    "answer": "The main failures are oversell, stale availability, split-shipment surprise, reservation leak, plus flash-sale bot traffic, hot SKUs, provider outages, promotion bugs, fraud rings, recommendation drift, and support overload. Prevention requires cache strategy, authoritative revalidation, idempotency, holds, risk controls, staged rollout, and operational kill switches."
  },
  {
  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/ecommerce-marketplace/inventory-aware-ui.svg" alt="Design an Inventory-aware UI architecture" caption="Architecture view: browse projections, transaction state, risk controls, support history, and operational boundaries." />
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/ecommerce-marketplace/inventory-aware-ui-flow.svg" alt="Design an Inventory-aware UI flow" caption="Flow view: user intent, validation, hold or quote, payment/order/refund state, and recovery." />
        <ArticleImage src="/diagrams/system-design-problems/high-level-design/ecommerce-marketplace/inventory-aware-ui-operations.svg" alt="Design an Inventory-aware UI operations" caption="Operations view: stale data, provider failure, fraud, rollback, reconciliation, and support reconstruction." />
      </section>
