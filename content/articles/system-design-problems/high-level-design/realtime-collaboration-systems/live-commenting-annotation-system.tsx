  ...
  return (
    <ArticleLayout metadata={metadata}>
      ...
      <section>
        ...
        <HighlightBlock as="p" tier="crucial">The annotation system is layered on top of the document system. Annotations are stored separately from document content (the document is not modified when an annotation is added) and reference the document via stable anchors. The Annotation Service manages CRUD operations for annotations and their replies, delivers real-time updates via WebSocket, and recomputes anchor positions when document edit operations affect the anchor region. The annotation rendering layer in the frontend positions annotation markers over the document text using the current anchor positions, handles viewport culling for large annotation sets, and manages the comment sidebar panel.</HighlightBlock>
      </section>
