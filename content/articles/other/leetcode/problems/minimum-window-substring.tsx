...
export const metadata: ArticleMetadata = {
  id: "leetcode-problem-minimum-window-substring",
...
export default function MinimumWindowSubstringArticle() {
  return (
    <ArticleLayout metadata={metadata}>
      <h2 className="text-2xl font-bold mt-8 mb-4">Definition &amp; Context</h2>
      <HighlightBlock as="p" tier="crucial" className="mb-4">
        Minimum Window Substring is a representative Leetcode interview problem that tests whether the candidate can recognize the right pattern, state the invariant, handle edge cases, and explain the complexity trade-off without drifting into brute force.
      </HighlightBlock>
      ...
      <HighlightBlock as="p" tier="important" className="mb-4">
        For Minimum Window Substring, the optimized flow should be framed around the sliding window decision loop. Each iteration must either consume new input, shrink the search space, settle a subproblem, or advance a traversal frontier.
      </HighlightBlock>
      <HighlightBlock as="p" tier="important" className="mb-4">
      ...
      <HighlightBlock as="p" tier="important" className="mb-4">
        Minimum Window Substring maps to production work whenever services must process streams, collections, dependencies, or user-generated structures with predictable memory and latency.
      </HighlightBlock>
      <HighlightBlock as="p" tier="important" className="mb-4">
      ...
      <h3 className="text-xl font-semibold mt-6 mb-3">How would you solve Minimum Window Substring, and how do you prove the optimized solution is correct?</h3>
      <HighlightBlock as="p" tier="crucial" className="mb-4">
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <a href="https://leetcode.com/problems/minimum-window-substring/" target="_blank" rel="noreferrer" className="text-primary underline">
