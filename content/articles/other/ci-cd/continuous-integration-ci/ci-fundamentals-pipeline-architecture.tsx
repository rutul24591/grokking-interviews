...
export default function CiFundamentalsPipelineArchitectureArticle() {
  return (
    <ArticleLayout metadata={metadata}><HighlightBlock as="p" tier="important" className="mb-4">Interview focus: Compare the simple baseline with the optimized or production-ready approach so the trade-off is explicit.</HighlightBlock><HighlightBlock as="p" tier="important" className="mb-4">Interview focus: Name the data structure, state machine, pipeline stage, or control plane that owns each decision.</HighlightBlock><HighlightBlock as="p" tier="important" className="mb-4">Interview focus: Include the cost model: preprocessing cost, per-operation cost, storage cost, latency impact, and failure recovery cost.</HighlightBlock><HighlightBlock as="p" tier="important" className="mb-4">Interview focus: Call out common mistakes because they are often what interviewers use to distinguish memorized answers from reasoned answers.</HighlightBlock>
      <section>
        <h2>Definition &amp; Context</h2><HighlightBlock as="p" tier="crucial" className="mb-4">Interview lens: frame CI Fundamentals and Pipeline Architecture around change risk, merge safety, runner isolation, artifact provenance, feedback latency, and mainline health. This is what turns the article from concept notes into interview-ready reasoning.</HighlightBlock>
      ...
      <section>
        <h2>Core Concepts</h2><HighlightBlock as="p" tier="crucial" className="mb-4">Core invariant to defend: a CI pipeline should produce trustworthy evidence before code reaches the shared mainline.</HighlightBlock>
        <HighlightBlock as="p" tier="crucial">
      ...
      <section>
        <h2>Trade offs &amp; Comparison</h2><HighlightBlock as="p" tier="important" className="mb-4">Failure modes to call out: green individual PRs breaking in combination, privileged runners executing untrusted code, flaky checks becoming ignored, and artifacts without source provenance.</HighlightBlock>
        <HighlightBlock as="p" tier="crucial">
      ...
      <section>
        <h2>Best practices</h2><HighlightBlock as="p" tier="important" className="mb-4">Useful signals or metrics: queue time, time to signal, flaky-test rate, merge-queue failure rate, artifact reproducibility, and mainline red duration.</HighlightBlock>
        <HighlightBlock as="p" tier="crucial">
