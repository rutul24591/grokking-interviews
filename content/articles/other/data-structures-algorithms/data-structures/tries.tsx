    ...
    <ArticleLayout metadata={metadata}>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="important"><strong>Choose the radix variant for production.</strong> Standard tries are good for teaching but waste 5–20× memory on real workloads. Radix trees deliver the same O(L) lookup with a fraction of the nodes.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Pick the child map carefully.</strong> Fixed-size array (256 slots) for byte keys with high branching; hash map for large alphabets like Unicode; sorted-array binary search for memory-constrained scenarios. The choice dominates total memory.</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="important"><strong>Forgetting end-of-word marker.</strong> Inserting &quot;app&quot; then searching for &quot;app&quot; returns false (or true incorrectly) depending on which side of the bug you&apos;re on. Mark the terminal node explicitly.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Memory blow-up with large alphabets.</strong> A fixed-size 256-array per node times 1M nodes is 2GB just for child pointers. Use a hash or sorted array if branching factor is low in practice.</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important" className="font-semibold">Q: When would you use a trie over a hash table?</HighlightBlock>
            <HighlightBlock as="p" tier="important" className="mt-2 text-sm">A: When prefix queries matter — autocomplete, IP longest-prefix match, URL routing, dictionary lookups with wildcard support. A hash table can&apos;t enumerate &quot;all keys starting with X&quot; without a full scan; a trie does it with a single walk to the prefix node followed by a subtree DFS. Also when keys have a lot of shared structure (URLs, file paths, IP addresses), the trie&apos;s prefix sharing reduces memory.</HighlightBlock>
          </div>
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
