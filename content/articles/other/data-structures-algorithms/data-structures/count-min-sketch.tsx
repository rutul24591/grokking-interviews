    ...
    <ArticleLayout metadata={metadata}>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="important"><strong>Size by error tolerance, not memory budget.</strong> Pick ε and δ from product requirements (&quot;within 0.1% of total at 99% confidence&quot;), then derive w and d. Backwards sizing produces nonsense guarantees.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Use conservative update for skewed data.</strong> For Zipfian distributions (web traffic, social activity), conservative update reduces error 2–10× without changing the asymptotic bound.</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc space-y-2 pl-6">
          <HighlightBlock as="li" tier="important"><strong>Treating estimates as exact.</strong> Count-min returns an upper bound. For low-frequency items, the over-estimate can be a large multiple of the true count. Always factor the error bound into downstream logic.</HighlightBlock>
          <HighlightBlock as="li" tier="important"><strong>Querying for items never inserted.</strong> The sketch will return a non-zero estimate (collisions from other items). For membership-style questions, pair with a Bloom filter — the count-min isn&apos;t designed for absence detection.</HighlightBlock>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <HighlightBlock as="p" tier="important" className="font-semibold">Q: Why does count-min always over-estimate?</HighlightBlock>
            <HighlightBlock as="p" tier="important" className="mt-2 text-sm">A: Each row&apos;s counter accumulates contributions from all items that hash to that column. Querying item x reads counter[i][hᵢ(x)], which includes x&apos;s true count <em>plus</em> noise from collisions. The minimum across rows is the tightest such over-estimate. There&apos;s no mechanism to subtract collision noise without losing the simple analysis.</HighlightBlock>
          </div>
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
