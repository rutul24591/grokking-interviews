  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          <strong>Media Optimization</strong> encompasses techniques for reducing the size and improving the
          delivery of images, video, and audio without perceptibly degrading quality. Media assets often account
          for 60-80% of total page weight, making optimization critical for performance.
        </p>
        <p>
          The impact is measurable: every 100KB reduction in image size improves load time by ~400ms on 3G.
          E-commerce sites see 1% conversion increase per 100ms improvement. Media optimization directly affects
          Core Web Vitals, particularly LCP (Largest Contentful Paint), which is often an image.
        </p>
        <p>
          Optimization happens at multiple levels:
        </p>
        <ul>
          <li><strong>Format selection:</strong> Choosing efficient codecs (AVIF, WebP, JPEG)</li>
          <li><strong>Compression:</strong> Reducing file size through lossy/lossless techniques</li>
          <li><strong>Responsive delivery:</strong> Serving appropriate sizes for each device</li>
          <li><strong>Lazy loading:</strong> Deferring off-screen media</li>
          <li><strong>CDN delivery:</strong> Edge-cached, optimized delivery</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/frontend-nfr/media-formats-comparison.svg"
        ...
        <ul className="space-y-3">
          <li>
            <strong>AVIF:</strong> Best compression (50% smaller than JPEG), supports HDR, wide color gamut.
            Slower encoding, limited editing tool support. Browser support: 85%+.
          </li>
          <li>
            <strong>WebP:</strong> Good compression (25-35% smaller than JPEG), fast encoding/decoding.
            Universal browser support. Best balance of size and compatibility.
          </li>
          <li>
            <strong>HEIC/HEIF:</strong> Excellent compression, Apple ecosystem. Poor web support.
          </li>
        </ul>
        ...
        <ul className="space-y-3">
          <li>
            <strong>JPEG:</strong> Universal support, good for photos. Larger files than modern formats.
          </li>
          <li>
            <strong>PNG:</strong> Lossless, supports transparency. Large files, use only when necessary.
          </li>
          <li>
            <strong>GIF:</strong> Animation support. Extremely inefficient. Replace with video or APNG.
          </li>
          <li>
            <strong>SVG:</strong> Vector graphics. Perfect for icons, logos, diagrams.
          </li>
        </ul>
      ...
      <section>
        ...
        <p>
          Provide multiple resolutions, browser chooses optimal:
        </p>
...
/>`}</code>
  ...
  <img src="image.jpg" alt="Description" />
        ...
        <ArticleImage
          src="/diagrams/frontend-nfr/media-responsive-images.svg"
      ...
      <section>
        ...
        <p>
          Browser support: 85%+. Simple, no JavaScript required.
        </p>

        <h3 className="mt-6 mb-3 text-lg font-semibold">Intersection Observer</h3>
        <p>
          For more control (blur-up, fade-in, placeholders):
        </p>
        <ul className="space-y-2">
        ...
        <h3 className="mt-6 mb-3 text-lg font-semibold">Progressive Image Loading</h3>
        <p>
          Techniques for perceived performance:
        </p>
        <ul className="space-y-2">
          <li><strong>Blur-up:</strong> Tiny blurred image → full image</li>
          <li><strong>LQIP:</strong> Low Quality Image Placeholders</li>
          <li><strong>SVG placeholders:</strong> Colored SVG matching aspect ratio</li>
          <li><strong>Skeleton screens:</strong> Gray box matching dimensions</li>
        </ul>

        <ArticleImage
          src="/diagrams/frontend-nfr/media-lazy-loading.svg"
      ...
      <section>
        ...
        <p>
          Video is the largest media type — optimization is critical.
        </p>

        <h3 className="mt-6 mb-3 text-lg font-semibold">Format Selection</h3>
        <ul className="space-y-2">
          <li><strong>MP4 (H.264):</strong> Universal support, good compression</li>
          <li><strong>WebM (VP9):</strong> Better compression, open format</li>
          <li><strong>AV1:</strong> Best compression, emerging support</li>
        </ul>

        <h3 className="mt-6 mb-3 text-lg font-semibold">Optimization Techniques</h3>
        <ul className="space-y-2">
        ...
        <ul className="space-y-2">
          ...
          <li>Use <code>playsInline</code> for mobile</li>
      ...
      <section>
        ...
        <p>
          Image CDNs handle optimization automatically.
        </p>

        <h3 className="mt-6 mb-3 text-lg font-semibold">Popular Services</h3>
        <ul className="space-y-2">
          <li><strong>Cloudinary:</strong> Full-featured, AI-powered optimization</li>
          <li><strong>Imgix:</strong> Real-time processing, excellent API</li>
          <li><strong>Cloudflare Images:</strong> Integrated with Cloudflare CDN</li>
          <li><strong>AWS CloudFront + Lambda@Edge:</strong> Custom optimization at edge</li>
        </ul>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: What&apos;s the best image format for web?</p>
            <p className="mt-2 text-sm">
              A: AVIF for best compression (50% smaller than JPEG), with WebP fallback for compatibility. Use
              the picture element to serve AVIF to supporting browsers, WebP to others. For photos, never use
              PNG unless you need lossless.
            </p>
          </div>

          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: How do you implement responsive images?</p>
            <p className="mt-2 text-sm">
              A: Use srcset for resolution switching (same image, different sizes) and picture for art direction
              or format switching. Combine both: picture with multiple sources, each having srcset for
              resolutions. Always include a fallback img tag.
            </p>
          </div>

          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: What&apos;s the LCP impact of image optimization?</p>
            <p className="mt-2 text-sm">
              A: LCP is often the hero image. Optimize it aggressively: use modern formats, preload the LCP
              image, don&apos;t lazy-load it, serve appropriately sized version. These changes can improve LCP
