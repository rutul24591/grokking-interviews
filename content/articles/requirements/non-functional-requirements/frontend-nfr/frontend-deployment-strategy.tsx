    ...
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          ...
          applications to production. This includes build pipelines, hosting
          platforms, CDN configuration, rollout strategies, and rollback
          procedures. For staff engineers, deployment strategy balances velocity
          (fast releases) with reliability (zero downtime, easy rollback).
        </p>
        <p>
          Modern frontend deployment has evolved from FTP uploads to
          sophisticated CI/CD pipelines with automated testing, preview
          deployments, canary releases, and instant rollback. The right strategy
          enables multiple deploys per day with confidence.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>Hosting:</strong> Static hosting, serverless, traditional
            servers
          </li>
          <li>
            <strong>CDN:</strong> Global distribution, caching, edge functions
          </li>
          <li>
            <strong>Rollout:</strong> Blue-green, canary, gradual rollouts
          </li>
          <li>
            <strong>Rollback:</strong> Instant rollback, version retention
          </li>
          <li>
            <strong>Monitoring:</strong> Post-deploy verification, error
            tracking
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Vercel:</strong> Next.js creators, edge functions, preview
            deployments
          </li>
          <li>
            <strong>Netlify:</strong> JAMstack focus, serverless functions, form
            handling
          </li>
          <li>
            <strong>Cloudflare Pages:</strong> Edge deployment, Workers
            integration
          </li>
          <li>
            <strong>AWS S3 + CloudFront:</strong> Raw AWS, more configuration,
            cost-effective
          </li>
          <li>
            <strong>Google Firebase Hosting:</strong> Integrated with Firebase
            ecosystem
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Nginx/Apache:</strong> Full control, self-managed
          </li>
          <li>
            <strong>Docker + Kubernetes:</strong> Container orchestration,
            scaling
          </li>
          <li>
            <strong>EC2/VMs:</strong> Traditional server deployment
          </li>
          <li>
            <strong>Best for:</strong> Complex requirements, existing
            infrastructure
          </li>
        </ul>
      ...
      <section>
        ...
        <ol className="space-y-3">
          <li>
            <strong>Build:</strong> Install dependencies, run build
          </li>
          <li>
            <strong>Test:</strong> Unit tests, integration tests, E2E tests
          </li>
          <li>
            <strong>Lint/Type-check:</strong> Code quality gates
          </li>
          <li>
            <strong>Security scan:</strong> Dependency vulnerabilities
          </li>
          <li>
            <strong>Deploy to staging:</strong> Deploy to staging environment
          </li>
          <li>
            <strong>Smoke tests:</strong> Post-deploy verification
          </li>
          <li>
            <strong>Deploy to production:</strong> Production release
          </li>
          <li>
            <strong>Post-deploy monitoring:</strong> Error tracking, performance
          </li>
        </ol>
        ...
        <ul className="space-y-2">
          <li>
            <strong>GitHub Actions:</strong> Native GitHub integration, generous
            free tier
          </li>
          <li>
            <strong>GitLab CI:</strong> Integrated with GitLab, powerful
            configuration
          </li>
          <li>
            <strong>CircleCI:</strong> Fast, good caching, parallel jobs
          </li>
          <li>
            <strong>Jenkins:</strong> Self-hosted, highly customizable
          </li>
          <li>
            <strong>Vercel/Netlify CI:</strong> Built-in for those platforms
          </li>
        </ul>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Cloudflare:</strong> Free tier, global network, security
            features
          </li>
          <li>
            <strong>Fastly:</strong> Real-time purging, edge compute
          </li>
          <li>
            <strong>AWS CloudFront:</strong> AWS integration, customizable
          </li>
          <li>
            <strong>Akamai:</strong> Enterprise, largest network
          </li>
          <li>
            <strong>Platform CDN:</strong> Vercel/Netlify built-in CDN
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          ...
          <li>
            Providers: Cloudflare Workers, Vercel Edge Functions, Fastly Compute
          </li>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: What&apos;s your deployment strategy for a frontend app?
            </p>
            <p className="mt-2 text-sm">
              A: CI/CD pipeline with automated tests (unit, integration, E2E).
              Preview deployments for every PR. Deploy to staging, run smoke
              tests. Canary deployment to production (5% → 50% → 100%). Feature
              flags for gradual rollout. Instant rollback capability.
              Post-deploy monitoring (errors, performance). Use Vercel/Netlify
              for static hosting with built-in CDN.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Blue-green deployment (two environments, switch traffic). Or
              canary deployment (gradual rollout). Keep previous version
              available for instant rollback. CDN cache purge for immediate
              effect. Database migrations must be backward compatible. Test
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: How do you configure CDN caching for frontend assets?
            </p>
            <p className="mt-2 text-sm">
              A: Static assets (JS, CSS with content hashes): 1 year TTL,
              immutable. HTML pages: no-cache (revalidate every time). Images: 1
              month TTL with versioning. Use cache-control headers. Purge CDN
              cache on deploy for HTML. Leverage browser caching with proper
              headers.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: What&apos;s in your CI/CD pipeline?
            </p>
            <p className="mt-2 text-sm">
              A: Install dependencies (cached), lint, type-check, unit tests,
              integration tests, build, E2E tests, deploy to staging, smoke
              tests, deploy to production, post-deploy monitoring. Parallelize
              independent jobs. Cache node_modules. Skip irrelevant jobs. Target
              &lt;10min total pipeline time.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Keep previous versions available (10 versions or 30 days).
              One-click rollback in UI. Automated rollback on health check
              failure or error spike. Test rollback procedure regularly.
              Document rollback steps. For database changes, ensure migrations
