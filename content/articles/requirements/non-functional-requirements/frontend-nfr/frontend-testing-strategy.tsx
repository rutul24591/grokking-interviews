    ...
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          ...
          tools, and practices for verifying frontend applications work
          correctly. This includes unit tests for components and utilities,
          integration tests for component interactions, E2E tests for user
          flows, visual regression tests for UI consistency, and accessibility
          tests for inclusive design.
        </p>
        <p>
          For staff engineers, testing strategy balances confidence with
          velocity. Too little testing leads to production bugs and regression
          fear. Too much testing slows development and creates maintenance
          burden. The right strategy depends on application criticality, team
          size, and release frequency.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>Unit tests (base):</strong> Fast, isolated, many tests
          </li>
          <li>
            <strong>Integration tests (middle):</strong> Component interactions,
            fewer tests
          </li>
          <li>
            <strong>E2E tests (top):</strong> Full user flows, few critical
            paths
          </li>
          <li>
            <strong>Visual/accessibility (cross-cutting):</strong> UI
            consistency, inclusive design
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Utility functions:</strong> Pure functions with clear
            inputs/outputs
          </li>
          <li>
            <strong>Component rendering:</strong> Component renders with given
            props
          </li>
          <li>
            <strong>User interactions:</strong> Clicks, inputs, form submissions
          </li>
          <li>
            <strong>State changes:</strong> Component state updates correctly
          </li>
          <li>
            <strong>Edge cases:</strong> Empty states, error states, boundary
            conditions
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Jest:</strong> Test runner, assertions, mocking
          </li>
          <li>
            <strong>Vitest:</strong> Fast alternative, Vite-native
          </li>
          <li>
          ...
          <li>
            <strong>Vue Test Utils:</strong> Vue component testing
          </li>
          <li>
            <strong>Angular Testing:</strong> Built-in testing utilities
          </li>
        </ul>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Component composition:</strong> Parent-child component
            interaction
          </li>
          <li>
            <strong>State management:</strong> Redux/Zustand integration
          </li>
          <li>
            <strong>API integration:</strong> Component with mocked API
            responses
          </li>
          <li>
            <strong>Form flows:</strong> Multi-field form validation and
            submission
          </li>
          <li>
            <strong>Routing:</strong> Navigation between pages/components
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>React Testing Library:</strong> render, screen, user-event
          </li>
          <li>
            <strong>MSW (Mock Service Worker):</strong> API mocking
          </li>
          <li>
            <strong>Testing Library User Event:</strong> Realistic user
            interactions
          </li>
          <li>
            <strong>Redux Mock Store:</strong> Redux state mocking
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Critical user flows:</strong> Login, checkout, signup
          </li>
          <li>
            <strong>Happy paths:</strong> Primary use cases
          </li>
          <li>
            <strong>Error flows:</strong> Failed login, payment errors
          </li>
          <li>
            <strong>Cross-browser:</strong> Chrome, Firefox, Safari
          </li>
          <li>
            <strong>Mobile:</strong> Responsive behavior on mobile viewports
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Cypress:</strong> Popular, developer-friendly, good DX
          </li>
          <li>
            <strong>Playwright:</strong> Microsoft, multi-browser, auto-wait
          </li>
          <li>
            <strong>Puppeteer:</strong> Chrome-focused, lower-level
          </li>
          <li>
            <strong>WebdriverIO:</strong> Selenium-based, enterprise
          </li>
        </ul>
      ...
      <section>
        ...
        <p>Visual regression tests catch unintended UI changes.</p>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Chromatic:</strong> Storybook integration, cloud-based
          </li>
          <li>
            <strong>Percy:</strong> Visual review platform
          </li>
          <li>
            <strong>Playwright screenshots:</strong> Built-in visual comparison
          </li>
          <li>
            <strong>BackstopJS:</strong> Open-source option
          </li>
        </ul>
      ...
      <section>
        ...
        <p>
          Accessibility tests ensure applications are usable by people with
          disabilities.
        </p>
        ...
        <ul className="space-y-2">
          <li>
            <strong>axe-core:</strong> Accessibility engine
          </li>
          <li>
            <strong>jest-axe:</strong> Jest integration
          </li>
          <li>
            <strong>cypress-axe:</strong> Cypress integration
          </li>
          <li>
            <strong>eslint-plugin-jsx-a11y:</strong> Linting for a11y issues
          </li>
        </ul>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/requirements/nfr/frontend-nfr/ci-cd-testing-pipeline.svg"
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Line coverage:</strong> Percentage of lines executed
          </li>
          <li>
            <strong>Branch coverage:</strong> Percentage of branches taken
          </li>
          <li>
            <strong>Function coverage:</strong> Percentage of functions called
          </li>
          <li>
            <strong>Statement coverage:</strong> Percentage of statements
            executed
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Istanbul/nyc:</strong> JavaScript coverage
          </li>
          <li>
            <strong>Jest coverage:</strong> Built-in coverage
          </li>
          <li>
            <strong>Vitest coverage:</strong> Vite-native coverage
          </li>
          <li>
            <strong>Cypress coverage:</strong> E2E coverage
          </li>
        </ul>
      </section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: What&apos;s your testing strategy for a React application?
            </p>
            <p className="mt-2 text-sm">
              A: Testing pyramid approach. Unit tests with Jest + React Testing
              Library for components and utilities. Integration tests for
              component interactions with mocked APIs. E2E tests with
              Cypress/Playwright for critical user flows (login, checkout).
              Visual regression with Chromatic for UI components. Accessibility
              tests with axe-core in CI. Run unit tests on every commit, E2E on
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Unit tests verify isolated components/functions — fast, many
              tests. Integration tests verify component interactions — medium
              speed, fewer tests. E2E tests verify complete user flows in real
              browser — slow, few critical paths only. Follow testing pyramid:
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Automated: eslint-plugin-jsx-a11y for linting, axe-core in unit
              tests, cypress-axe in E2E tests. Manual: Screen reader testing
              (NVDA, VoiceOver), keyboard navigation testing, user testing with
              disabled users. Automated catches ~30% of issues — manual testing
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Identify flaky tests (fail intermittently). Quarantine them so
              they don&apos;t block deploys. Add retry logic as temporary
              measure. Fix root causes — usually timing issues, race conditions,
              or external dependencies. Monitor flaky test rate. Don&apos;t
              ignore flaky tests — they erode team confidence in the test suite.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: 80%+ line coverage for critical code, but coverage is a guide
              not a goal. Focus on testing important logic, not chasing 100%.
              High coverage doesn&apos;t mean good tests — you can have 100%
              coverage and still miss critical bugs. Test critical paths, edge
              cases, and business logic. Don&apos;t waste time testing trivial
              code (getters, re-exports).
            </p>
          </div>
        </div>
      </section>
