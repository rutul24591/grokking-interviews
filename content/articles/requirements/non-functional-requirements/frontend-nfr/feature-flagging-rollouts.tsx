    ...
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          ...
          is a technique for conditionally hiding or showing features in an
          application. Flags enable gradual rollouts, A/B testing, instant kill
          switches, and decoupling deployment from release. For staff engineers,
          feature flags are essential for risk mitigation and experimentation at
          scale.
        </p>
        <p>
          Feature flags transform release decisions from binary (deployed or
          not) to continuous (0% → 100% rollout). This enables testing in
          production with minimal risk, quick rollback without redeploy, and
          data-driven release decisions based on metrics.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>Gradual rollout:</strong> 1% → 5% → 25% → 50% → 100%
          </li>
          <li>
            <strong>A/B testing:</strong> Compare variants with real users
          </li>
          <li>
            <strong>Kill switch:</strong> Instant disable if issues detected
          </li>
          <li>
            <strong>Targeted release:</strong> Beta users, internal teams,
            specific segments
          </li>
          <li>
            <strong>Ops flags:</strong> Disable expensive features during
            incidents
          </li>
          <li>
            <strong>Permission flags:</strong> Enable features by user role/plan
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ArticleImage
          src="/diagrams/requirements/nfr/frontend-nfr/rollout-strategies.svg"
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              ...
              redeploy. Benefits: gradual rollout (reduce risk), A/B testing
              (data-driven decisions), kill switch (instant rollback), decouple
              deployment from release. Essential for modern CI/CD and
              experimentation.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Hash user ID to get consistent assignment. Compare hash to
              percentage threshold. Same user always gets same variant.
              Gradually increase percentage (1% → 5% → 25% → 50% → 100%).
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: What&apos;s your flag cleanup strategy?
            </p>
            <p className="mt-2 text-sm">
              A: Document flag purpose and expected lifetime. Track flag usage
              (identify stale flags). Remove release flags after 100% rollout
              and stable period. Quarterly flag audit. Keep ops and permission
              flags (long-lived). Technical debt if flags accumulate.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Always provide default value. Cache flags locally for offline.
              Graceful degradation (feature off by default or last known state).
              Don&apos;t block page load waiting for flags. Retry with backoff.
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: What&apos;s the difference between release flags and experiment
              flags?
            </p>
            <p className="mt-2 text-sm">
              A: Release flags are short-lived, for gradual rollout, removed
              after 100% release. Experiment flags are for A/B testing,
              longer-lived, measure metric impact, removed after experiment
              concludes. Both need cleanup, but experiment flags require
              statistical analysis before removal.
            </p>
          </div>
        </div>
      </section>
