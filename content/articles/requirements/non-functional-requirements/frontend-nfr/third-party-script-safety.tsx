    ...
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          ...
          integrating external scripts (analytics, ads, chat widgets, A/B
          testing, payment processors) while minimizing security risks,
          performance impact, and privacy concerns. Third-party scripts run with
          full access to your page — they can read cookies, capture keystrokes,
          modify content, and exfiltrate data.
        </p>
        <p>
          For staff engineers, third-party script management is a risk balancing
          act. Marketing teams want analytics and tracking. Support wants chat
          widgets. Revenue depends on ads. But each script increases attack
          surface, slows page load, and creates dependencies on external
          providers.
        </p>
        <p>
        ...
        <ul>
          <li>
            <strong>Analytics:</strong> Google Analytics, Adobe Analytics,
            Mixpanel
          </li>
          <li>
            <strong>Ads:</strong> Google AdSense, Facebook Audience Network
          </li>
          <li>
            <strong>Chat widgets:</strong> Intercom, Drift, Zendesk
          </li>
          <li>
            <strong>A/B testing:</strong> Optimizely, VWO, Google Optimize
          </li>
          <li>
            <strong>Payment:</strong> Stripe, PayPal, Braintree
          </li>
          <li>
            <strong>Social:</strong> Facebook Pixel, Twitter widgets, LinkedIn
            Insight
          </li>
          <li>
            <strong>Tag managers:</strong> Google Tag Manager, Tealium
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          ...
          <li>
            Examples: British Airways Magecart attack (2018), Ticketmaster
            (2018)
          </li>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Network overhead:</strong> Each script is an additional HTTP
            request
          </li>
          <li>
            <strong>JavaScript execution:</strong> Third-party JS blocks main
            thread
          </li>
          <li>
            <strong>Render blocking:</strong> Scripts in head delay page render
          </li>
          <li>
            <strong>Layout shift:</strong> Widgets loading can cause CLS
          </li>
          <li>
            <strong>Long tasks:</strong> Third-party code can cause 500ms+ tasks
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          ...
          <li>
            Third-party scripts are leading cause of performance regressions
          </li>
        </ul>
      ...
      <section>
        ...
        <p>CSP restricts which scripts can execute on your page.</p>
        <ul className="space-y-2">
          <li>
            <code>script-src</code>: Specify allowed script sources
          </li>
          <li>Use nonces or hashes for inline scripts</li>
          <li>
            Avoid <code>unsafe-inline</code> and <code>unsafe-eval</code>
          </li>
          <li>
            Report violations with <code>report-uri</code> or{" "}
            <code>report-to</code>
          </li>
        ...
        <p>SRI ensures third-party scripts haven&apos;t been tampered with.</p>
        <ul className="space-y-2">
        ...
        <p>Isolate third-party widgets in sandboxed iframes.</p>
        <ul className="space-y-2">
          <li>
            <code>sandbox</code> attribute restricts iframe capabilities
          </li>
        ...
        <p>Modern API to prevent DOM XSS from third-party scripts.</p>
        <ul className="space-y-2">
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Async:</strong>{" "}
            <code>&lt;script async src=&quot;...&quot;&gt;</code> — Download and
            execute ASAP
          </li>
          <li>
            <strong>Defer:</strong>{" "}
            <code>&lt;script defer src=&quot;...&quot;&gt;</code> — Execute
            after HTML parsed
          </li>
          <li>
            <strong>Dynamic:</strong> Create script element programmatically
          </li>
          <li>
            <strong>Lazy:</strong> Load on user interaction or visibility
          </li>
          <li>
            <strong>Web Worker:</strong> Run in worker thread (if supported)
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Google Tag Manager:</strong> Central management for
            marketing tags
          </li>
          <li>
            <strong>Tealium:</strong> Enterprise tag management
          </li>
          <li>
            <strong>Segment:</strong> Customer data platform with tag routing
          </li>
          <li>
            <strong>Benefits:</strong> Single integration, marketing team
            control, versioning
          </li>
          <li>
            <strong>Risks:</strong> Single point of failure, additional
            overhead, less visibility
          </li>
        </ul>
      ...
      <section>
        ...
        <ul className="space-y-3">
          <li>
            <strong>Minimize third-party scripts:</strong> Every script is a
            risk. Question each one.
          </li>
          <li>
          ...
          <li>
            <strong>Sandbox untrusted content:</strong> Use sandboxed iframes
            for ads, widgets.
          </li>
          <li>
            <strong>Monitor continuously:</strong> Track performance and
            security impact.
          </li>
          <li>
            <strong>Respect consent:</strong> Block scripts until user consents
            (GDPR/CCPA).
          </li>
          <li>
            <strong>Have fallback plans:</strong> What if third-party fails or
            is compromised?
          </li>
          <li>
            <strong>Document all third-parties:</strong> Maintain inventory with
            purpose and risk level.
          </li>
          <li>
            <strong>Regular audits:</strong> Quarterly review of all third-party
            scripts.
          </li>
        </ul>
        ...
        <div className="my-6 rounded-lg border border-accent/30 bg-accent/10 p-6">
          ...
          <p>
            In staff engineer interviews, demonstrate understanding that
            third-party scripts are a security and performance risk, not just a
            convenience. Discuss CSP, SRI, async loading, and consent
            management. Show awareness of supply chain attacks (Magecart).
            Emphasize minimizing third-party dependencies and having contingency
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Supply chain attacks (compromised vendor serves malicious
              code), data exfiltration (stealing cookies, keystrokes, form
              data), DOM manipulation (defacement, phishing forms), and privacy
              violations (cross-site tracking). Examples: British Airways and
              Ticketmaster Magecart attacks where thousands of sites were
              affected by single compromised script.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Content Security Policy (restrict script sources), Subresource
              Integrity (verify script hasn&apos;t been tampered), sandboxed
              iframes for untrusted widgets, Trusted Types API, async/defer
              loading to prevent render blocking, consent management for
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Network overhead (each script is additional HTTP request),
              JavaScript execution blocking main thread, render-blocking if not
              async/defer, layout shift from widgets loading, long tasks causing
              jank. Average page has 70+ third-party requests accounting for
              30-50% of total JS. Mitigate with async loading, lazy loading, and
              performance budgets.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: SRI adds integrity hash to script tags. Browser verifies hash
              before executing, preventing compromised CDN from serving
              malicious code. Use for static third-party scripts (CDN-hosted
              libraries). Generate hash with srihash.org. Update hash when
              vendor updates script. Doesn&apos;t protect against dynamic
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Block non-essential scripts until user consents. Use consent
              management platform (OneTrust, Cookiebot). Respect Global Privacy
              Control signal. Log consent decisions. Allow users to withdraw
              consent. Categorize scripts (essential, analytics, marketing).
