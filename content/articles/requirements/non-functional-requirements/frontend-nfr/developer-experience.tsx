    ...
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          ...
          productive, happy, and effective. Good DX reduces cognitive load,
          minimizes friction, and accelerates development velocity. For staff
          engineers, DX is a force multiplier — investing in developer
          productivity compounds across the entire team.
        </p>
        <p>
          DX impacts hiring (developers prefer good DX), retention (frustrated
          developers leave), and output quality (happy developers write better
          code). Measuring DX requires both quantitative metrics (build times,
          test feedback loops) and qualitative feedback (developer surveys,
        ...
        <ul>
          <li>
            <strong>Tooling:</strong> IDE, linters, formatters, debuggers
          </li>
          <li>
            <strong>Feedback loops:</strong> Build times, test execution, hot
            reload
          </li>
          <li>
            <strong>Documentation:</strong> Onboarding, APIs, architecture
            decisions
          </li>
          <li>
            <strong>Workflow:</strong> Git workflow, CI/CD, code review process
          </li>
          <li>
            <strong>Environment:</strong> Local setup, staging environments, dev
            tools
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            One-command setup (<code>pnpm install</code>, <code>pnpm dev</code>)
          </li>
          <li>Document prerequisites (Node version, pnpm version)</li>
          <li>
            Use <code>.nvmrc</code> or <code>.tool-versions</code> for version
            management
          </li>
        ...
        <ul className="space-y-2">
          <li>
            Share VS Code settings (<code>.vscode/settings.json</code>)
          </li>
        ...
        <ul className="space-y-2">
          <li>
            Use <code>.env</code> files for environment variables
          </li>
          <li>
            Provide <code>.env.example</code> with required variables
          </li>
      ...
      <section>
        ...
        <ul className="space-y-2">
          ...
          <li>
            Store in repository (<code>docs/adr/</code>)
          </li>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Satisfaction:</strong> Developer happiness and well-being
          </li>
          <li>
            <strong>Performance:</strong> Output and quality
          </li>
          <li>
            <strong>Activity:</strong> Actions performed (commits, PRs, reviews)
          </li>
          <li>
            <strong>Communication:</strong> Collaboration and knowledge sharing
          </li>
          <li>
            <strong>Efficiency:</strong> Flow state, uninterrupted time
          </li>
        </ul>
        ...
        <ArticleImage
          src="/diagrams/requirements/nfr/frontend-nfr/dx-metrics-framework.svg"
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Fast feedback loops (builds, tests), clear error messages, good
              documentation, consistent tooling (linters, formatters), easy
              onboarding, and reliable CI/CD. Measure both quantitative (build
              times, test duration) and qualitative (developer surveys, friction
              logs). Invest in DX as force multiplier for team productivity.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Profile builds to identify bottlenecks. Use caching
              (dependency, build cache). Implement code splitting. Upgrade to
              faster tools (Vite vs webpack, esbuild vs Babel). Monitor build
              times over time. Target &lt;5s dev server start, &lt;1s HMR.
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: README with quick start, setup guide with prerequisites,
              architecture overview, API documentation (auto-generated), ADRs
              for significant decisions, component documentation (Storybook),
              troubleshooting guide. Keep docs close to code, update with
              changes, make searchable.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Use SPACE framework — Satisfaction, Performance, Activity,
              Communication, Efficiency. Quantitative: build times, test
              duration, deployment frequency, lead time. Qualitative: developer
              surveys, friction logs, onboarding feedback. Avoid vanity metrics
              (lines of code, commits). Focus on outcomes, not output.
            </p>
          </div>

          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: What&apos;s your approach to code quality tooling?
            </p>
            <p className="mt-2 text-sm">
              A: ESLint for linting, Prettier for formatting (format on save),
              TypeScript for type safety. Pre-commit hooks with lint-staged for
              fast feedback. Run in CI as gate. Balance strictness with
              pragmatism — too many rules frustrate developers. Share configs
              across projects for consistency.
            </p>
          </div>
        </div>
      </section>
