  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          <strong>Build Optimization</strong> encompasses techniques to reduce
          bundle size, improve load performance, and accelerate build times.
          This includes bundling, tree-shaking, code splitting, minification,
          compression, and caching strategies. For staff engineers, build
          optimization balances output quality (small bundles) with build
          performance (fast builds) and developer experience (fast HMR).
        </p>
        <p>
          Build decisions have long-term impact on application performance and
          team productivity. The right bundler configuration can reduce bundle
          size by 50%+, improve load times by seconds, and accelerate CI/CD
          pipelines. Poor build configuration leads to bloated bundles, slow
        ...
        <ul>
          <li>
            <strong>Small bundles:</strong> Less JavaScript to download and
            parse
          </li>
          <li>
            <strong>Fast builds:</strong> Quick feedback for developers, faster
            CI/CD
          </li>
          <li>
            <strong>Efficient caching:</strong> Leverage browser and CDN caching
          </li>
          <li>
            <strong>Modern output:</strong> Ship modern JavaScript to modern
            browsers
          </li>
          <li>
            <strong>Source maps:</strong> Debug production issues effectively
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Maturity:</strong> Most mature, largest ecosystem
          </li>
          <li>
            <strong>Features:</strong> Code splitting, tree-shaking, HMR,
            extensive loader ecosystem
          </li>
          <li>
            <strong>Performance:</strong> Slower than newer tools, but optimized
            over time
          </li>
          <li>
            <strong>Configuration:</strong> Complex, flexible
          </li>
          <li>
            <strong>Best for:</strong> Large projects, complex requirements,
            legacy support
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Architecture:</strong> ESM-based dev server, Rollup for
            production
          </li>
          <li>
            <strong>Performance:</strong> Instant HMR, fast cold start
          </li>
          <li>
            <strong>Configuration:</strong> Simple, convention over
            configuration
          </li>
          <li>
            <strong>Features:</strong> Built-in CSS, JSON, asset handling
          </li>
          <li>
            <strong>Best for:</strong> Modern projects, React/Vue/Svelte, fast
            DX
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Performance:</strong> 10-100x faster than webpack (Go-based)
          </li>
          <li>
            <strong>Features:</strong> Bundling, minification, transpilation
          </li>
          <li>
            <strong>Limitations:</strong> Less mature ecosystem, fewer plugins
          </li>
          <li>
            <strong>Use cases:</strong> Fast builds, simple projects, as webpack
            loader
          </li>
          <li>
            <strong>Best for:</strong> Performance-critical builds, prototyping
          </li>
        </ul>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Focus:</strong> Library bundling, tree-shaking
          </li>
          <li>
            <strong>Output:</strong> Clean, efficient bundles
          </li>
          <li>
            <strong>Features:</strong> Excellent tree-shaking, multiple output
            formats
          </li>
          <li>
            <strong>Best for:</strong> Libraries, packages, simple applications
          </li>
        </ul>
      ...
      <section>
        ...
        <ul className="space-y-2">
          ...
          <li>
            Mark packages as side-effect-free (<code>"sideEffects": false</code>
            )
          </li>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <strong>Gzip:</strong> Universal support, 70-80% compression
          </li>
          <li>
            <strong>Brotli:</strong> Better compression (80-90%), modern
            browsers
          </li>
          <li>
            <strong>Zstandard:</strong> Fast, emerging support
          </li>
        ...
        <ul className="space-y-2">
          ...
          <li>
            Use <code>.br</code> files for Brotli, <code>.gz</code> for Gzip
          </li>
      ...
      <section>
        ...
        <ul className="space-y-2">
          ...
          <li>
            Use &lt;script type=&quot;module&quot;&gt; for modern, nomodule for
            legacy
          </li>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li>
            <code>source-map</code>: Full source map, best for debugging
          </li>
          <li>
            <code>inline-source-map</code>: Embedded in bundle, larger
          </li>
          <li>
            <code>hidden-source-map</code>: Generated but not referenced
          </li>
          <li>
            <code>nosources-source-map</code>: No source content, privacy
          </li>
          <li>
            <code>false</code>: No source maps (production default)
          </li>
        </ul>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Tree-shaking (ES6 modules, side-effect-free packages), code
              splitting (route-based, component-based), replace heavy libraries
              (moment → dayjs, lodash-es), analyze bundles
              (webpack-bundle-analyzer), enable minification and compression.
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Depends on project. Vite for modern React/Vue/Svelte apps —
              fast HMR, simple config. Webpack for complex projects, legacy
              support, extensive plugin ecosystem. esbuild for fastest builds,
              simple projects. Rollup for libraries. Consider team familiarity,
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Static analysis of ES6 import/export statements. Bundler
              identifies unused exports and removes them from bundle. Requires
              ES6 module syntax — CommonJS doesn&apos;t tree-shake well. Mark
              packages as side-effect-free. Import specific functions, not
              entire libraries.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            ...
            <p className="mt-2 text-sm">
              A: Use faster tools (esbuild, swc vs Babel), enable caching (file
              system, dependency), parallelize builds, exclude node_modules from
              transpilation, use include/exclude properly. Monitor build times,
              alert on regressions. Target &lt;5s dev build, &lt;30s production
              build.
            </p>
          </div>
          ...
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">
              Q: What&apos;s your code splitting strategy?
            </p>
            <p className="mt-2 text-sm">
              A: Route-based splitting (load page code on navigation),
              component-based for heavy components (charts, modals), vendor
              chunk for dependencies (cache long-term), common chunk for shared
              code. Use React.lazy + Suspense. Balance splitting overhead vs
              bundle size — don&apos;t over-split.
            </p>
          </div>
        </div>
      </section>
