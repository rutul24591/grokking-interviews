  ...
  return (
    <ArticleLayout metadata={metadata}>
      <section>
        ...
        <p>
          <strong>Conflict Resolution UX</strong> addresses how applications handle situations where
          the same data has been modified in multiple places — different tabs, different devices, or
          by different users — and those modifications conflict with each other. Conflicts occur in
          offline-first apps, collaborative editing, multi-device sync, and distributed systems.
        </p>
        <p>
          For staff engineers, conflict resolution is both a technical and UX challenge. Technically,
          you need detection mechanisms and resolution algorithms. From a UX perspective, you need to
          handle conflicts gracefully without confusing or frustrating users.
        </p>
        <p>
          <strong>When conflicts occur:</strong>
        </p>
        <ul>
          <li><strong>Offline editing:</strong> User edits document offline, same document edited on another device</li>
          <li><strong>Multi-tab editing:</strong> Same form open in multiple tabs, both submitted</li>
          <li><strong>Collaborative editing:</strong> Multiple users edit same document simultaneously</li>
          <li><strong>Mobile sync:</strong> Phone and tablet both modified contact list while offline</li>
          <li><strong>Queue replay:</strong> Queued actions conflict with current server state</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="space-y-2">
          ...
          <li>Use logical timestamps (Lamport clocks) for distributed systems</li>
          <li>Server timestamp preferred over client timestamp</li>
        </ul>

        <h3 className="mt-8 mb-4 text-xl font-semibold">Field-Level Tracking</h3>
        <ul className="space-y-2">
        ...
        <ArticleImage
          src="/diagrams/frontend-nfr/conflict-detection-methods.svg"
      ...
      <section>
        ...
        <ul className="space-y-2">
          ...
          <li>If user A changes title and user B changes content, both changes kept</li>
        ...
        <h3 className="mt-8 mb-4 text-xl font-semibold">Operational Transformation (OT)</h3>
        <ul className="space-y-2">
        ...
        <ArticleImage
          src="/diagrams/frontend-nfr/conflict-resolution-strategies.svg"
      ...
      <section>
        ...
        <h3 className="mt-8 mb-4 text-xl font-semibold">Conflict Notification</h3>
        <ul className="space-y-2">
          ...
          <li>Example: &quot;This document was modified on another device. Review changes and choose which to keep.&quot;</li>
        </ul>

        <h3 className="mt-8 mb-4 text-xl font-semibold">Side-by-Side Comparison</h3>
        <ul className="space-y-2">
        ...
        <h3 className="mt-8 mb-4 text-xl font-semibold">Preserve Both Versions</h3>
        <ul className="space-y-2">
        ...
        <h3 className="mt-8 mb-4 text-xl font-semibold">Automatic Merge with Review</h3>
        <ul className="space-y-2">
        ...
        <ArticleImage
          src="/diagrams/frontend-nfr/conflict-ux-patterns.svg"
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li><strong>On sync:</strong> Detect and resolve when coming back online</li>
          <li><strong>On save:</strong> Check for conflicts before committing</li>
          <li><strong>On open:</strong> Check for conflicts when opening document</li>
          <li><strong>Real-time:</strong> Resolve as changes arrive (collaborative editing)</li>
        </ul>
      ...
      <section>
        ...
        <ul className="space-y-2">
          <li><strong>G-Counter:</strong> Grow-only counter (only increments)</li>
          <li><strong>PN-Counter:</strong> Positive-negative counter (increment and decrement)</li>
          <li><strong>LWW-Register:</strong> Last-write-wins register</li>
          <li><strong>OR-Set:</strong> Observed-remove set (add/remove elements)</li>
          <li><strong>RGA:</strong> Replicated Growable Array (for text editing)</li>
        </ul>

        <h3 className="mt-8 mb-4 text-xl font-semibold">CRDT Libraries</h3>
        <ul className="space-y-2">
          <li><strong>Yjs:</strong> Popular, well-documented, many bindings</li>
          <li><strong>Automerge:</strong> JSON-like API, good for documents</li>
          <li><strong>Crdts:</strong> Rust implementation with WASM bindings</li>
          <li><strong>GunDB:</strong> Real-time database with CRDTs</li>
        </ul>
        ...
        <ul className="space-y-2">
          ...
          <li>Avoid when: Simple LWW is sufficient, complexity not justified</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: How do you detect conflicts in offline-first apps?</p>
            <p className="mt-2 text-sm">
              A: Version vectors track version per device — conflict if versions are concurrent.
              Timestamps for last-write-wins (but can lose data). Field-level tracking detects
              conflicts only when same field modified. Operation logs record each change for
              transformation. Choose based on complexity needs — timestamps for simple, CRDTs
              for collaborative.
            </p>
          </div>

          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: What are CRDTs and when would you use them?</p>
            <p className="mt-2 text-sm">
              A: CRDTs (Conflict-Free Replicated Data Types) are data structures with mathematical
              guarantee that any order of operations produces same result. No central coordination
              needed. Use for real-time collaborative editing, offline-first with complex merge
              needs, peer-to-peer apps. Libraries: Yjs, Automerge. Overkill for simple apps where
              LWW is sufficient.
            </p>
          </div>

          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: How do you design UX for conflict resolution?</p>
            <p className="mt-2 text-sm">
              A: Notify user clearly that conflict exists. Show side-by-side comparison with
              differences highlighted. Include attribution (who changed what, when). Allow
              selecting parts from each version. Preserve both versions if unsure. Auto-merge
              non-conflicting changes, ask user about conflicts. Never silently lose user data.
            </p>
          </div>

          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: What&apos;s the difference between OT and CRDTs?</p>
            <p className="mt-2 text-sm">
              A: OT (Operational Transformation) transforms operations to maintain consistency —
              requires central server, used by Google Docs. CRDTs are data structures that
              automatically converge — no central coordination needed, better for peer-to-peer.
              Both enable real-time collaboration. CRDTs are more mathematically elegant, OT is
              more mature for text editing.
            </p>
          </div>

          <div className="rounded-lg border border-theme bg-panel-soft p-4">
            <p className="font-semibold">Q: How do you handle conflicts in a multi-tab app?</p>
            <p className="mt-2 text-sm">
              A: Use BroadcastChannel or localStorage events for cross-tab communication. Detect
              conflicts when syncing state. For simple data, last-write-wins with notification.
              For forms, show conflict dialog before submitting. For collaborative editing, use
              CRDTs (Yjs) for automatic merge. Always inform user of conflicts — never silently
              overwrite.
            </p>
          </div>
        </div>
      ...
      <section>
        ...
        <ul className="space-y-2">
          ...
          <li>
            <a href="https://martin.kleppmann.com/papers/beatopia-dissertation.pdf" className="text-accent hover:underline" target="_blank" rel="noopener noreferrer">
