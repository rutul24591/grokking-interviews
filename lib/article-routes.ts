...
export const articleRoutes: Record<string, () => Promise<any>> = {
  ...
  "requirements/functional-requirements/cross-cutting-archive/accessibility": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/accessibility"),
  "requirements/functional-requirements/cross-cutting-archive/circuit-breaker": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/circuit-breaker"),
  "requirements/functional-requirements/cross-cutting-archive/data-governance": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/data-governance"),
  "requirements/functional-requirements/cross-cutting-archive/data-synchronization": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/data-synchronization"),
  "requirements/functional-requirements/cross-cutting-archive/distributed-tracing": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/distributed-tracing"),
  "requirements/functional-requirements/cross-cutting-archive/error-handling": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/error-handling"),
  "requirements/functional-requirements/cross-cutting-archive/event-sourcing": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/event-sourcing"),
  "requirements/functional-requirements/cross-cutting-archive/gdpr-compliance": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/gdpr-compliance"),
  "requirements/functional-requirements/cross-cutting-archive/internationalization": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/internationalization"),
  "requirements/functional-requirements/cross-cutting-archive/performance-optimization": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/performance-optimization"),
  "requirements/functional-requirements/cross-cutting-archive/privacy-controls-ui": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/privacy-controls-ui"),
  "requirements/functional-requirements/cross-cutting-archive/rate-limiting": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/rate-limiting"),
  "requirements/functional-requirements/cross-cutting-archive/retry-mechanisms": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/retry-mechanisms"),
  "requirements/functional-requirements/cross-cutting-archive/security-best-practices": () => import("@/content/articles/requirements/functional-requirements/cross-cutting-archive/security-best-practices"),
