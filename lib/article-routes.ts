...
export const articleRoutes: Record<string, () => Promise<any>> = {
  ...
  "requirements/functional-requirements/communication/e2e-encryption": () => import("@/content/articles/requirements/functional-requirements/communication/e2e-encryption"),
  ...
  "requirements/functional-requirements/discovery/category-navigation": () => import("@/content/articles/requirements/functional-requirements/discovery/category-navigation"),
  "requirements/functional-requirements/discovery/elasticsearch": () => import("@/content/articles/requirements/functional-requirements/discovery/elasticsearch"),
  "requirements/functional-requirements/discovery/explore-page": () => import("@/content/articles/requirements/functional-requirements/discovery/explore-page"),
  "requirements/functional-requirements/discovery/faceted-search": () => import("@/content/articles/requirements/functional-requirements/discovery/faceted-search"),
  "requirements/functional-requirements/discovery/feed-display": () => import("@/content/articles/requirements/functional-requirements/discovery/feed-display"),
  "requirements/functional-requirements/discovery/feed-generation": () => import("@/content/articles/requirements/functional-requirements/discovery/feed-generation"),
  "requirements/functional-requirements/discovery/filters-and-sorting": () => import("@/content/articles/requirements/functional-requirements/discovery/filters-and-sorting"),
  "requirements/functional-requirements/discovery/infinite-scrolling": () => import("@/content/articles/requirements/functional-requirements/discovery/infinite-scrolling"),
  "requirements/functional-requirements/discovery/query-processing": () => import("@/content/articles/requirements/functional-requirements/discovery/query-processing"),
  "requirements/functional-requirements/discovery/ranking-optimization": () => import("@/content/articles/requirements/functional-requirements/discovery/ranking-optimization"),
  "requirements/functional-requirements/discovery/recommendation-algorithms": () => import("@/content/articles/requirements/functional-requirements/discovery/recommendation-algorithms"),
  "requirements/functional-requirements/discovery/recommendation-carousel": () => import("@/content/articles/requirements/functional-requirements/discovery/recommendation-carousel"),
  "requirements/functional-requirements/discovery/related-content": () => import("@/content/articles/requirements/functional-requirements/discovery/related-content"),
  "requirements/functional-requirements/discovery/search-analytics": () => import("@/content/articles/requirements/functional-requirements/discovery/search-analytics"),
  "requirements/functional-requirements/discovery/search-bar": () => import("@/content/articles/requirements/functional-requirements/discovery/search-bar"),
  "requirements/functional-requirements/discovery/search-indexing": () => import("@/content/articles/requirements/functional-requirements/discovery/search-indexing"),
  "requirements/functional-requirements/discovery/search-ranking": () => import("@/content/articles/requirements/functional-requirements/discovery/search-ranking"),
  "requirements/functional-requirements/discovery/search-results-ui": () => import("@/content/articles/requirements/functional-requirements/discovery/search-results-ui"),
  "requirements/functional-requirements/discovery/trending-computation": () => import("@/content/articles/requirements/functional-requirements/discovery/trending-computation"),
  "requirements/functional-requirements/discovery/trending-section": () => import("@/content/articles/requirements/functional-requirements/discovery/trending-section"),
  ...
  "requirements/functional-requirements/transactions-state/fraud-detection": () => import("@/content/articles/requirements/functional-requirements/transactions-state/fraud-detection"),
