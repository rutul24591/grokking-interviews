...
import { BackendDataProvider } from "@/lib/backend-data-context";
...
export function AppLayout({
  ...
  useSyncUrlToState({ frontendSubCategories, backendSubCategories });
      ...
      <div className="mx-auto flex min-h-0 w-full max-w-[1400px] flex-1 gap-6 px-4 py-6 lg:px-6">
        ...
        <ContentArea>
          <FrontendDataProvider data={frontendSubCategories}>
            <BackendDataProvider data={backendSubCategories}>
              {children}
            </BackendDataProvider>
